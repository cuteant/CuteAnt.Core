...
namespace CuteAnt.OrmLite.Testing
{
  ...
  public class TestingLong : TestingLong<TestingLong> { }

  /// <summary>测试表LONG</summary>
  public partial class TestingLong<TEntity> : CommonInt64IdentityPKEntityBase<TEntity> where TEntity : TestingLong<TEntity>, new()
  {
    #region 对象操作﻿
    ...
    /// <returns></returns>
    [DataObjectMethod(DataObjectMethodType.Select, false)]
    public static TEntity FindByID(Int64 id)
    {
      if (Meta.Count >= 1000)
