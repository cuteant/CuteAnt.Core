...
namespace CuteAnt.OrmLite.Testing
{
  ...
  [Serializable]
  [DataObject]
  [Description("测试表CombGuid")]
  [BindIndex("IX_TestingCombGuid_CreateUserID", false, "CreateUserID")]
  [BindIndex("PK__TestingCombGuid__3214EC277F60ED59", true, "ID")]
  [BindIndex("IX_TestingCombGuid_OrganizeID", false, "OrganizeID")]
  [BindIndex("IX_TestingCombGuid_Name", true, "Name")]
  [BindIndex("IX_TestingCombGuid_RoleID", false, "RoleID")]
  ...
  [BindTable("TestingCombGuid", Description = "测试表CombGuid", ConnName = "EmeTesting")]
  public abstract partial class TestingCombGuid<TEntity> : ITestingCombGuid
  {
    #region 属性
    ...
    public override Object this[String name]
    {
      ...
      set
      {
        switch (name)
        {
          //case __.ID: _ID = (CombGuid)value; break;
    ...
    /// <summary>取得测试表CombGuid字段信息的快捷方式</summary>
    ...
    /// <summary>取得测试表CombGuid字段名称的快捷方式</summary>
  ...
  /// <summary>测试表CombGuid接口</summary>
  public partial interface ITestingCombGuid
  {
    #region 属性
