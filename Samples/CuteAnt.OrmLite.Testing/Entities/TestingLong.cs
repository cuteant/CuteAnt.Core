...
{
  /// <summary>测试表LONG</summary>
  [Serializable]
  [DataObject]
  [Description("测试表LONG")]
  [BindIndex("IX_TestingLong_RoleID", false, "RoleID")]
  [BindIndex("IX_TestingLong_Name", true, "Name")]
  [BindIndex("IX_TestingLong_OrganizeID", false, "OrganizeID")]
  [BindIndex("PK__TestingLong__3214EC277F60ED59", true, "ID")]
  [BindIndex("IX_TestingLong_CreateUserID", false, "CreateUserID")]
  ...
  [BindTable("TestingLong", Description = "测试表LONG", ConnName = "EmeTesting")]
  public abstract partial class TestingLong<TEntity> : ITestingLong
  {
    #region 属性
    ...
    [Description("创建用户名")]
    [DataObjectField(false, false, false, 50)]
    [BindColumn(48, "CreateBy", "创建用户名", null, "nvarchar(50)", CommonDbType.String, true)]
    ...
    /// <summary>取得测试表LONG字段信息的快捷方式</summary>
    ...
    /// <summary>取得测试表LONG字段名称的快捷方式</summary>
  ...
  /// <summary>测试表LONG接口</summary>
  public partial interface ITestingLong
  {
    #region 属性
