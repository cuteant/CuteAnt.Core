...
namespace CuteAnt.OrmLite.Testing
{
  ...
  public class TestingGuid : TestingGuid<TestingGuid> { }

  /// <summary>测试表GUID</summary>
  public partial class TestingGuid<TEntity> : CommonGuidPKEntityBase<TEntity> where TEntity : TestingGuid<TEntity>, new()
  {
    #region 对象操作﻿
    ...
    /// <returns></returns>
    [DataObjectMethod(DataObjectMethodType.Select, false)]
    public static TEntity FindByID(Guid id)
    {
      if (Meta.Count >= 1000)
