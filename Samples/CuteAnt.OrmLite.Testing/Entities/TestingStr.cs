...
{
  /// <summary>测试表String</summary>
  [Serializable]
  [DataObject]
  [Description("测试表String")]
  [BindIndex("IX_TestingStr_RoleID", false, "RoleID")]
  [BindIndex("IX_TestingStr_Name", true, "Name")]
  [BindIndex("IX_TestingStr_OrganizeID", false, "OrganizeID")]
  [BindIndex("PK__TestingStr__3214EC277F60ED59", true, "ID")]
  [BindIndex("IX_TestingStr_CreateUserID", false, "CreateUserID")]
  ...
  [BindTable("TestingStr", Description = "测试表String", ConnName = "EmeTesting")]
  public abstract partial class TestingStr<TEntity> : ITestingStr
  {
    #region 属性
    ...
    [BindColumn(1, "ID", "主键", null, "varchar(32)", CommonDbType.AnsiString, true)]
    ...
    /// <summary>取得测试表String字段信息的快捷方式</summary>
    ...
    /// <summary>取得测试表String字段名称的快捷方式</summary>
  ...
  /// <summary>测试表String接口</summary>
  public partial interface ITestingStr
  {
    #region 属性
