...
namespace NLog.Extensions.Logging
{
    ...
    public static class ConfigureExtensions
    {
        ...
        /// <summary>Enable NLog as logging provider for Microsoft Extension Logging</summary>
        /// <param name="factory"></param>
        ...
        /// <summary>Factory method for <see cref="NLogLoggerProvider"/>.</summary>
        ...
        {
            if (configurationSection == null) { return nlogProvider; }
            ...
            var configProps = nlogProvider.Options.GetType().GetProperties(BindingFlags.Instance | BindingFlags.Public).ToDictionary(p => p.Name, StringComparer.OrdinalIgnoreCase);
...
#if NET40
                        propertyInfo.GetSetMethod(true).Invoke(nlogProvider.Options, new[] { result });
#else
