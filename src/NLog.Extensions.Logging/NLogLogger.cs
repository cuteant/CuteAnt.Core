...
namespace NLog.Extensions.Logging
{
  ...
  internal class NLogLogger : Microsoft.Extensions.Logging.ILogger
  {
    ...
    public void Log<TState>(Microsoft.Extensions.Logging.LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
    {
      ...
      var messageParameters = NLogMessageParameterList.TryParse(_options.CaptureMessageTemplates ? state as
#if NET40
        IList<KeyValuePair<string, object>> : null);
#else
    ...
    private class ScopeProperties : IDisposable
    {
      ...
      /// <summary>Properties, never null and lazy init</summary>
