...
{
  /// <summary>Options for logging to NLog with</summary>
  public class NLogProviderOptions
  {
    ...
    /// <summary>Skip allocation of <see cref="LogEventInfo.Properties"/>-dictionary</summary>
    /// <remarks>using <c>default(EventId)</c></remarks>
    public bool IgnoreEmptyEventId { get; set; }

    /// <summary>Enable structured logging by capturing message template parameters and inject into the <see cref="LogEventInfo.Properties"/>-dictionary.</summary>
    public bool CaptureMessageTemplates { get; set; }

    /// <summary>Enable capture of properties from the ILogger-State-object, 
