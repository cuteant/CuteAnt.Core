...
namespace Yaml.Extensions.Configuration
{
  public class YamlConfigurationProvider : FileConfigurationProvider
  {
    ...
    public virtual void Commit()
    {
      ...
      // TODO: Revisit to make fully atomic. https://github.com/aspnet/Configuration/pull/147/files
      ...
      catch
      {
        ...
        // The operation should be atomic because we don't want a corrupted config file So we roll
