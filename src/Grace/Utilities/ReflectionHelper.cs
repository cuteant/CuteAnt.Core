...
namespace Grace.Utilities
{
  ...
  public static class ReflectionHelper
  {
    ...
    private static Type CreateClosedExportTypeFromInterfaceRequestingType(Type exportedType, Type requestedType)
    {
      ...
      var interfaces = exportedTypeInfo.ImplementedInterfaces.Where(x => x.GetTypeInfo().GUID == requestedTypeInfo.GUID);
    ...
    {
      var returValue = true;
      var interfaceTypes = @interface.GetTypeGenericArguments();
      var closedRequestedTypes = requestedType.GetTypeGenericArguments();
