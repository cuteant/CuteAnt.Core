...
{
  /// <summary>Diagnostic class used for visual studio debugging</summary>
  ...
  public class ActivationStrategyCollectionContainerDebuggerView<T> where T : IActivationStrategy
  {
    ...
    /// <summary>Strategies debugger view</summary>
    ...
    public class StrategyListDebuggerView<TStrategy>
    {
      ...
      /// <summary>Type of strategies</summary>
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
      public Type Type { get; }

      /// <summary>Name for Type</summary>
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
      ...
      /// <summary>Debugger display value</summary>
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
      private string DebuggerDisplayValue => $"Count: {_strategies.Count}";

      /// <summary>Debugger display name</summary>
      [DebuggerBrowsable(DebuggerBrowsableState.Never)]
