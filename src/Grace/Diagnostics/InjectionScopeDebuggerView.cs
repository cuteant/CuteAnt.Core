...
{
  /// <summary>Debugger view for injection scope</summary>
  public class InjectionScopeDebuggerView
  {
    ...
    /// <summary>Extra data for scope</summary>
    ...
    /// <summary>Exports in the scope</summary>
    ...
    /// <summary>Exports by type</summary>
    ...
    /// <summary>Decorators for the scope</summary>
    ...
    /// <summary>Wrappers for the scope</summary>
    ...
    /// <summary>List of possible missing dependencies in this scope</summary>
    ...
    /// <summary>List of exceptions discovered while looking for dependencies</summary>
