...
{
  /// <summary>Condition for if a member has an attribute</summary>
  ...
  public class WhenMemberHas<TAttribute> : ICompiledCondition where TAttribute : Attribute
  {
    ...
    /// <summary>Default constructor that takes a filter</summary>
    /// <param name="filter"></param>
    public WhenMemberHas(Func<TAttribute, bool> filter) => _filter = filter;
