...
{
  /// <summary>Information about how the import should be performed</summary>
  public class ImportAttributeInfo
  {
    ...
    /// <summary>The key that should be used when importing</summary>
    public object ImportKey { get; set; }

    /// <summary>Import Filter</summary>
    public ActivationStrategyFilter ExportStrategyFilter { get; set; }

    /// <summary>Comparer object for import</summary>
    public object Comparer { get; set; }
  }

  /// <summary>Attributes that implement this interface will be included while discovering attributes for importing</summary>
  public interface IImportAttribute
  {
    /// <summary>Provides information about the import</summary>
