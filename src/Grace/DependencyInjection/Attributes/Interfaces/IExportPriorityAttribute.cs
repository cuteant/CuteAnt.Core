...
{
  /// <summary>Attributes that implement this interface will be called during discover to provide a priority</summary>
  public interface IExportPriorityAttribute
  {
    /// <summary>Provide the priority for an attributed type</summary>
