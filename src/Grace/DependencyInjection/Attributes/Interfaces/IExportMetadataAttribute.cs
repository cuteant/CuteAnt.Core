...
{
  /// <summary>
  /// Attributes that implement this interface will be called during discovery to provide metadata
  /// for an attributed type
  /// </summary>
  public interface IExportMetadataAttribute
  {
    /// <summary>Provide the metadata for an attributed type</summary>
