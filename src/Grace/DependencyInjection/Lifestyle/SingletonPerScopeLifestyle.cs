...
namespace Grace.DependencyInjection.Lifestyle
{
  ...
  public class SingletonPerScopeLifestyle : ICompiledLifestyle
  {
    ...
    public virtual IActivationExpressionResult ProvideLifestyleExpression(IInjectionScope scope, IActivationExpressionRequest request, Func<IActivationExpressionRequest, IActivationExpressionResult> activationExpression)
    {
      ...
      const string _getValueFromScopeThreadSafeMethodName = nameof(GetValueFromScopeThreadSafe);
      const string _getValueFromScopeMethodName = nameof(GetValueFromScope);
      var getValueFromScopeMethod = typeof(SingletonPerScopeLifestyle).GetRuntimeMethod(
          ThreadSafe ? _getValueFromScopeThreadSafeMethodName : _getValueFromScopeMethodName,
          new[]
          {
    ...
    /// <summary>Get value from scope with no lock</summary>
