...
{
  /// <summary>C# extension class for configurable activation strategy</summary>
  // ReSharper disable once InconsistentNaming
  public static class IConfigurableActivationStrategyExtensions
  {
    /// <summary>Process attributes on type and configure strategy based on attributes</summary>
