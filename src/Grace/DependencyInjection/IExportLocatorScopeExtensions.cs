...
{
  /// <summary>Extension class for IExportLocatorScope</summary>
  // ReSharper disable once InconsistentNaming
  public static class IExportLocatorScopeExtensions
  {
    /// <summary>Get the parent injection scope for this export locator scope</summary>
    ...
    /// <summary>Creates a new lifetime scope and sets extra data into it before returning</summary>
    /// <param name="scope">scope</param>
    /// <param name="scopeName">new scope name</param>
    /// <param name="extraData">extra data to add to scope</param>
    /// <returns></returns>
    public static IExportLocatorScope BeginLifetimeScope(this IExportLocatorScope scope, string scopeName = "", object extraData = null)
    {
      var lifetimeScope = scope.BeginLifetimeScope(scopeName);

      if (extraData == null) { return lifetimeScope; }
    ...
    /// <returns></returns>
    public static string WhatDoIHave(this IExportLocatorScope scope, bool includeParent = true, ActivationStrategyFilter consider = null)
    {
