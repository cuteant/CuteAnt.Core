...
{
  /// <summary>Configuration object for enumerable properties</summary>
  ...
  public class FluentWithCtorCollectionConfiguration<T, TItem> : ProxyFluentExportStrategyConfiguration<T>, IFluentWithCtorCollectionConfiguration<T, TItem>
  {
    ...
    /// <summary>Provide a filter for which exports should be used</summary>
    ...
    /// <summary>Sort an import collection before it's being injected</summary>
    ...
    /// <summary>Sort the import collection by a particular property on TItem</summary>
