...
{
  /// <summary>Data context that is shared between context in the same graph</summary>
  public class InjectionContextSharedData : IInjectionContextSharedData
  {
    ...
    /// <summary>Get a lock object by a specific name</summary>
    /// <param name="lockName"></param>
    /// <returns></returns>
    public object GetLockObject(string lockName)
        => _locks.GetValueOrDefault(lockName) ??
