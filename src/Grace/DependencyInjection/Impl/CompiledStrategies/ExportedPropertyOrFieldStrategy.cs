...
{
  /// <summary>Strategy to export a property of field from another strategy</summary>
  public class ExportedPropertyOrFieldStrategy : ConfigurableActivationStrategy, ICompiledExportStrategy
  {
    ...
    public ExportedPropertyOrFieldStrategy(Type activationType, IInjectionScope injectionScope, ICompiledExportStrategy dependentStrategy, string propertyOrFieldName)
