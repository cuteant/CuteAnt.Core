...
{
  /// <summary>Represents a generic decorator class</summary>
  public class GenericCompiledDecoratorStrategy : ConfigurableActivationStrategy, ICompiledDecoratorStrategy
  {
    ...
    public GenericCompiledDecoratorStrategy(Type activationType, IInjectionScope injectionScope, IDefaultStrategyExpressionBuilder builder)
