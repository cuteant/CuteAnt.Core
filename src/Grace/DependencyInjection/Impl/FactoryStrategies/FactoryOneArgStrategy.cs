...
{
  /// <summary>Strategy for Func that take 1 dependency and returns TResult</summary>
  ...
  public class FactoryOneArgStrategy<T1, TResult> : DelegateBaseExportStrategy<Func<T1, TResult>>
  {
    ...
    public FactoryOneArgStrategy(Func<T1, TResult> func, IInjectionScope injectionScope)
