...
{
  /// <summary>Strategy for Func that take 5 dependencies and returns TResult</summary>
  ...
  public class FactoryFiveArgStrategy<T1, T2, T3, T4, T5, TResult> : DelegateBaseExportStrategy<Func<T1, T2, T3, T4, T5, TResult>>
  {
    ...
    public FactoryFiveArgStrategy(Func<T1, T2, T3, T4, T5, TResult> func, IInjectionScope injectionScope)
      : base(typeof(TResult), injectionScope, func) { }
  }
}