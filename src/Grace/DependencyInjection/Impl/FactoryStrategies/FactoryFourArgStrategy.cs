...
{
  /// <summary>Strategy for Func that take 4 dependencies and returns TResult</summary>
  ...
  public class FactoryFourArgStrategy<T1, T2, T3, T4, TResult> : DelegateBaseExportStrategy<Func<T1, T2, T3, T4, TResult>>
  {
    ...
    public FactoryFourArgStrategy(Func<T1, T2, T3, T4, TResult> func, IInjectionScope injectionScope)
