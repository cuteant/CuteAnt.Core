...
{
  /// <summary>Strategy for Func that take no dependencies and returns TResult</summary>
  ...
  public class FactoryNoArgStrategy<TResult> : DelegateBaseExportStrategy<Func<TResult>>
  {
    ...
    public FactoryNoArgStrategy(Func<TResult> func, IInjectionScope injectionScope)
