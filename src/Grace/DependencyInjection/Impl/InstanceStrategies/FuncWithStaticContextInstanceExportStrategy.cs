...
{
  /// <summary>Strategy for Func that takes IExportLocatorScope and StaticInjectionContext</summary>
  ...
  public class FuncWithStaticContextInstanceExportStrategy<T> : DelegateBaseExportStrategy<Func<IExportLocatorScope, StaticInjectionContext, T>>
  {
    ...
    public FuncWithStaticContextInstanceExportStrategy(
      Func<IExportLocatorScope, StaticInjectionContext, T> func, IInjectionScope injectionScope)
