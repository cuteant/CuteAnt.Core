...
{
  /// <summary>Strategy for creating ImmutableLinkedList</summary>
  public class ImmutableLinkListStrategy : BaseGenericEnumerableStrategy
  {
    /// <summary>Default constructor</summary>
    /// <param name="injectionScope"></param>
    public ImmutableLinkListStrategy(IInjectionScope injectionScope)
      : base(typeof(ImmutableLinkedList<>), injectionScope) { }
    ...
    public override IActivationExpressionResult GetActivationExpression(IInjectionScope scope, IActivationExpressionRequest request)
    {
      ...
      const string _createImmutableLinkedListMethodName = nameof(CreateImmutableLinkedList);
      var createMethod = typeof(ImmutableLinkListStrategy).GetTypeInfo().GetDeclaredMethod(_createImmutableLinkedListMethodName);
    ...
    /// <summary>Creates an immutable linked list from elements</summary>
