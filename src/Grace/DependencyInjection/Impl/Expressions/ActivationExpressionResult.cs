...
{
  /// <summary>Expression result</summary>
  public class ActivationExpressionResult : IActivationExpressionResult
  {
    ...
    public ActivationExpressionResult(IActivationExpressionRequest request) => Request = request;

    /// <summary>Request that generated result</summary>
    public IActivationExpressionRequest Request { get; }

    /// <summary>Expression for result</summary>
    public Expression Expression { get; set; }

    /// <summary>True if no type was found and the default fallback expression was used</summary>
    public bool UsingFallbackExpression { get; set; } = false;

    /// <summary>Add child expression result</summary>
    ...
    /// <summary>Add extra parameter for expression</summary>
    /// <param name="parameter">parameter to declare</param>
    public void AddExtraParameter(ParameterExpression parameter) => _parameterExpressions = _parameterExpressions.Add(parameter);

    /// <summary>Extra parameters for result</summary>
    /// <returns></returns>
    public IEnumerable<ParameterExpression> ExtraParameters() => _parameterExpressions.Reverse();

    /// <summary>Add extra expression to result</summary>
    ...
    /// <summary>Extra expressions for result</summary>
    /// <returns></returns>
    public IEnumerable<Expression> ExtraExpressions() => _extraExpressions.Reverse();
  }
}