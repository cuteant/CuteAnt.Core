...
{
  /// <summary>Represents a block of registration</summary>
  public class ExportRegistrationBlock : IExportRegistrationBlockValueProvider
  {
    ...
    /// <summary>Scope this registration block is for</summary>
    public IInjectionScope OwningScope { get; }

    /// <summary>Export strategies from the registration block</summary>
    /// <returns></returns>
    ...
    /// <summary>Decorators from the registration block</summary>
    /// <returns></returns>
    ...
    /// <summary>Wrappers from the registration block</summary>
    /// <returns></returns>
    ...
    /// <summary>Get inspectors registered in block</summary>
    /// <returns></returns>
    public IEnumerable<IActivationStrategyInspector> GetInspectors() => _inspectors;
    ...
    /// <returns></returns>
    public IEnumerable<IInjectionValueProvider> GetValueProviders() => _valueProviders;

    /// <summary>Get member injection selectors</summary>
    /// <returns></returns>
    public IEnumerable<IMemberInjectionSelector> GetMemberInjectionSelectors() => _globalSelectors;

    /// <summary>Add IMemberInjectionSelctor that selects</summary>
    ...
    /// <summary>Add configuration module</summary>
    ...
    /// <summary>Export a specific type</summary>
    ...
    /// <summary>Export a specific type (open generics allowed)</summary>
    ...
    /// <summary>Export a set of types</summary>
    ...
    /// <summary>Export a specific value</summary>
    /// <typeparam name="T">type to export</typeparam>
    ...
    /// <summary>Export a specific type using a function</summary>
    /// <typeparam name="T">type to export</typeparam>
    ...
    /// <summary>Export an expression tree</summary>
    ...
    /// <summary>Export a specific type that requires some dependency</summary>
    ...
    /// <summary>Export a specific type that requires some dependencies</summary>
    ...
    /// <summary>Test if a type is exported</summary>
    /// <param name="type"></param>
    ...
    /// <summary>Clears exports from current registration block, this does not unregister exports for previous configuration calls</summary>
    ...
    /// <summary>Export a type that will be used as a decorator for exports</summary>
    ...
    /// <summary>Export a piece of logic that will be used to decorate exports upon creation</summary>
    ...
    /// <summary>Add injection inspector that will be called to inspect all exports, wrappers and decorators
    /// (apply cross cutting configuration with an inspector)</summary>
    ...
    /// <summary>Add IInjectionValueProvider allowing the developer to override the normal behavior for
    /// creating an injection value</summary>
    ...
    /// <summary>Add missing export strategy provider</summary>
    /// <param name="provider"></param>
