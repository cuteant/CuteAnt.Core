...
{
  /// <summary>Implements <see cref="ILoggerFactory"/> so that we can inject Serilog Logger.</summary>
  public class SerilogLoggerFactory : ILoggerFactory
  {
    private readonly SerilogLoggerProvider _provider;

    /// <summary>Initializes a new instance of the <see cref="SerilogLoggerFactory"/> class.</summary>
