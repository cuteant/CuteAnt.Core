...
{
  /// <summary>Extends <see cref="ILoggerFactory"/> with methods for configuring file logging.</summary>
  public static class FileLoggerExtensions
  {
    /// <summary>Adds a file logger initialized from the supplied configuration section.</summary>
    ...
    /// <param name="retainedFileCountLimit">The maximum number of log files that will be retained, including the current log file.
    /// For unlimited retention, pass null. The default is 31.</param>
    /// <returns>A logger factory to allow further configuration.</returns>
    ...
    /// <param name="levelOverrides">A dictionary mapping logger name prefixes to minimum logging levels.</param>
    /// <param name="isJson">If true, the log file will be written in JSON format.</param>
    /// <param name="fileSizeLimitBytes">The maximum size, in bytes, to which any single log file will be allowed to grow. For
    /// unrestricted growth, pass null. The default is 1 GB.</param>
    /// <param name="retainedFileCountLimit">The maximum number of log files that will be retained, including the current log file. For
    /// unlimited retention, pass null. The default is 31.</param>
    /// <returns>The logging builder to allow further configuration.</returns>
    ...
    {
      var levelOverrides = new Dictionary<string, LogLevel>(StringComparer.Ordinal);
