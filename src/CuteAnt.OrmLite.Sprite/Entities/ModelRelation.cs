...
{
	/// <summary>实体模型关系</summary>
	//[Serializable]
	[DataObject]
	[Description("实体模型关系")]
	[BindIndex("PK__ModelRel__3214EC2731EC6D26", true, "ID")]
	[BindIndex("IX_ModelRelation2", true, "ModelTableID,Column,RelationTable,RelationColumn")]
	[BindIndex("IX_ModelRelation", false, "ModelTableID")]
	[BindRelation("ModelTableID", false, "ModelTable", "ID")]
	[BindTable("ModelRelation", Description = "实体模型关系", ConnName = "EmeSprite")]
	public partial class ModelRelation : IModelRelation
	{
		#region 属性
		...
		[BindColumn(3, "Column", "字段名称", null, "nvarchar(50)", CommonDbType.String, true)]
		public virtual String Column
		{
			get { return _Column; }
			set { if (OnPropertyChanging(__.Column, value)) { _Column = value; OnPropertyChanged(__.Column); } }
		}
		...
		[Description("引用表")]
		[DataObjectField(false, false, false, 50)]
		[BindColumn(4, "RelationTable", "引用表", null, "nvarchar(50)", CommonDbType.String, true)]
		public virtual String RelationTable
		{
			get { return _RelationTable; }
			set { if (OnPropertyChanging(__.RelationTable, value)) { _RelationTable = value; OnPropertyChanged(__.RelationTable); } }
		}

		private String _RelationColumn;

		/// <summary>引用字段</summary>
		[DisplayName("引用字段")]
		[Description("引用字段")]
		[DataObjectField(false, false, false, 50)]
		[BindColumn(5, "RelationColumn", "引用字段", null, "nvarchar(50)", CommonDbType.String, true)]
		public virtual String RelationColumn
		{
			get { return _RelationColumn; }
			set { if (OnPropertyChanging(__.RelationColumn, value)) { _RelationColumn = value; OnPropertyChanged(__.RelationColumn); } }
		}
		...
		[Description("唯一")]
		[DataObjectField(false, false, false)]
		[BindColumn(6, "Unique", "唯一", "0", "bit", CommonDbType.Boolean, false)]
		...
		[Description("是否计算产生")]
		[DataObjectField(false, false, false)]
		[BindColumn(7, "Computed", "是否计算产生", "0", "bit", CommonDbType.Boolean, false)]
		...
		[Description("允许编辑")]
		[DataObjectField(false, false, false)]
		[BindColumn(8, "AllowEdit", "允许编辑", "1", "bit", CommonDbType.Boolean, false)]
		...
		[Description("允许删除")]
		[DataObjectField(false, false, false)]
		[BindColumn(9, "AllowDelete", "允许删除", "1", "bit", CommonDbType.Boolean, false)]
		...
		[Description("修改时间")]
		[DataObjectField(false, false, false)]
		[BindColumn(10, "ModifiedTime", "修改时间", null, "datetime", CommonDbType.DateTime, false)]
		...
		[Description("修改用户")]
		[DataObjectField(false, false, false)]
		[BindColumn(11, "ModifiedByUserID", "修改用户", "0", "int", CommonDbType.Integer, false)]
		...
		[Description("修改用户名")]
		[DataObjectField(false, false, false, 50)]
		[BindColumn(12, "ModifiedByUser", "修改用户名", null, "nvarchar(50)", CommonDbType.String, true)]
		...
		[Description("创建时间")]
		[DataObjectField(false, false, false)]
		[BindColumn(13, "CreatedTime", "创建时间", null, "datetime", CommonDbType.DateTime, false)]
		...
		[Description("创建用户")]
		[DataObjectField(false, false, false)]
		[BindColumn(14, "CreatedByUserID", "创建用户", "0", "int", CommonDbType.Integer, false)]
		...
		[Description("创建用户名")]
		[DataObjectField(false, false, false, 50)]
		[BindColumn(15, "CreatedByUser", "创建用户名", null, "nvarchar(50)", CommonDbType.String, true)]
		...
		public override Object this[String name]
		{
			get
			{
				switch (name)
				{
					...
					case __.Column: return _Column;
					case __.RelationTable: return _RelationTable;
					case __.RelationColumn: return _RelationColumn;
			...
			set
			{
				switch (name)
				{
					...
					case __.Column: _Column = Convert.ToString(value); break;
					case __.RelationTable: _RelationTable = Convert.ToString(value); break;
					case __.RelationColumn: _RelationColumn = Convert.ToString(value); break;
		...
		/// <summary>取得实体模型关系字段信息的快捷方式</summary>
		public partial class _
		{
			...
			///<summary>字段名称</summary>
			public static readonly FieldItem Column = FindByName(__.Column);

			///<summary>引用表</summary>
			public static readonly FieldItem RelationTable = FindByName(__.RelationTable);

			///<summary>引用字段</summary>
			public static readonly FieldItem RelationColumn = FindByName(__.RelationColumn);
		...
		/// <summary>取得实体模型关系字段名称的快捷方式</summary>
		public partial class __
		{
			...
			///<summary>引用表</summary>
			public const String RelationTable = "RelationTable";

			///<summary>引用字段</summary>
			public const String RelationColumn = "RelationColumn";
	...
	/// <summary>实体模型关系接口</summary>
	public partial interface IModelRelation
	{
		#region 属性
