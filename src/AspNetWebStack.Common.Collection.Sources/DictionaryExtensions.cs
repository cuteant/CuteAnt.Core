...
namespace System.Collections.Generic
{
  ...
  internal static class WebAPIDictionaryExtensions
  {
    /// <summary>Remove entries from dictionary that match the removeCondition.</summary>
    internal static void RemoveFromDictionary<TKey, TValue>(this IDictionary<TKey, TValue> dictionary, Func<KeyValuePair<TKey, TValue>, bool> removeCondition)
    {
    ...
    /// <summary>Remove entries from dictionary that match the removeCondition.</summary>
    internal static void RemoveFromDictionary<TKey, TValue, TState>(this IDictionary<TKey, TValue> dictionary, Func<KeyValuePair<TKey, TValue>, TState, bool> removeCondition, TState state)
    {
