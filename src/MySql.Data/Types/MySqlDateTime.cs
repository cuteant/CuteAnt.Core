    ...
    public int Millisecond {
      ...
      set
      {
        if (value < 0 || value > 999)
          throw new ArgumentOutOfRangeException("Millisecond", Properties.Resources.InvalidMillisecondValue);
        millisecond = value;
    ...
    public int Microsecond
    {
      ...
      set
      {
        if (value < 0 || value > 999999)
          throw new ArgumentOutOfRangeException("Microsecond", Properties.Resources.InvalidMicrosecondValue);
        microsecond = value;
