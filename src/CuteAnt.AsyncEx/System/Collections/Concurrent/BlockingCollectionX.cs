...
namespace System.Collections.Concurrent
{
  ...
  public class BlockingCollectionX<T> : IEnumerable<T>, ICollection, IDisposable, IReadOnlyCollection<T>
  {
    ...
    /// </summary>
    /// <remarks>
    /// The default underlying collection is a <see cref="System.Collections.Concurrent.ConcurrentQueueX{T}">ConcurrentQueue&lt;T&gt;</see>.
    /// </remarks>
    public BlockingCollectionX()
      : this(new ConcurrentQueueX<T>())
    {
    }
    ...
    /// The default underlying collection is a <see cref="System.Collections.Concurrent.ConcurrentQueueX{T}">ConcurrentQueue&lt;T&gt;</see>.
    /// </remarks>
    public BlockingCollectionX(int boundedCapacity)
      : this(new ConcurrentQueueX<T>(), boundedCapacity)
    {
    }
    ...
    public BlockingCollectionX(IProducerConsumerCollection<T> collection, int boundedCapacity)
    {
    ...
    /// <exception cref="T:System.ArgumentNullException">The <paramref name="collection"/> argument is
    /// null.</exception>
    public BlockingCollectionX(IProducerConsumerCollection<T> collection)
    {
      if (collection == null)
      {
        throw new ArgumentNullException(nameof(collection));
    ...
    /// If a bounded capacity was specified when this instance of 
    /// <see cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> was initialized, 
    /// a call to <see cref="Add(System.Threading.CancellationToken)"/> may block until space is available to store the provided item.
    /// </remarks>
...
#pragma warning restore 0420
    ...
    /// </remarks>
    public static int AddToAny(BlockingCollectionX<T>[] collections, T item)
    {
#if DEBUG
 ...
 TryAddToAny(collections, item, Timeout.Infinite, CancellationToken.None);
    ...
    /// to store the provided item.
    /// </remarks>
    public static int AddToAny(BlockingCollectionX<T>[] collections, T item, CancellationToken cancellationToken)
    {
#if DEBUG
      int tryAddAnyReturnValue =
#else
 ...
 TryAddToAny(collections, item, Timeout.Infinite, cancellationToken);
    ...
    /// <exception cref="T:System.ArgumentOutOfRangeException">The count of <paramref name="collections"/> is greater than the maximum size of
    /// 62 for STA and 63 for MTA.</exception>
    public static int TryAddToAny(BlockingCollectionX<T>[] collections, T item)
    {
    ...
    /// <exception cref="T:System.ArgumentOutOfRangeException">The count of <paramref name="collections"/> is greater than the maximum size of
    /// 62 for STA and 63 for MTA.</exception>
    public static int TryAddToAny(BlockingCollectionX<T>[] collections, T item, TimeSpan timeout)
    {
      ValidateTimeout(timeout);
    ...
    /// <exception cref="T:System.ArgumentOutOfRangeException">The count of <paramref name="collections"/> is greater than the maximum size of
    /// 62 for STA and 63 for MTA.</exception>
    public static int TryAddToAny(BlockingCollectionX<T>[] collections, T item, int millisecondsTimeout)
    {
      ValidateMillisecondsTimeout(millisecondsTimeout);
    ...
    /// <exception cref="T:System.ArgumentOutOfRangeException">The count of <paramref name="collections"/> is greater than the maximum size of
    /// 62 for STA and 63 for MTA.</exception>
    public static int TryAddToAny(BlockingCollectionX<T>[] collections, T item, int millisecondsTimeout, CancellationToken cancellationToken)
    {
      ValidateMillisecondsTimeout(millisecondsTimeout);
    ...
    private static int TryAddToAnyFast(BlockingCollectionX<T>[] collections, T item)
    {
    ...
    private static List<WaitHandle> GetHandles(BlockingCollectionX<T>[] collections, CancellationToken externalCancellationToken, bool isAddOperation, out CancellationToken[] cancellationTokens)
    {
    ...
    public static int TakeFromAny(BlockingCollectionX<T>[] collections, out T item)
    {
    ...
    /// 62 for STA and 63 for MTA.</exception>
    /// <remarks>A call to TakeFromAny may block until an item is available to be removed.</remarks>
    public static int TakeFromAny(BlockingCollectionX<T>[] collections, out T item, CancellationToken cancellationToken)
    {
    ...
    public static int TryTakeFromAny(BlockingCollectionX<T>[] collections, out T item)
    {
    ...
    /// 62 for STA and 63 for MTA.</exception>
    /// <remarks>A call to TryTakeFromAny may block until an item is available to be removed.</remarks>
    public static int TryTakeFromAny(BlockingCollectionX<T>[] collections, out T item, TimeSpan timeout)
    {
      ValidateTimeout(timeout);
    ...
    /// 62 for STA and 63 for MTA.</exception>
    /// <remarks>A call to TryTakeFromAny may block until an item is available to be removed.</remarks>
    public static int TryTakeFromAny(BlockingCollectionX<T>[] collections, out T item, int millisecondsTimeout)
    {
      ValidateMillisecondsTimeout(millisecondsTimeout);
    ...
    /// 62 for STA and 63 for MTA.</exception>
    /// <remarks>A call to TryTakeFromAny may block until an item is available to be removed.</remarks>
    public static int TryTakeFromAny(BlockingCollectionX<T>[] collections, out T item, int millisecondsTimeout, CancellationToken cancellationToken)
    {
      ValidateMillisecondsTimeout(millisecondsTimeout);
...
#pragma warning restore 0420
    ...
    private static void ValidateCollectionsArray(BlockingCollectionX<T>[] collections, bool isAddOperation)
    {
      if (collections == null)
      {
      ...
      for (int i = 0; i < collections.Length; ++i)
      {
        ...
        {
          throw new ArgumentException(SR.BlockingCollection_ValidateCollectionsArray_NullElems, nameof(collections));
        }

        if (collections[i]._isDisposed)
          throw new ObjectDisposedException(nameof(collections), SR.BlockingCollection_ValidateCollectionsArray_DispElems);
  ...
  {
    private readonly BlockingCollectionX<T> _blockingCollection; // The collection being viewed.
    ...
    public BlockingCollectionDebugView(BlockingCollectionX<T> collection)
    {
      if (collection == null)
      {
        throw new ArgumentNullException(nameof(collection));
