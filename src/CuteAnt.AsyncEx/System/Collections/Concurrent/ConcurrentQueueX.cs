...
namespace System.Collections.Concurrent
{
  ...
  /// <remarks>
  /// All public  and protected members of <see cref="ConcurrentQueueX{T}"/> are thread-safe and may be used
  /// concurrently from multiple threads.
  /// </remarks>
  [DebuggerDisplay("Count = {Count}")]
  [DebuggerTypeProxy(typeof(IProducerConsumerCollectionDebugView<>))]
  [Serializable]
  public class ConcurrentQueueX<T> : IProducerConsumerCollection<T>, IReadOnlyCollection<T>
  {
    [NonSerialized]
    ...
    /// <summary>Initializes a new instance of the <see cref="ConcurrentQueueX{T}"/> class.</summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConcurrentQueueX{T}"/>
    /// class that contains elements copied from the specified collection
    /// </summary>
    /// <param name="collection">The collection whose elements are copied to the new <see
    /// cref="ConcurrentQueueX{T}"/>.</param>
    ...
    /// with the SyncRoot; otherwise, false. For <see cref="ConcurrentQueueX{T}"/>, this property always
    /// returns false.</value>
    ...
    /// <remarks>For <see cref="ConcurrentQueueX{T}"/>, this operation will always add the object to the
    /// end of the <see cref="ConcurrentQueueX{T}"/>
    ...
    /// <remarks>For <see cref="ConcurrentQueueX{T}"/>, this operation will attempt to remove the object
    /// from the beginning of the <see cref="ConcurrentQueueX{T}"/>.
    /// </remarks>
    ...
    /// <summary>Gets a value that indicates whether the <see cref="ConcurrentQueueX{T}"/> is empty.</summary>
    /// <value>true if the <see cref="ConcurrentQueueX{T}"/> is empty; otherwise, false.</value>
    /// <remarks>
    ...
    /// <summary>Copies the elements stored in the <see cref="ConcurrentQueueX{T}"/> to a new array.</summary>
    /// <returns>A new array containing a snapshot of elements copied from the <see
    /// cref="ConcurrentQueueX{T}"/>.</returns>
    public T[] ToArray()
    {
...
#pragma warning disable 0420 // No warning for Interlocked.xxx if compiled with new managed compiler (Roslyn)
    /// <summary>
    /// Copies the <see cref="ConcurrentQueueX{T}"/> elements to a new <see
    /// cref="T:System.Collections.Generic.List{T}"/>.
    /// </summary>
    /// <returns>A new <see cref="T:System.Collections.Generic.List{T}"/> containing a snapshot of
    /// elements copied from the <see cref="ConcurrentQueueX{T}"/>.</returns>
    ...
    /// <summary>Gets the number of elements contained in the <see cref="ConcurrentQueueX{T}"/>.</summary>
    /// <value>The number of elements contained in the <see cref="ConcurrentQueueX{T}"/>.</value>
    /// <remarks>
    ...
    /// <summary>
    /// Copies the <see cref="ConcurrentQueueX{T}"/> elements to an existing one-dimensional <see
    /// cref="T:System.Array">Array</see>, starting at the specified array index.
    /// </summary>
    /// <param name="array">The one-dimensional <see cref="T:System.Array">Array</see> that is the
    /// destination of the elements copied from the
    /// <see cref="ConcurrentQueueX{T}"/>. The <see cref="T:System.Array">Array</see> must have zero-based
    /// indexing.</param>
    /// <param name="index">The zero-based index in <paramref name="array"/> at which copying
    /// begins.</param>
    /// <exception cref="ArgumentNullException"><paramref name="array"/> is a null reference (Nothing in
    ...
    /// -or- The number of elements in the source <see cref="ConcurrentQueueX{T}"/> is greater than the
    ...
    /// <summary>Adds an object to the end of the <see cref="ConcurrentQueueX{T}"/>.</summary>
    /// <param name="item">The object to add to the end of the <see
    /// cref="ConcurrentQueueX{T}"/>. The value can be a null reference
    ...
    /// <summary>
    /// Attempts to return an object from the beginning of the <see cref="ConcurrentQueueX{T}"/>
    /// without removing it.
    /// </summary>
    ...
    private class Segment
    {
      ...
      private volatile ConcurrentQueueX<T> _source;

      /// <summary>Create and initialize a segment with the specified index.</summary>
      internal Segment(long index, ConcurrentQueueX<T> source)
      {
