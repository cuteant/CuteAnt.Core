...
namespace System.Collections.Concurrent
{
  ...
  public class ConcurrentDictionaryX<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
  {
    ...
    /// </summary>
    public ConcurrentDictionaryX() : this(DefaultConcurrencyLevel, DefaultCapacity, true, EqualityComparer<TKey>.Default) { }
    ...
    /// (Nothing in Visual Basic).</exception>
    public ConcurrentDictionaryX(IEqualityComparer<TKey> comparer) : this(DefaultConcurrencyLevel, DefaultCapacity, true, comparer) { }
    ...
    public KeyValuePair<TKey, TValue>[] ToArray()
    {
      ...
      try
      {
        ...
        if (count == 0)
        {
          ...
          return CuteAnt.EmptyArray<KeyValuePair<TKey, TValue>>.Instance;
        }
