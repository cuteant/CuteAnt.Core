...
namespace System.Collections.Concurrent
{
	...
	/// <remarks>
	/// All public and protected members of <see cref="ConcurrentDictionaryX{TKey,TValue}"/> are thread-safe and may be used
	/// concurrently from multiple threads.
	/// </remarks>
	[DebuggerTypeProxy(typeof(IDictionaryDebugView<,>))]
	[DebuggerDisplay("Count = {Count}")]
	public class ConcurrentDictionaryX<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
	{
		/// <summary>
		...
		/// cref="ConcurrentDictionaryX{TKey,TValue}"/>
		/// class that is empty, has the default concurrency level, has the default initial capacity, and
		/// uses the default comparer for the key type.
		/// </summary>
		public ConcurrentDictionaryX() : this(DefaultConcurrencyLevel, DEFAULT_CAPACITY, true, EqualityComparer<TKey>.Default) { }
		...
		/// <see cref="ConcurrentDictionaryX{TKey,TValue}"/> concurrently.</param>
		...
		/// 0.</exception>
		public ConcurrentDictionaryX(int concurrencyLevel, int capacity) : this(concurrencyLevel, capacity, false, EqualityComparer<TKey>.Default) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="ConcurrentDictionaryX{TKey,TValue}"/>
		...
		/// the new
		/// <see cref="ConcurrentDictionaryX{TKey,TValue}"/>.</param>
		/// <exception cref="T:System.ArgumentNullException"><paramref name="collection"/> is a null reference
		/// (Nothing in Visual Basic).</exception>
		/// <exception cref="T:System.ArgumentException"><paramref name="collection"/> contains one or more
		/// duplicate keys.</exception>
		public ConcurrentDictionaryX(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this(collection, EqualityComparer<TKey>.Default) { }
		...
		/// (Nothing in Visual Basic).</exception>
		public ConcurrentDictionaryX(IEqualityComparer<TKey> comparer) : this(DefaultConcurrencyLevel, DEFAULT_CAPACITY, true, comparer) { }
		...
		/// <summary>
		/// Attempts to add the specified key and value to the <see cref="ConcurrentDictionaryX{TKey,
		/// TValue}"/>.
		/// </summary>
		/// <param name="key">The key of the element to add.</param>
		/// <param name="value">The value of the element to add. The value can be a null reference (Nothing
		/// in Visual Basic) for reference types.</param>
		/// <returns>true if the key/value pair was added to the <see cref="ConcurrentDictionaryX{TKey,
		/// TValue}"/>
		/// successfully; otherwise, false.</returns>
		/// <exception cref="T:System.ArgumentNullException"><paramref name="key"/> is null reference
		/// (Nothing in Visual Basic).</exception>
		/// <exception cref="T:System.OverflowException">The <see cref="ConcurrentDictionaryX{TKey, TValue}"/>
		...
		/// <summary>
		/// Determines whether the <see cref="ConcurrentDictionaryX{TKey, TValue}"/> contains the specified
		/// key.
		/// </summary>
		/// <param name="key">The key to locate in the <see cref="ConcurrentDictionaryX{TKey,
		/// TValue}"/>.</param>
		/// <returns>true if the <see cref="ConcurrentDictionaryX{TKey, TValue}"/> contains an element with
		...
		/// <see cref="ConcurrentDictionaryX{TKey, TValue}"/>.
		/// </summary>
		/// <param name="key">The key of the element to remove and return.</param>
		/// <param name="value">When this method returns, <paramref name="value"/> contains the object removed from the
		/// <see cref="ConcurrentDictionaryX{TKey,TValue}"/> or the default value of <typeparamref
		/// name="TValue"/>
		...
		/// the
		/// <see cref="ConcurrentDictionaryX{TKey,TValue}"/> with the specified key or the default value of
		/// <typeparamref name="TValue"/>, if the operation failed.</param>
		/// <returns>true if the key was found in the <see cref="ConcurrentDictionaryX{TKey,TValue}"/>;
		...
		/// <summary>Removes all keys and values from the <see cref="ConcurrentDictionaryX{TKey,TValue}"/>.</summary>
		public void Clear()
		{
			int locksAcquired = 0;
			try
		...
		/// <summary>
		/// Copies the key and value pairs stored in the <see cref="ConcurrentDictionaryX{TKey,TValue}"/> to a
		/// new array.
		/// </summary>
		/// <returns>A new array containing a snapshot of key and value pairs copied from the <see
		/// cref="ConcurrentDictionaryX{TKey,TValue}"/>.</returns>
		[SuppressMessage("Microsoft.Concurrency", "CA8001", Justification = "ConcurrencyCop just doesn't know about these locks")]
		...
		/// cref="ConcurrentDictionaryX{TKey,TValue}"/>.</summary>
		/// <returns>An enumerator for the <see cref="ConcurrentDictionaryX{TKey,TValue}"/>.</returns>
		/// <remarks>
		...
		/// cref="ConcurrentDictionaryX{TKey,TValue}"/>.</value>
		...
		/// <summary>
		/// Adds a key/value pair to the <see cref="ConcurrentDictionaryX{TKey,TValue}"/> 
		...
		/// <summary>
		/// Adds a key/value pair to the <see cref="ConcurrentDictionaryX{TKey,TValue}"/> if the key does not already 
		/// exist, or updates a key/value pair in the <see cref="ConcurrentDictionaryX{TKey,TValue}"/> if the key 
		/// already exists.
		/// </summary>
		...
		/// <summary>Gets a value that indicates whether the <see cref="ConcurrentDictionaryX{TKey,TValue}"/> is empty.</summary>
		/// <value>true if the <see cref="ConcurrentDictionaryX{TKey,TValue}"/> is empty; otherwise,
		/// false.</value>
		public bool IsEmpty
		{
			[SuppressMessage("Microsoft.Concurrency", "CA8001", Justification = "ConcurrencyCop just doesn't know about these locks")]
		...
		/// cref="ConcurrentDictionaryX{TKey,TValue}"/>.</exception>
		...
		{
			return ((ConcurrentDictionaryX<TKey, TValue>)this).GetEnumerator();
		}
		...
		object IDictionary.this[object key]
		{
			...
			set
			{
				...
				((ConcurrentDictionaryX<TKey, TValue>)this)[(TKey)key] = (TValue)value;
			}
		}
		...
		private class DictionaryEnumerator : IDictionaryEnumerator
		{
			...
			internal DictionaryEnumerator(ConcurrentDictionaryX<TKey, TValue> dictionary)
			{
