...
namespace System.Threading.Tasks.Dataflow
{
	...
	{
		/// <summary>Indicates that the <see cref="ITargetBlock{TInput}"/> accepted the message. 
		/// Once a target has accepted a message, it is wholly owned by the target.</summary>
		Accepted = 0x0,

		/// <summary>Indicates that the <see cref="ITargetBlock{TInput}"/> declined the message. 
		...
		/// <summary>Indicates that the <see cref="ITargetBlock{TInput}"/> tried to accept the message from the <see cref="ISourceBlock{TOutput}"/>, 
		/// but the message was no longer available.</summary>
		NotAvailable = 0x3,
