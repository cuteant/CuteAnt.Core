...
namespace System.Threading.Tasks.Dataflow
{
	...
	{
		/// <summary>A constant used to specify an unlimited quantity for <see cref="DataflowLinkOptions"/> members
		...
		/// <remarks>Do not change the values of this instance. 
		/// It is shared by all of our blocks that need to unlink after one message has been consumed.</remarks>
