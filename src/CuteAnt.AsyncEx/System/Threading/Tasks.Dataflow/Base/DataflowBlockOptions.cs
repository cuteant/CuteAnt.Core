...
{
  #region -- class DataflowBlockOptions --
  ...
  public class DataflowBlockOptions
  {
    ...
    /// <summary>A constant used to specify an unlimited quantity for <see cref="DataflowBlockOptions"/> members
    ...
    /// <remarks>Do not change the values of this instance.  It is shared by all of our blocks when no options are provided by the user.</remarks>
    ...
    private Boolean _autoDisposeMessages = true;

    /// <summary>AutoDisposeMessages</summary>
    public Boolean AutoDisposeMessages
    {
      get { return _autoDisposeMessages; }
      set { _autoDisposeMessages = value; }
    }
  ...
  #region -- class ExecutionDataflowBlockOptions --

  /// <summary>Provides options used to configure the processing performed by dataflow blocks that
  ...
  #region -- class GroupingDataflowBlockOptions --
