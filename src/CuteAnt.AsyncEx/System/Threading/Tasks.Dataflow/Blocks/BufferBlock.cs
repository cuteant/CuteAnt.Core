...
namespace System.Threading.Tasks.Dataflow
{
  ...
  public sealed class BufferBlock<T> : IPropagatorBlock<T, T>, IReceivableSourceBlock<T>, IDebuggerDisplay
  {
    ...
    private Boolean _targetDecliningPermanently;

    /// <summary>A task has reserved the right to run the target's completion routine.</summary>
    private Boolean _targetCompletionReserved;
    ...
    DataflowMessageStatus ITargetBlock<T>.OfferMessage(DataflowMessageHeader messageHeader, T messageValue,
      ISourceBlock<T> source, Boolean consumeToAccept)
    {
      // Validate arguments
    ...
    private void CompleteCore(Exception exception, Boolean storeExceptionEvenIfAlreadyCompleting, Boolean revertProcessingState = false)
    {
    ...
    private void ConsumeMessagesLoopCore()
    {
      ...
      try
      {
        Int32 maxMessagesPerTask = _source.DataflowBlockOptions.ActualMaxMessagesPerTask;
        for (Int32 i = 0;
    ...
    private Int32 CountForDebugger { get { return _source.GetDebuggingInformation().OutputCount; } }
    ...
    private sealed class DebugView
    {
      ...
      public Boolean IsDecliningPermanently { get { return _bufferBlock._targetDecliningPermanently; } }
      ...
      public Int32 Id { get { return Common.GetBlockId(_bufferBlock); } }
