...
namespace System.Threading.Tasks.Dataflow
{
  ...
  public sealed class WriteOnceBlock<T> : IPropagatorBlock<T, T>, IReceivableSourceBlock<T>, IDebuggerDisplay
  {
    ...
    private Boolean HasValue { get { return _header.IsValid; } }
    ...
    #region ** CompleteBlockAsync **

    /// <summary>Asynchronously completes the block on another task.</summary>
    /// <remarks>This must only be called once all of the completion conditions are met.</remarks>
    ...
    private void CompleteBlockAsync(IList<Exception> exceptions)
    {
      ...
      else
      {
        ...
        {
          var blockAndList = (Tuple<WriteOnceBlock<T>, IList<Exception>>)state;
    ...
    #region ** OfferToTargetsAndCompleteBlock **

    /// <summary>Offers the message and completes the block.</summary>
    /// <remarks>This is called only once.</remarks>
    ...
    private void CompleteCore(Exception exception, Boolean storeExceptionEvenIfAlreadyCompleting)
    {
      ...
      var thisThreadReservedCompletion = false;
      lock (ValueLock)
      {
    ...
    public Boolean TryReceive(Predicate<T> filter, out T item)
    {
      ...
      // completed WriteOnceBlock will return true, as Int64 as the message
    ...
    DataflowMessageStatus ITargetBlock<T>.OfferMessage(DataflowMessageHeader messageHeader, T messageValue, ISourceBlock<T> source, Boolean consumeToAccept)
    {
      ...
      Boolean thisThreadReservedCompletion = false;
      lock (ValueLock)
      {
    ...
    private sealed class DebugView
    {
      ...
      public Boolean IsCompleted { get { return _writeOnceBlock.Completion.IsCompleted; } }

      /// <summary>Gets the block's Id.</summary>
      public Int32 Id { get { return Common.GetBlockId(_writeOnceBlock); } }

      /// <summary>Gets whether the WriteOnceBlock has a value.</summary>
      public Boolean HasValue { get { return _writeOnceBlock.HasValue; } }
