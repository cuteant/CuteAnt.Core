...
namespace System.Threading.Tasks.Dataflow
{
  ...
  public sealed class ActionBlock<TInput> : ITargetBlock<TInput>, IDebuggerDisplay
  {
    ...
    private void ProcessMessage(Action<TInput> action, KeyValuePair<TInput, Int64> messageWithId)
    {
      try
      {
    ...
    #region -- ITargetBlock<TInput> Memebers --
    ...
    private Int32 InputCountForDebugger
    {
    ...
    private Object DebuggerDisplayContent
    {
      get
      {
        return "{0}, InputCount={1}".FormatWith(
    ...
    private sealed class DebugView
    {
      ...
      public Int32 Id { get { return Common.GetBlockId(_actionBlock); } }
    }
