...
namespace System.Threading.Tasks.Dataflow.Internal
{
	...
	internal sealed class TargetRegistry<T>
	{
		...
		internal sealed class LinkedTargetInfo
		{
			...
			internal readonly Boolean PropagateCompletion;
			...
			internal Int32 RemainingMessages;
		...
		private Int32 _linksWithRemainingMessages;
		...
		private Int32 Count { get { return _targetInformation.Count; } }
		...
		internal Boolean Contains(ITargetBlock<T> target)
		{
		...
		/// </param>
		internal void Remove(ITargetBlock<T> target, Boolean onlyIfReachedMaxMessages = false)
		{
		...
		internal void AddToList(LinkedTargetInfo node, Boolean append)
		{
		...
		#region ** class NopLinkPropagator **
