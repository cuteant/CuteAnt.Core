...
namespace System.Threading.Tasks.Dataflow.Internal
{
  ...
  internal enum TargetCoreOptions : byte
  {
    ...
    /// <summary>Whether the block containing this target core is just a target or also has a source side.
    /// If it's just a target, then this target core's completion represents the entire block's completion.</summary>
    RepresentsBlockCompletion = 0x2
  }

  /// <summary>Provides a core implementation of <see cref="ITargetBlock{TInput}"/>.</summary>
  ...
  {
    #region @@ These fields are readonly and are initialized at AppDomain startup. @@

    /// <summary>Caching the keep alive predicate.</summary>
    private static readonly Common.KeepAlivePredicate<TargetCore<TInput>, KeyValuePair<TInput, Int64>> _keepAlivePredicate =
            (TargetCore<TInput> thisTargetCore, out KeyValuePair<TInput, Int64> messageWithId) =>
    ...
    private readonly IProducerConsumerQueue<KeyValuePair<TInput, Int64>> _messages;
    ...
    private readonly Action<KeyValuePair<TInput, Int64>> _callAction;
    ...
    private Int32 _numberOfOutstandingOperations;

    /// <summary>The number of service tasks in async mode currently running.</summary>
    /// <remarks>Must always be accessed from inside a lock.</remarks>
    private Int32 _numberOfOutstandingServiceTasks;
    ...
    private Int32 _keepAliveBanCounter;
    ...
    internal Int32 InputCount { get { return _messages.GetCountSafe(IncomingLock); } }

    /// <summary>Gets whether this instance has been constructed for async processing.</summary>
    private Boolean UsesAsyncCompletion
    {
    ...
    private Boolean HasRoomForMoreOperations
    {
      get
      {
    ...
    private Boolean HasRoomForMoreServiceTasks
    {
      get
      {
        Contract.Requires(_numberOfOutstandingOperations >= 0, "Number of outstanding operations should never be negative.");
    ...
    internal Boolean IsBounded { get { return _boundingState != null; } }
    ...
    private Object DebuggerDisplayContent
    {
      get
      {
        ...
        return "Block=\"{0}\"".FormatWith(displayTarget != null ? displayTarget.Content : _owningTarget);
      }
    }
    ...
    internal TargetCore(
        ...
        Action<KeyValuePair<TInput, Int64>> callAction,
        ...
        TargetCoreOptions targetCoreOptions)
    {
      ...
      _messages = (dataflowBlockOptions.MaxDegreeOfParallelism == 1) ?
          (IProducerConsumerQueue<KeyValuePair<TInput, Int64>>)new SingleProducerSingleConsumerQueue<KeyValuePair<TInput, Int64>>() :
          (IProducerConsumerQueue<KeyValuePair<TInput, Int64>>)new MultiProducerMultiConsumerQueue<KeyValuePair<TInput, Int64>>();
...
#pragma warning disable 0420
        ...
        {
          KeyValuePair<TInput, Int64> dummy;
          if (_dataflowBlockOptions.AutoDisposeMessages)
          {
    ...
    internal DataflowMessageStatus OfferMessage(DataflowMessageHeader messageHeader, TInput messageValue,
      ISourceBlock<TInput> source, Boolean consumeToAccept)
    {
      // Validate arguments
      ...
      lock (IncomingLock)
      {
            ...
            (_boundingState.OutstandingTransfers == 0 && _boundingState.CountIsLessThanBound && _boundingState.PostponedMessages.Count == 0))
        {
          ...
          _messages.Enqueue(new KeyValuePair<TInput, Int64>(messageValue, messageId));
    ...
    #region == SignalOneAsyncMessageCompleted ==
    ...
    internal void SignalOneAsyncMessageCompleted(Int32 boundingCountChange)
    {
      lock (IncomingLock)
      {
    ...
    private void ProcessAsyncIfNecessary(Boolean repeat = false)
    {
      Common.ContractAssertMonitorStatus(IncomingLock, held: true);
    ...
    private void ProcessMessagesLoopCore()
    {
      ...
      var messageWithId = default(KeyValuePair<TInput, Int64>);
      try
      {
        ...
        while (numberOfMessagesProcessedByThisTask < maxMessagesPerTask && !CanceledOrFaulted)
        {
          ...
          KeyValuePair<TInput, Int64> transferMessageWithId;
    ...
    #region ** TryGetNextMessageForNewAsyncOperation **
    ...
    private Boolean TryGetNextMessageForNewAsyncOperation(out KeyValuePair<TInput, Int64> messageWithId)
    {
      ...
      messageWithId = default(KeyValuePair<TInput, Int64>);
    ...
    #region ** TryGetNextAvailableOrPostponedMessage **

    /// <summary>Either takes the next available message from the input queue or retrieves a postponed
    /// message from a source, based on whether we're in greedy or non-greedy mode.</summary>
    ...
    private Boolean TryGetNextAvailableOrPostponedMessage(out KeyValuePair<TInput, Int64> messageWithId)
    {
      Common.ContractAssertMonitorStatus(IncomingLock, held: false);

      // First try to get a message from our input buffer.
      if (_messages.TryDequeue(out messageWithId)) { return true; }
    ...
    #region ** TryConsumePostponedMessage **
    ...
    private Boolean TryConsumePostponedMessage(
        ...
        out KeyValuePair<TInput, Int64> result)
    {
      ...
      while (true)
      {
        ...
        if (consumed)
        {
          result = new KeyValuePair<TInput, Int64>(consumedValue, messageId);
          return true;
        }
        else
        {
      ...
      result = default(KeyValuePair<TInput, Int64>);
      return false;
    }
    ...
    private void CompleteBlockOncePossible()
    {
      ...
      KeyValuePair<TInput, Int64> ignored;
    ...
    internal sealed class DebuggingInformation
    {
      ...
      internal Int32 InputCount { get { return _target._messages.Count; } }
      ...
      internal Boolean IsDecliningPermanently { get { return _target._decliningPermanently; } }

      /// <summary>Gets whether the block is completed.</summary>
      internal Boolean IsCompleted { get { return _target.Completion.IsCompleted; } }
    }
