...
namespace System.Threading.Tasks.Dataflow.Internal
{
	...
	internal sealed class DataflowEtwProvider : EventSource
	{
		...
		private void DataflowBlockCreated(string blockName, Int32 blockId)
		{
		...
		private void TaskLaunchedForMessageHandling(Int32 blockId, TaskLaunchedReason reason, Int32 availableMessages, Int32 taskId)
		{
			// There is no explicit WriteEvent() overload matching this event's fields:
			//     WriteEvent(TASKLAUNCHED_EVENTID, blockId, (Int32)reason, availableMessages, taskId);
		...
		internal void DataflowBlockCompleted(IDataflowBlock block)
		{
			...
			if (IsEnabled(EventLevel.Informational, ALL_KEYWORDS))
			{
				...
				Boolean blockIsCompleted = completionTask != null && completionTask.IsCompleted;
		...
		internal enum BlockCompletionReason
		{
			...
			RanToCompletion = (Int32)TaskStatus.RanToCompletion,

			/// <summary>The block completed due to an error.</summary>
			Faulted = (Int32)TaskStatus.Faulted,

			/// <summary>The block completed due to cancellation.</summary>
			Canceled = (Int32)TaskStatus.Canceled
		}

		[Event(BLOCKCOMPLETED_EVENTID, Level = EventLevel.Informational)]
		private void DataflowBlockCompleted(Int32 blockId, BlockCompletionReason reason, string exceptionData)
		{
			WriteEvent(BLOCKCOMPLETED_EVENTID, blockId, (Int32)reason, exceptionData);
		}
		...
		private void DataflowBlockLinking(Int32 sourceId, Int32 targetId)
		{
		...
		private void DataflowBlockUnlinking(Int32 sourceId, Int32 targetId)
		{
