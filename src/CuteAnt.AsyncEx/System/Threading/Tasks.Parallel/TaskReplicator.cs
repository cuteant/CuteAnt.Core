...
namespace System.Threading.Tasks
{
	...
	internal class TaskReplicator
	{
		...
		private TaskReplicator(ParallelOptionsX options, bool stopOnFirstFailure)
		{
			_scheduler = options.TaskScheduler ?? TaskScheduler.Current;
			_stopOnFirstFailure = stopOnFirstFailure;
		}

		public static void Run<TState>(ReplicatableUserAction<TState> action, ParallelOptionsX options, bool stopOnFirstFailure)
		{
