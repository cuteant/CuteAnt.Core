...
namespace System.Threading.Tasks
{
	...
	/// the default TaskScheduler (TaskScheduler.Default). <see cref="ParallelOptionsX"/> enables
	/// overriding these defaults.
	/// </remarks>
	public class ParallelOptionsX
	{
		private TaskScheduler _scheduler;
		private int _maxDegreeOfParallelism;
		private CancellationToken _cancellationToken;

		/// <summary>Initializes a new instance of the <see cref="ParallelOptionsX"/> class.</summary>
		/// <remarks>
		...
		/// associated with this <see cref="ParallelOptionsX"/> instance. Setting this property to null
		...
		/// associated with this <see cref="ParallelOptionsX"/> instance.
		/// </summary>
		/// <remarks>
	...
	public static class ParallelX
	{
		...
		internal static ParallelOptionsX s_defaultParallelOptions = new ParallelOptionsX();
		...
		/// occurs due to normal or exceptional termination.
		/// </remarks>
		public static void Invoke(ParallelOptionsX parallelOptions, params Action[] actions)
		{
			if (actions == null)
			{
		...
		/// </remarks>
		public static ParallelLoopResultX For(int fromInclusive, int toExclusive, Action<int> body)
		{
			if (body == null)
			{
		...
		/// </remarks>
		public static ParallelLoopResultX For(long fromInclusive, long toExclusive, Action<long> body)
		{
			if (body == null)
			{
				throw new ArgumentNullException("body");
		...
		/// [fromInclusive, toExclusive).  It is provided with the iteration count (an Int32) as a parameter.
		/// </remarks>
		public static ParallelLoopResultX For(int fromInclusive, int toExclusive, ParallelOptionsX parallelOptions, Action<int> body)
		{
			if (body == null)
			{
				throw new ArgumentNullException("body");
		...
		/// [fromInclusive, toExclusive).  It is provided with the iteration count (an Int64) as a parameter.
		/// </remarks>
		public static ParallelLoopResultX For(long fromInclusive, long toExclusive, ParallelOptionsX parallelOptions, Action<long> body)
		{
			if (body == null)
			{
				throw new ArgumentNullException("body");
		...
		/// and a <see cref="System.Threading.Tasks.ParallelLoopStateX">ParallelLoopState</see> instance that may be 
		/// used to break out of the loop prematurely.
		/// </para>
		/// <para>
		/// Calling <see cref="System.Threading.Tasks.ParallelLoopStateX.Break()">ParallelLoopState.Break()</see>
		...
		/// <see cref="System.Threading.Tasks.ParallelLoopStateX.Stop()">ParallelLoopState.Stop()</see>
		...
		/// </para>
		/// </remarks>
		public static ParallelLoopResultX For(int fromInclusive, int toExclusive, Action<int, ParallelLoopStateX> body)
		{
			if (body == null)
			{
				throw new ArgumentNullException("body");
		...
		/// used to break out of the loop prematurely.
		/// </remarks>
		public static ParallelLoopResultX For(long fromInclusive, long toExclusive, Action<long, ParallelLoopStateX> body)
		{
			if (body == null)
			{
				throw new ArgumentNullException("body");
		...
		/// used to break out of the loop prematurely.
		/// </remarks>
		public static ParallelLoopResultX For(int fromInclusive, int toExclusive, ParallelOptionsX parallelOptions, Action<int, ParallelLoopStateX> body)
		{
			if (body == null)
			{
				throw new ArgumentNullException("body");
		...
		/// used to break out of the loop prematurely.
		/// </remarks>
		public static ParallelLoopResultX For(long fromInclusive, long toExclusive, ParallelOptionsX parallelOptions,
				Action<long, ParallelLoopStateX> body)
		{
			if (body == null)
			{
				throw new ArgumentNullException("body");
		...
		/// The <paramref name="body"/> delegate is invoked once for each value in the iteration range: 
		/// [fromInclusive, toExclusive).  It is provided with the following parameters: the iteration count (an Int32), 
		/// a <see cref="System.Threading.Tasks.ParallelLoopStateX">ParallelLoopState</see> instance that may be 
		...
		/// </para>
		/// </remarks>
		public static ParallelLoopResultX For<TLocal>(
				int fromInclusive, int toExclusive,
				Func<TLocal> localInit,
				Func<int, ParallelLoopStateX, TLocal, TLocal> body,
		...
		public static ParallelLoopResultX For<TLocal>(
				...
				Func<TLocal> localInit,
				Func<long, ParallelLoopStateX, TLocal, TLocal> body,
				Action<TLocal> localFinally)
		{
			if (body == null)
			{
		...
		/// </remarks>
		public static ParallelLoopResultX For<TLocal>(
				int fromInclusive, int toExclusive, ParallelOptionsX parallelOptions,
				Func<TLocal> localInit,
				Func<int, ParallelLoopStateX, TLocal, TLocal> body,
				Action<TLocal> localFinally)
		{
		...
		/// </remarks>
		public static ParallelLoopResultX For<TLocal>(
				long fromInclusive, long toExclusive, ParallelOptionsX parallelOptions,
				Func<TLocal> localInit,
				Func<long, ParallelLoopStateX, TLocal, TLocal> body,
				Action<TLocal> localFinally)
		{
		...
		private static ParallelLoopResultX ForWorker<TLocal>(
				int fromInclusive, int toExclusive,
				ParallelOptionsX parallelOptions,
				Action<int> body,
				Action<int, ParallelLoopStateX> bodyWithState,
				Func<int, ParallelLoopStateX, TLocal, TLocal> bodyWithLocal,
				Func<TLocal> localInit, Action<TLocal> localFinally)
		{
			...
			ParallelLoopResultX result = new ParallelLoopResultX();
		...
		/// <remarks>Only one of the body arguments may be supplied (i.e. they are exclusive).</remarks>
		/// <returns>A <see cref="T:System.Threading.Tasks.ParallelLoopResult"/> structure.</returns>
		private static ParallelLoopResultX ForWorker64<TLocal>(
				long fromInclusive, long toExclusive,
				ParallelOptionsX parallelOptions,
				Action<long> body,
				Action<long, ParallelLoopStateX> bodyWithState,
				Func<long, ParallelLoopStateX, TLocal, TLocal> bodyWithLocal,
				Func<TLocal> localInit, Action<TLocal> localFinally)
		{
			Debug.Assert(((body == null ? 0 : 1) + (bodyWithState == null ? 0 : 1) + (bodyWithLocal == null ? 0 : 1)) == 1,
					"expected exactly one body function to be supplied");
		...
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource>(IEnumerable<TSource> source, Action<TSource> body)
		{
			if (source == null)
			{
		...
		/// enumerable.  It is provided with the current element as a parameter.
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource>(IEnumerable<TSource> source, ParallelOptionsX parallelOptions, Action<TSource> body)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		/// used to break out of the loop prematurely.
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource>(IEnumerable<TSource> source, Action<TSource, ParallelLoopStateX> body)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		/// used to break out of the loop prematurely.
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource>(IEnumerable<TSource> source, ParallelOptionsX parallelOptions, Action<TSource, ParallelLoopStateX> body)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource>(IEnumerable<TSource> source, Action<TSource, ParallelLoopStateX, long> body)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		/// used to break out of the loop prematurely, and the current element's index (an Int64).
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource>(IEnumerable<TSource> source, ParallelOptionsX parallelOptions, Action<TSource, ParallelLoopStateX, long> body)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		/// </para>
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource, TLocal>(IEnumerable<TSource> source, Func<TLocal> localInit,
				Func<TSource, ParallelLoopStateX, TLocal, TLocal> body, Action<TLocal> localFinally)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		/// </para>
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource, TLocal>(IEnumerable<TSource> source,
				ParallelOptionsX parallelOptions, Func<TLocal> localInit,
				Func<TSource, ParallelLoopStateX, TLocal, TLocal> body, Action<TLocal> localFinally)
		{
			if (source == null)
			{
		...
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource, TLocal>(IEnumerable<TSource> source, Func<TLocal> localInit,
				Func<TSource, ParallelLoopStateX, long, TLocal, TLocal> body, Action<TLocal> localFinally)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		/// </para>
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource, TLocal>(IEnumerable<TSource> source, ParallelOptionsX parallelOptions, Func<TLocal> localInit,
				Func<TSource, ParallelLoopStateX, long, TLocal, TLocal> body, Action<TLocal> localFinally)
		{
			if (source == null)
			{
		...
		/// <returns>A <see cref="T:System.Threading.Tasks.ParallelLoopResult"/> structure.</returns>
		private static ParallelLoopResultX ForEachWorker<TSource, TLocal>(
				IEnumerable<TSource> source,
				ParallelOptionsX parallelOptions,
				Action<TSource> body,
				Action<TSource, ParallelLoopStateX> bodyWithState,
				Action<TSource, ParallelLoopStateX, long> bodyWithStateAndIndex,
				Func<TSource, ParallelLoopStateX, TLocal, TLocal> bodyWithStateAndLocal,
				Func<TSource, ParallelLoopStateX, long, TLocal, TLocal> bodyWithEverything,
				Func<TLocal> localInit, Action<TLocal> localFinally)
		{
		...
		/// </para>
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource>(
		...
		public static ParallelLoopResultX ForEach<TSource>(
				Partitioner<TSource> source,
				Action<TSource, ParallelLoopStateX> body)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		public static ParallelLoopResultX ForEach<TSource>(
				...
				Action<TSource, ParallelLoopStateX, long> body)
		{
			if (source == null)
			{
				throw new ArgumentNullException("source");
		...
		/// </para>
		/// </remarks>
		public static ParallelLoopResultX ForEach<TSource, TLocal>(
				Partitioner<TSource> source,
				Func<TLocal> localInit,
				Func<TSource, ParallelLoopStateX, TLocal, TLocal> body,
				Action<TLocal> localFinally)
		{
			if (source == null)
			{
		...
		public static ParallelLoopResultX ForEach<TSource, TLocal>(
				OrderablePartitioner<TSource> source,
				Func<TLocal> localInit,
				Func<TSource, ParallelLoopStateX, long, TLocal, TLocal> body,
				Action<TLocal> localFinally)
		{
			if (source == null)
			{
		...
		private static ParallelLoopResultX PartitionerForEachWorker<TSource, TLocal>(
																																				 ...
																																				 Exception otherException)
		{
			...
			if (reducedCancelEx != null)
			{
				...
				throw ExceptionHelpers.PrepareForRethrow(reducedCancelEx);
			}
			else
			{
				//ExceptionDispatchInfo.Capture(otherException).Throw();
				throw ExceptionHelpers.PrepareForRethrow(otherException);
			}
		}
	}  // class Parallel
}  // namespace
