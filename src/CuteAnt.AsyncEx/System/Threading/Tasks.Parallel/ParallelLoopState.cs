...
namespace System.Threading.Tasks
{
	...
	public class ParallelLoopStateX
	{
		...
		internal ParallelLoopStateX(ParallelLoopStateFlags fbase)
		{
			_flagsBase = fbase;
		}
		...
		/// when one throws an exception, or when the loop is canceled, the <see cref="ParallelX"/> class will proactively
		...
		/// <summary>
		/// Communicates that the <see cref="ParallelX"/> loop should cease execution at the system's earliest
		/// convenience.
		/// </summary>
	...
	internal class ParallelLoopState32 : ParallelLoopStateX
	{
		...
		{
			ParallelLoopStateX.Break(CurrentIteration, _sharedParallelStateFlags);
		}
	}

	/// <summary>Allows independent iterations of a parallel loop to interact with other iterations.</summary>
	internal class ParallelLoopState64 : ParallelLoopStateX
	{
	...
	/// <summary>Provides completion status on the execution of a <see cref="ParallelX"/> loop.</summary>
	/// <remarks>
	...
	/// cref="System.Threading.Tasks.ParallelLoopStateX.Stop"/> was used to end the loop prematurely. If <see
	/// cref="IsCompleted"/> returns false and <see cref="LowestBreakIteration"/> returns a non-null integral
	/// value, <see cref="System.Threading.Tasks.ParallelLoopStateX.Break()"/> was used to end the loop prematurely.
	/// </remarks>
	public struct ParallelLoopResultX
	{
		...
		/// cref="System.Threading.Tasks.ParallelLoopStateX.Break()"/>
		/// was called.
		/// </summary>
		/// <remarks>
		/// If <see cref="System.Threading.Tasks.ParallelLoopStateX.Break()"/> was not employed, this property will
		/// return null.
		/// </remarks>
