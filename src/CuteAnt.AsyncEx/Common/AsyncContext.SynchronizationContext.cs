...
namespace CuteAnt.AsyncEx
{
	public sealed partial class AsyncContext
	{
		...
		private sealed class AsyncContextSynchronizationContext : SynchronizationContext
		{
			...
			/// <summary>Dispatches an asynchronous message to the async context. 
			...
			/// It is considered equal if it refers to the same underlying async context as this instance.</summary>
