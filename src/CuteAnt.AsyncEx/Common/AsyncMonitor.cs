...
namespace CuteAnt.AsyncEx
{
	...
	public sealed class AsyncMonitor
	{
		...
		/// <param name="cancellationToken">The cancellation token used to cancel the enter. If this is already set, 
		/// then this method will attempt to enter the monitor immediately (succeeding if the monitor is currently available).</param>
		...
		/// <summary>Synchronously enters the monitor. Returns a disposable that leaves the monitor when disposed. 
		...
		/// <summary>Asynchronously enters the monitor. Returns a disposable that leaves the monitor when disposed. 
		/// This method may block the calling thread.</summary>
		...
		/// <summary>Asynchronously waits for a pulse signal on this monitor. 
		/// The monitor MUST already be entered when calling this method, and it will still be entered when this method returns, 
		/// even if the method is cancelled. This method internally will leave the monitor while waiting for a notification.</summary>
		...
		/// <summary>Asynchronously waits for a pulse signal on this monitor. 
		/// This method may block the calling thread. The monitor MUST already be entered when calling this method, 
		/// and it will still be entered when this method returns, even if the method is cancelled. 
		/// This method internally will leave the monitor while waiting for a notification.</summary>
		/// <param name="cancellationToken">The cancellation signal used to cancel this wait.</param>
		...
		/// <summary>Asynchronously waits for a pulse signal on this monitor. 
		/// This method may block the calling thread. The monitor MUST already be entered when calling this method, 
		/// and it will still be entered when this method returns. 
		/// This method internally will leave the monitor while waiting for a notification.</summary>
		public void Wait()
		{
		...
		/// <summary>Sends a signal to a single task waiting on this monitor. 
		/// The monitor MUST already be entered when calling this method, 
		/// and it will still be entered when this method returns.</summary>
		public void Pulse()
		{
			_conditionVariable.Notify();
		}

		/// <summary>Sends a signal to all tasks waiting on this monitor. 
		/// The monitor MUST already be entered when calling this method, 
		/// and it will still be entered when this method returns.</summary>
