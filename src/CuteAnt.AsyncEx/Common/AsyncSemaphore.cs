...
{
	/// <summary>An async-compatible semaphore. Alternatively, you could use <c>SemaphoreSlim</c> on .NET 4.5 / Windows Store.</summary>
	...
	public sealed class AsyncSemaphore
	{
		...
		public AsyncSemaphore(Int32 initialCount, IAsyncWaitQueue<Object> queue)
		{
			_queue = queue;
			_count = initialCount;
			_mutex = new Object();
		...
		/// If this is already set, then this method will attempt to take the slot immediately (succeeding if a slot is currently available).</param>
		...
		public void Release(Int32 releaseCount)
		{
			...
			lock (_mutex)
			{
				if (_count > Int32.MaxValue - releaseCount)
		...
		private sealed class DebugView
		{
			...
			public Int32 Id { get { return _semaphore.Id; } }

			public Int32 CurrentCount { get { return _semaphore._count; } }
