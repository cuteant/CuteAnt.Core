...
{
  /// <summary>A progress implementation that stores progress updates in a property. 
  /// If this instance is created on a UI thread, its <see cref="Progress"/> property is suitable for data binding.</summary>
  ...
  {
    /// <summary>The context of the thread that created this instance.</summary>
    private readonly SynchronizationContext _context;

    /// <summary>The last reported progress value.</summary>
    private T _progress;

    /// <summary>Initializes a new instance of the <see cref="PropertyProgress&lt;T&gt;"/> class.</summary>
