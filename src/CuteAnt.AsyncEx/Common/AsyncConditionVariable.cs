...
namespace CuteAnt.AsyncEx
{
	...
	public sealed class AsyncConditionVariable
	{
		...
		/// <summary>Sends a signal to a single task waiting on this condition variable. 
		/// The associated lock MUST be held when calling this method, and it will still be held when this method returns.</summary>
		public void Notify()
		{
		...
		/// <summary>Sends a signal to all tasks waiting on this condition variable. 
		/// The associated lock MUST be held when calling this method, and it will still be held when this method returns.</summary>
		...
		/// even if the method is cancelled.</summary>
		...
		/// <summary>Synchronously waits for a signal on this condition variable. This method may block the calling thread. 
		/// The associated lock MUST be held when calling this method, and it will still be held when this method returns, 
		/// even if the method is cancelled.</summary>
		/// <param name="cancellationToken">The cancellation signal used to cancel this wait.</param>
		...
		/// <summary>Asynchronously waits for a signal on this condition variable. The associated lock MUST be held when calling this method, 
		...
		private sealed class DebugView
		{
			...
			public Int32 Id { get { return _cv.Id; } }
