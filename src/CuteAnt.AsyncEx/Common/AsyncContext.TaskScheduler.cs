...
namespace CuteAnt.AsyncEx
{
	...
	{
		/// <summary>A task scheduler which schedules tasks to an async context.</summary>
		private sealed class AsyncContextTaskScheduler : TaskScheduler
		{
			/// <summary>The async context for this task scheduler.</summary>
			private readonly AsyncContext _context;

			/// <summary>Initializes a new instance of the <see cref="AsyncContextTaskScheduler"/> class.</summary>
			...
			/// <summary>Generates an enumerable of <see cref="T:System.Threading.Tasks.Task"/> instances 
			/// currently queued to the scheduler waiting to be executed.</summary>
			...
			/// <summary>Queues a <see cref="T:System.Threading.Tasks.Task"/> to the scheduler. 
			...
			/// <summary>Determines whether the provided <see cref="T:System.Threading.Tasks.Task"/> 
			/// can be executed synchronously in this call, and if it can, executes it.</summary>
			/// <param name="task">The <see cref="T:System.Threading.Tasks.Task"/> to be executed.</param>
			/// <param name="taskWasPreviouslyQueued">A Boolean denoting whether or not task has previously been queued. 
			...
			/// and this call is being made in order to execute the task inline without queuing it.</param>
			...
			/// <summary>Exposes the base <see cref="TaskScheduler.TryExecuteTask"/> method.</summary>
