...
namespace CuteAnt.Reflection
{
  public static class TypeHelper
  {
    ...
    public static readonly Type ObjectType = TypeX._.Object; // typeof(object);
    public static readonly Type StringType = TypeX._.String; // typeof(string);
    public static readonly Type TypeType = TypeX._.Type; // typeof(Type);
