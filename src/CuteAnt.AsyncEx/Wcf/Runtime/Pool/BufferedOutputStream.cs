...
namespace CuteAnt.Pool
{
  public class BufferedOutputStream : Stream
  {
    ...
    public const Int32 DefaultBufferSize = 1024 * 16;
    ...
    //  : this(initialSize, Int32.MaxValue, BufferManager.CreateSingleInstance())
    //{
    //}
    ...
    internal void Reinitialize(int initialSize, int maxSizeQuota, int effectiveMaxSize, InternalBufferManager bufferManager)
    {
      ...
      if (bufferManager == null) { throw Fx.Exception.ArgumentNull("bufferManager"); }
    ...
    {
      if (offset < 0) { throw Fx.Exception.ArgumentOutOfRange("offset", offset, InternalSR.ValueMustBeNonNegative); }
    ...
    public unsafe void Write(Char ch)
    {
      ...
      {
        numBytes = InternalEncoder.GetBytes(&ch, 1, pBytes, 16, true);
      }
    ...
    public void Write(Char[] chars, Int32 index, Int32 count)
    {
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    public unsafe void Write(Double value, Boolean bigEndian = true)
    {
    ...
    /// <param name="bigEndian">if set to <c>true</c> [big-endian].</param>
    public void Write(Decimal value, Boolean bigEndian = true)
    {
    ...
    /// <param name="bigEndian">if set to <c>true</c> [big-endian].</param>
    public void Write(Int16 value, Boolean bigEndian = true)
    {
      GetBytes(value, _buffer, bigEndian);
      Write(_buffer, 0, 2);
    }
    ...
    /// <param name="bigEndian">if set to <c>true</c> [big-endian].</param>
    [CLSCompliant(false)]
    public void Write(UInt16 value, Boolean bigEndian = true)
    {
      GetBytes(value, _buffer, bigEndian);
      Write(_buffer, 0, 2);
    }
    ...
    /// <param name="bigEndian">if set to <c>true</c> [big-endian].</param>
    public void Write(Int32 value, Boolean bigEndian = true)
    {
      GetBytes(value, _buffer, bigEndian);
      Write(_buffer, 0, 4);
    }
    ...
    /// <param name="bigEndian">if set to <c>true</c> [big-endian].</param>
    [CLSCompliant(false)]
    public void Write(UInt32 value, Boolean bigEndian = true)
    {
      GetBytes(value, _buffer, bigEndian);
      Write(_buffer, 0, 4);
    }
    ...
    /// <param name="bigEndian">if set to <c>true</c> [big-endian].</param>
    public void Write(Int64 value, Boolean bigEndian = true)
    {
      GetBytes(value, _buffer, bigEndian);
      Write(_buffer, 0, 8);
    }
    ...
    /// <param name="bigEndian">if set to <c>true</c> [big-endian].</param>
    [CLSCompliant(false)]
    public void Write(UInt64 value, Boolean bigEndian = true)
    {
      GetBytes(value, _buffer, bigEndian);
      Write(_buffer, 0, 8);
    }
    ...
    /// <param name="bigEndian">if set to <c>true</c> [big-endian].</param>
    [System.Security.SecuritySafeCritical]  // auto-generated
    public unsafe void Write(Single value, Boolean bigEndian = true)
    {
    ...
    [System.Security.SecuritySafeCritical]  // auto-generated
    public unsafe void Write(String value, Boolean include7BitEncodedSize = true)
    {
      ...
      {
        _largeByteBuffer = _bufferManager.TakeBuffer(LargeByteBufferSize); //new byte[LargeByteBufferSize];
    ...
    public void Clear()
    {
      ...
      if (_largeByteBuffer != null) { _bufferManager.ReturnBuffer(_largeByteBuffer); }
      _maxChars = 0;
    ...
    #region -- ToReadOnlyMemoryStream --

    public BufferedReadOnlyMemoryStream ToReadOnlyMemoryStream()
    {
      int bufferSize;
      byte[] buffer = ToArray(out bufferSize);
      return new BufferedReadOnlyMemoryStream(buffer, 0, bufferSize, _encoding, _bufferManager);
    }
    ...
    public ArraySegmentShim<byte> ToArraySegment()
    {
      ...
      return new ArraySegmentShim<byte>(buffer, 0, bufferSize);
    }
