...
namespace CuteAnt.AsyncEx
{
  public sealed partial class AsyncContext
  {
    ...
    private sealed class AsyncContextTaskScheduler : TaskScheduler
    {
      ...
      protected override IEnumerable<Task> GetScheduledTasks() => _context._queue.GetScheduledTasks();

      /// <summary>Queues a <see cref="T:System.Threading.Tasks.Task"/> to the scheduler. If all tasks have been completed and the outstanding asynchronous operation count is zero, then this method has undefined behavior.</summary>
      /// <param name="task">The <see cref="T:System.Threading.Tasks.Task"/> to be queued.</param>
      protected override void QueueTask(Task task) => _context.Enqueue(task, false);
      ...
      protected override bool TryExecuteTaskInline(Task task, bool taskWasPreviouslyQueued) => (AsyncContext.Current == _context) && TryExecuteTask(task);
      ...
      public void DoTryExecuteTask(Task task) => TryExecuteTask(task);
    }
  }
}
