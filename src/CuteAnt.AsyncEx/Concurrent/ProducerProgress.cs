...
{
	/// <summary>A progress implementation that sends progress reports to a producer/consumer collection.</summary>
	/// <typeparam name="T">The type of progress value.</typeparam>
	public sealed class ProducerProgress<T> : IProgress<T>
	{
		/// <summary>The producer/consumer collection that receives progress reports.</summary>
		private readonly IProducerConsumerCollection<T> _collection;

		/// <summary>Initializes a new instance of the <see cref="ProducerProgress&lt;T&gt;"/> class.</summary>
