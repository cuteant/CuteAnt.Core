...
{
	/// <summary>An object that implements an equality comparer using delegates.</summary>
	/// <typeparam name="T">The type of objects being compared.</typeparam>
	public sealed class AnonymousEqualityComparer<T> : EqualityComparerBase<T>
	{
		/// <summary>Gets or sets a delegate which compares two objects and returns <c>true</c> if they are equal and <c>false</c> if they are not equal.</summary>
		public new Func<T, T, Boolean> Equals { get; set; }
		...
		/// <summary>Initializes a new instance of the <see cref="AnonymousEqualityComparer{T}"/> class.</summary>
		...
		public AnonymousEqualityComparer(Boolean allowNulls = false)
			: base(allowNulls)
		{
		}
