...
namespace CuteAnt.EqualityComparers.Util
{
	...
	public static class UtilityEqualityComparerExtensions
	{
		...
		public static IFullEqualityComparer<T> SelectEquateFrom<T, TSource>(this IEqualityComparer<TSource> source, Func<T, TSource> selector, Boolean allowNulls = false)
		{
