...
namespace CuteAnt.EqualityComparers
{
	...
	public static class EqualityComparerExtensions
	{
		...
		public static IFullEqualityComparer<T> ThenEquateBy<T, TKey>(this IEqualityComparer<T> source, Func<T, TKey> selector, IEqualityComparer<TKey> keyComparer = null, Boolean allowNulls = false)
		{
