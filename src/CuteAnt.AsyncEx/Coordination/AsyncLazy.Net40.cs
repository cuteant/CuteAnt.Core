...
namespace CuteAnt.AsyncEx
{
  ...
  public sealed class AsyncLazy<T>
  {
    ...
    /// <param name="factory">The delegate that is invoked on a background thread to produce the value 
    /// when it is needed. May not be <c>null</c>.</param>
    ...
    /// <summary>Initializes a new instance of the <see cref="AsyncLazy&lt;T&gt;"/> class.</summary>
    /// <param name="factory">The asynchronous delegate that is invoked on a background thread to produce 
    /// the value when it is needed. May not be <c>null</c>.</param>
    ...
    /// <summary>Whether the asynchronous factory method has started. This is initially <c>false</c> 
    /// and becomes <c>true</c> when this instance is awaited or after <see cref="Start"/> is called.</summary>
    public bool IsStarted
    {
      get { return _instance.IsValueCreated; }
    }

    /// <summary>Asynchronous infrastructure support. 
    /// This method permits instances of <see cref="AsyncLazy&lt;T&gt;"/> to be await'ed.</summary>
