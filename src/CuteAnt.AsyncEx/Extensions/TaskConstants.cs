...
namespace CuteAnt.AsyncEx
{
	...
	public static class TaskConstants
	{
		...
		public static Task<Boolean> BooleanFalse { get { return TaskConstants<Boolean>.Default; } }

		/// <summary>A task that has been completed with the value <c>0</c>.</summary>
		public static Task<Int32> Int32Zero { get { return TaskConstants<Int32>.Default; } }

		public static Task<Object> NullResult() { return TaskConstants<Object>.Default; }

		/// <summary>A <see cref="Task"/> that has been completed.</summary>
		public static Task Completed { get { return TaskConstants<AsyncVoid>.Default; } }

		/// <summary>A <see cref="Task"/> that will never complete.</summary>
		public static Task Never { get { return TaskConstants<AsyncVoid>.Never; } }

		/// <summary>A task that has been canceled.</summary>
		public static Task Canceled { get { return TaskConstants<AsyncVoid>.Canceled; } }
