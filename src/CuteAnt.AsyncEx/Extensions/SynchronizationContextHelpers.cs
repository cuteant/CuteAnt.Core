...
namespace CuteAnt.AsyncEx
{
	...
	{
		/// <summary>Retrieves the current synchronization context, or the default synchronization context 
		/// if there is no current synchronization context.</summary>
		public static SynchronizationContext CurrentOrDefault
		{
			get { return SynchronizationContext.Current ?? new SynchronizationContext(); }
		}
		...
		public sealed class SynchronizationContextSwitcher : IDisposable
		{
			...
			/// <summary>Whether this object has already been disposed.</summary>
