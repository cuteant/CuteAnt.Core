...
namespace CuteAnt.AsyncEx
{
    ...
    public static class TaskCompletionSourceExtensions
    {
        ...
        {
            if (@this is null) { ThrowHelper.ThrowArgumentNullException(ExceptionArgument.@this); }
        ...
        public static bool TryCompleteFromCompletedTask<TResult>(this TaskCompletionSource<TResult> @this, Task task, Func<TResult> resultFunc)
        {
            if (@this is null) { ThrowHelper.ThrowArgumentNullException(ExceptionArgument.@this); }
            if (task is null) { ThrowHelper.ThrowArgumentNullException(ExceptionArgument.task); }
            if (resultFunc is null) { ThrowHelper.ThrowArgumentNullException(ExceptionArgument.resultFunc); }
