...
namespace CuteAnt.AsyncEx.Interop
{
    /// <summary>
    ...
    public static class EventAsyncFactory
    {
        ...
        {
            if (convert is null) { ThrowHelper.ThrowArgumentNullException(ExceptionArgument.convert); }
            if (subscribe is null) { ThrowHelper.ThrowArgumentNullException(ExceptionArgument.subscribe); }
            if (unsubscribe is null) { ThrowHelper.ThrowArgumentNullException(ExceptionArgument.unsubscribe); }
