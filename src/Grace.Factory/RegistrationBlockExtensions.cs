...
{
  /// <summary>C# extensions for registration block</summary>
  public static class RegistrationBlockExtensions
  {
    /// <summary>Export all missing interfaces as factories, this can be filtered</summary>
    ...
    /// <summary>Export Factory Interface</summary>
