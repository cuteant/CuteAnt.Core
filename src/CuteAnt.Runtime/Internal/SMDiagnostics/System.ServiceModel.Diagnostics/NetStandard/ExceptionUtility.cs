...
namespace CuteAnt.ServiceModel.Diagnostics
{
  ...
  {
    private const string ExceptionStackAsStringKey = "CuteAnt.ServiceModel.Diagnostics.ExceptionUtility.ExceptionStackAsString";
...
#pragma warning restore 649
    ...
    {
      return this.ThrowHelperCallback("GenericCallbackException", innerException); // SR.GenericCallbackException
    }
