...
namespace CuteAnt.Diagnostics
{
  internal partial class TraceCore
  {
    ...
    static CuteAnt.Diagnostics.EventDescriptor[] eventDescriptors;
    ...
    internal static void AppDomainUnload(EtwDiagnosticTrace trace, string appdomainName, string processName, string processId)
    {
      ...
      {
        string description = string.Format(ResourceManager.AppDomainUnload, appdomainName, processName, processId);
    ...
    internal static void HandledException(EtwDiagnosticTrace trace, string param0, System.Exception exception)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Informational))
      {
        string description = string.Format(ResourceManager.HandledException, param0);
    ...
    internal static void ShipAssertExceptionMessage(EtwDiagnosticTrace trace, string param0)
    {
      ...
      {
        string description = string.Format(ResourceManager.ShipAssertExceptionMessage, param0);
    ...
    internal static void ThrowingException(EtwDiagnosticTrace trace, string param0, string param1, System.Exception exception)
    {
      ...
      {
        string description = string.Format(ResourceManager.ThrowingException, param0, param1);
    ...
    internal static void UnhandledException(EtwDiagnosticTrace trace, string param0, System.Exception exception)
    {
      ...
      {
        string description = string.Format(ResourceManager.UnhandledException, param0);
    ...
    internal static void TraceCodeEventLogCritical(EtwDiagnosticTrace trace, TraceRecord traceRecord)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Critical))
      {
        string description = ResourceManager.TraceCodeEventLogCritical;
    ...
    internal static void TraceCodeEventLogError(EtwDiagnosticTrace trace, TraceRecord traceRecord)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Error))
      {
        string description = ResourceManager.TraceCodeEventLogError;
    ...
    internal static void TraceCodeEventLogInfo(EtwDiagnosticTrace trace, TraceRecord traceRecord)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Informational))
      {
        string description = ResourceManager.TraceCodeEventLogInfo;
    ...
    internal static void TraceCodeEventLogVerbose(EtwDiagnosticTrace trace, TraceRecord traceRecord)
    {
      ...
      {
        string description = ResourceManager.TraceCodeEventLogVerbose;
    ...
    internal static void TraceCodeEventLogWarning(EtwDiagnosticTrace trace, TraceRecord traceRecord)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Warning))
      {
        string description = ResourceManager.TraceCodeEventLogWarning;
    ...
    internal static void HandledExceptionWarning(EtwDiagnosticTrace trace, string param0, System.Exception exception)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Warning))
      {
        string description = string.Format(ResourceManager.HandledExceptionWarning, param0);
    ...
    internal static void HandledExceptionError(EtwDiagnosticTrace trace, string param0, System.Exception exception)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Error))
      {
        string description = string.Format(ResourceManager.HandledExceptionError, param0);
    ...
    internal static void HandledExceptionVerbose(EtwDiagnosticTrace trace, string param0, System.Exception exception)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Verbose))
      {
        string description = string.Format(ResourceManager.HandledExceptionVerbose, param0);
    ...
    internal static void ThrowingExceptionVerbose(EtwDiagnosticTrace trace, string param0, string param1, System.Exception exception)
    {
      ...
      if (trace.ShouldTraceToTraceSource(TraceEventLevel.Verbose))
      {
        string description = string.Format(ResourceManager.ThrowingExceptionVerbose, param0, param1);
    ...
    {
      eventDescriptors = new CuteAnt.Diagnostics.EventDescriptor[] {
                    new CuteAnt.Diagnostics.EventDescriptor(57393, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Informational, (byte)TraceEventOpcode.Info, 0x0, 0x1000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57394, 0, (byte)TraceChannel.Analytic, (byte)TraceEventLevel.Informational, (byte)TraceEventOpcode.Info, 0x0, 0x2000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57395, 0, (byte)TraceChannel.Analytic, (byte)TraceEventLevel.Error, (byte)TraceEventOpcode.Info, 0x0, 0x2000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57396, 0, (byte)TraceChannel.Analytic, (byte)TraceEventLevel.Warning, (byte)TraceEventOpcode.Info, 0x0, 0x2000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57397, 0, (byte)TraceChannel.Operational, (byte)TraceEventLevel.Critical, (byte)TraceEventOpcode.Info, 0x0, 0x4000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57399, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Critical, (byte)TraceEventOpcode.Info, 0x0, 0x1000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57400, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Error, (byte)TraceEventOpcode.Info, 0x0, 0x1000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57401, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Informational, (byte)TraceEventOpcode.Info, 0x0, 0x1000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57402, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Verbose, (byte)TraceEventOpcode.Info, 0x0, 0x1000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57403, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Warning, (byte)TraceEventOpcode.Info, 0x0, 0x1000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57404, 0, (byte)TraceChannel.Analytic, (byte)TraceEventLevel.Warning, (byte)TraceEventOpcode.Info, 0x0, 0x2000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(131, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Verbose, (byte)12, 0x9cd, 0x1000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(132, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Verbose, (byte)13, 0x9cd, 0x1000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(133, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Verbose, (byte)TraceEventOpcode.Start, 0xa21, 0x1000000000200000),
                    new CuteAnt.Diagnostics.EventDescriptor(134, 0, (byte)TraceChannel.Debug, (byte)TraceEventLevel.Verbose, (byte)TraceEventOpcode.Stop, 0xa21, 0x1000000000200000),
                    new CuteAnt.Diagnostics.EventDescriptor(57405, 0, (byte)TraceChannel.Operational, (byte)TraceEventLevel.Error, (byte)TraceEventOpcode.Info, 0x0, 0x4000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57406, 0, (byte)TraceChannel.Analytic, (byte)TraceEventLevel.Verbose, (byte)TraceEventOpcode.Info, 0x0, 0x2000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57408, 0, (byte)TraceChannel.Operational, (byte)TraceEventLevel.Critical, (byte)TraceEventOpcode.Info, 0x0, 0x4000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57410, 0, (byte)TraceChannel.Analytic, (byte)TraceEventLevel.Warning, (byte)TraceEventOpcode.Info, 0x0, 0x2000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57409, 0, (byte)TraceChannel.Analytic, (byte)TraceEventLevel.Verbose, (byte)TraceEventOpcode.Info, 0x0, 0x2000000000010000),
                    new CuteAnt.Diagnostics.EventDescriptor(57407, 0, (byte)TraceChannel.Analytic, (byte)TraceEventLevel.Verbose, (byte)TraceEventOpcode.Info, 0x0, 0x2000000000010000)};
    }
