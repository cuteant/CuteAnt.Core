...
// System.ServiceModel.Internals\System\Runtime\ScheduleActionItemAsyncResult.cs

using System;

namespace CuteAnt.Runtime
{
  /// <summary>An AsyncResult that schedules work for later on the IOThreadScheduler</summary>
  public abstract class ScheduleActionItemAsyncResult : AsyncResult
  {
