...
{
  /// <summary>Abstract class for histgram value statistics, instantiate either HistogramValueStatistic or LinearHistogramValueStatistic</summary>
  public abstract class HistogramValueStatistic
  {
  ...
  /// <summary>Histogram created where buckets grow exponentially</summary>
  public class ExponentialHistogramValueStatistic : HistogramValueStatistic
  {
  ...
  /// <summary>Histogram created where buckets are uniform size.</summary>
  public class LinearHistogramValueStatistic : HistogramValueStatistic
  {
