...
{
  public class RuntimeStatisticsGroup : IDisposable
  {
    private static readonly ILogger logger = TraceLogger.GetLogger<RuntimeStatisticsGroup>();//, TraceLogger.LoggerType.Runtime);
    ...
    public RuntimeStatisticsGroup()
    {
      ...
      {
        logger.LogWarning(ErrorCode.PerfCounterConnectError,
    ...
    public void Start()
    {
      ...
      {
        logger.LogWarning(ErrorCode.PerfCounterNotRegistered,
