...
{
  /// <summary>System status values and current register</summary>
  public sealed class SystemStatus : IEquatable<SystemStatus>
  {
    ...
    private readonly InternalSystemStatus s_value;
    private SystemStatus(InternalSystemStatus name) { this.s_value = name; }

    /// <see cref="Object.ToString"/>
    public override string ToString() { return this.s_value.ToString(); }
    /// <see cref="Object.GetHashCode"/>
    public override int GetHashCode() { return this.s_value.GetHashCode(); }
    ...
    public bool Equals(SystemStatus other) { return (other != null) && this.s_value.Equals(other.s_value); }
  }
}
