...
namespace CuteAnt.OrmLite.DataAccessLayer
{
	...
	/// <remarks>抽象数据库的功能特点。
	/// 对于每一个连接字符串配置，都有一个数据库实例，而不是每个数据库类型一个实例，因为同类型数据库不同版本行为不同。</remarks>
	public partial interface IDatabase : IDisposable2
	{
		#region -- 属性 --
		...
		String PageSplit(String sql, Int64 startRowIndex, Int32 maximumRows, String keyColumn);
