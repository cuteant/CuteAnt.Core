...
namespace CuteAnt.OrmLite.DataAccessLayer
{
	internal class PostgreSQL : RemoteDb
	{
		...
		private static readonly GeneratorBase _Generator = new PostgresGenerator();
		internal override GeneratorBase Generator { get { return _Generator; } }

		private PostgresSchemaProvider _SchemaProvider;
		...
		public override ISchemaProvider SchemaProvider
		{
			get
			{
				...
				{
					_SchemaProvider = new PostgresSchemaProvider();
