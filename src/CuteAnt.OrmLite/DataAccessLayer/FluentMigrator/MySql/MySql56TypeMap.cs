...
{
	/// <summary>MySQL 5.64以上版本</summary>
	internal class MySql56TypeMap : MySql55TypeMap
	{
		internal override void SetupTypeMaps()
		{
			base.SetupTypeMaps();

			SetTypeMap(CommonDbType.DateTime, "DATETIME(3)");
			SetTypeMap(CommonDbType.DateTime2, "DATETIME(6)");
			SetTypeMap(CommonDbType.DateTimeOffset, "TIMESTAMP(6)");
		}
	}
}