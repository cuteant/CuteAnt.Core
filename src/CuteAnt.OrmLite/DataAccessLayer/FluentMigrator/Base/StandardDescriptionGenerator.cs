...
{
	internal class StandardDescriptionGenerator //EmptyDescriptionGenerator : IDescriptionGenerator
	{
		internal virtual IList<String> GenerateCreateTableDescriptionStatements(String schemaName, IDataTable table)
		{
			return Enumerable.Empty<String>().ToList();
		}

		internal virtual String GenerateAlterTableDescriptionStatement(String schemaName, IDataTable table)
		{
			return String.Empty;
		}

		internal virtual String GenerateCreateColumnDescriptionStatement(String schemaName, IDataColumn column)
		{
			return String.Empty;
		}

		internal virtual String GenerateAlterColumnDescriptionStatement(String schemaName, IDataColumn column)
		{
			return String.Empty;
		}

		internal virtual void SetQuoter(IQuoter quoter) { }
	}
}