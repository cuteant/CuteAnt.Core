...
namespace CuteAnt.OrmLite
{
	...
	{
		internal static T[] Append<T>(this T[] array, T newItem)
			where T : class
		{
		...
		internal static T[] ReplaceOrAppend<T>(this T[] array, T newItem)
			where T : class
		{
			if (array.Length == 0) return new[] { newItem };
		...
		internal static T[] Replace<T>(this T[] array, int index, T newItem)
		{
