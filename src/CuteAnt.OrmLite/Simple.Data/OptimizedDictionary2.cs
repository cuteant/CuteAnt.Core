...
{
	internal class OptimizedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ICloneable
	{
		private static readonly DictionaryCloner Cloner = new DictionaryCloner();
		private readonly IDictionary<TKey, Int32> _index;
		private readonly List<TValue> _values;

		internal OptimizedDictionary(IDictionary<TKey, Int32> index, IEnumerable<TValue> values)
		{
			_index = index;
		...
		/// <summary>Copies the elements of the <see cref="T:System.Collections.Generic.ICollection`1"/> to an <see cref="T:System.Array"/>, 
		...
		public void CopyTo(KeyValuePair<TKey, TValue>[] array, Int32 arrayIndex)
		{
			...
			{
				var index = arrayIndex + _index[key];
				array[index] = new KeyValuePair<TKey, TValue>(key, _values[index]);
			}
		}

		/// <summary>Removes the first occurrence of a specific object from the <see cref="T:System.Collections.Generic.ICollection`1"/>.</summary>
		/// <returns>true if <paramref name="item"/> was successfully removed from the <see cref="T:System.Collections.Generic.ICollection`1"/>; 
		...
		/// <returns>true if the element is successfully removed; otherwise, false.  This method also returns false if <paramref name="key"/> 
		/// was not found in the original <see cref="T:System.Collections.Generic.IDictionary`2"/>.</returns>
		...
		/// <returns>true if the object that implements <see cref="T:System.Collections.Generic.IDictionary`2"/> contains 
