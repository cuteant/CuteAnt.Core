...
namespace CuteAnt.OrmLite.Common
{
  ...
  public static class Helper
  {
    ...
    /// <param name="dbType"></param>
    /// <returns></returns>
    public static CommonDbType ToCommonDbType(this DbType dbType)
    {
      return ConvertDbType(dbType);
    }

    /// <summary>转换</summary>
    /// <param name="type"></param>
    /// <returns></returns>
    public static DbType ToDbType(this CommonDbType type)
    {
      return ConvertDbType(type);
    }
