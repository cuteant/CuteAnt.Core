...
namespace System.IO
{
  ...
  internal static class CaPathExtensions
  {
    #region -- 属性 --

    /// <summary>基础目录。GetFullPath依赖于此，默认为当前应用程序域基础目录</summary>
    internal static String BaseDirectory = PathHelper.ApplicationBasePath;
    ...
    internal static String CombinePath(this String path, params String[] ps)
    {
      ...
      var list = new List<String>(ps.Length + 1);
      list.Add(path);
      list.AddRange(ps);
    ...
    /// <returns></returns>
    internal static Boolean CopyToIfNewer(this FileInfo fi, String destFileName)
    {
      // 源文件必须存在
    ...
    //internal static IEnumerable<String> GetAllFileNames(this DirectoryInfo di, String searchPattern = null, Boolean allSub = true)
    //{
    ...
    ///// <returns></returns>
    //internal static Int32 UpdateFrom(this DirectoryInfo di, String src, String searchPattern = null, Boolean allSub = true)
    //{
    ...
    /// <returns></returns>
    internal static Int32 CopyToIfNewer(this DirectoryInfo di, String destDirName, String exts = null, Boolean allSub = false, Action<String> callback = null)
    {
