...
namespace CuteAnt.Extensions.DependencyInjection
{
  ...
  {
    /// <summary>Create an <see cref="CuteAnt.Extensions.DependencyInjection.IServiceScope"/> which
    /// contains an <see cref="System.IServiceProvider"/> used to resolve dependencies from a
    /// newly created scope.</summary>
    /// <returns>An <see cref="CuteAnt.Extensions.DependencyInjection.IServiceScope"/> controlling the
