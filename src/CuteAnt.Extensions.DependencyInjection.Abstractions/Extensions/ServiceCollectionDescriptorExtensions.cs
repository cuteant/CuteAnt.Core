...
namespace CuteAnt.Extensions.DependencyInjection.Extensions
{
  public static class ServiceCollectionDescriptorExtensions
  {
    ...
    /// <summary>Adds a sequence of <see cref="ServiceDescriptor"/> to the <paramref name="collection"/>.</summary>
    /// <param name="collection">The <see cref="IServiceCollection"/>.</param>
    ...
    /// service type hasn't been already registered.</summary>
    /// <param name="collection">The <see cref="IServiceCollection"/>.</param>
    /// <param name="descriptor">The <see cref="ServiceDescriptor"/>.</param>
    ...
    /// <summary>Adds a <see cref="ServiceDescriptor"/> if an existing descriptor with the same
    ...
    /// <summary>Adds the specified <see cref="ServiceDescriptor"/>s if an existing descriptor with the same
    /// <see cref="ServiceDescriptor.ServiceType"/> and an implementation that does not already exist
    /// in <paramref name="services."/>. </summary>
    /// <param name="services">The <see cref="IServiceCollection"/>.</param>
    /// <param name="descriptors">The <see cref="ServiceDescriptor"/>s.</param>
    ...
    /// <summary>Removes the first service in <see cref="IServiceCollection"/> with the same service type
    /// as <paramref name="descriptor"/> and adds <paramef name="descriptor"/> to the collection.</summary>
    /// <param name="collection">The <see cref="IServiceCollection"/>.</param>
