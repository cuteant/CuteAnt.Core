...
using System;
using Common = CuteAnt.Extensions.Internal;
...
namespace CuteAnt.Extensions.DependencyInjection
{
  ...
  {
    /// <summary>Instantiate a type with constructor arguments provided directly and/or from an <see cref="IServiceProvider"/>.</summary>
