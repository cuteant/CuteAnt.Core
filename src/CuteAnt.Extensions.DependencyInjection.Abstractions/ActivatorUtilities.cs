  ...
  public static class ActivatorUtilities
  {
        ...
        Expression factoryArgumentArray)
    {
      ...
      for (var i = 0; i < constructorParameters.Length; i++)
      {
        ...
        {
          var constructorParameterHasDefault = constructorParameters[i].HasDefaultValueEx();
        ...
        if (constructorParameters[i].HasDefaultValueEx())
        {
    ...
    private class ConstructorMatcher
    {
      ...
      public int Match(object[] givenParameters)
      {
        ...
        for (var givenIndex = 0; givenIndex < givenParameters.Length; givenIndex++)
        {
          ...
          var givenType = givenParameters[givenIndex] == null ? default(TypeInfo) : givenParameters[givenIndex].GetType().GetTypeInfo();
          #endregion
      ...
      public object CreateInstance(IServiceProvider provider)
      {
        for (var index = 0; index < _parameters.Length; index++)
        {
          if (_parameterValuesSet[index] == false)
          {
            ...
            if (value == null)
            {
              if (!_parameters[index].HasDefaultValueEx()) // ## 苦竹 修改 ##
              {
