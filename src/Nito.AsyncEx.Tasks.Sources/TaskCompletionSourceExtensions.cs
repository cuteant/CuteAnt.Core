...
namespace CuteAnt.AsyncEx
{
	...
	internal static class TaskCompletionSourceExtensions
	{
		...
		internal static Boolean TryCompleteFromCompletedTask<TResult, TSourceResult>(this TaskCompletionSource<TResult> @this, Task<TSourceResult> task) where TSourceResult : TResult
		{
			if (task.IsFaulted)
		...
		/// <summary>Attempts to complete a <see cref="TaskCompletionSource"/>, forcing all continuations onto a threadpool thread even if they specified <c>ExecuteSynchronously</c>.</summary>
		/// <param name="this">The task completion source. May not be <c>null</c>.</param>
