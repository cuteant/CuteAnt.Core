...
namespace CuteAnt.AsyncEx
{
	...
	{
		/// <summary>Queues work to the task factory and returns a <see cref="Task"/> representing that work.</summary>
		...
		/// <summary>Queues work to the task factory and returns a <see cref="Task{TResult}"/> representing that work.</summary>
		/// <param name="this">The <see cref="TaskFactory"/>. May not be <c>null</c>.</param>
		/// <param name="action">The action delegate to execute. May not be <c>null</c>.</param>
		/// <returns>The started task.</returns>
#if NET_4_0_GREATER
		...
		/// <summary>Queues work to the task factory and returns a proxy <see cref="Task"/> representing that work.</summary>
		/// <param name="this">The <see cref="TaskFactory"/>. May not be <c>null</c>.</param>
		/// <param name="action">The action delegate to execute. May not be <c>null</c>.</param>
		/// <returns>The started task.</returns>
#if NET_4_0_GREATER
		...
		/// <summary>Queues work to the task factory and returns a proxy <see cref="Task{TResult}"/> representing that work.</summary>
		/// <param name="this">The <see cref="TaskFactory"/>. May not be <c>null</c>.</param>
		/// <param name="action">The action delegate to execute. May not be <c>null</c>.</param>
		/// <returns>The started task.</returns>
#if NET_4_0_GREATER
