...
//  	Copyright 2013-2014 Matthew Ducker(https://github.com/zenith-nz/BitManipulator)
//  	
...
namespace System
{
	/// <summary>Extension methods for packing/unpacking integral numbers into/out of byte arrays, in big-or-little endian formats.</summary>
	internal static class EndiannessExtensions
	{
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToBigEndian_NoChecks(this Int16[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
		...
		internal static void BigEndianToInt16(this byte[] ba, int baOff, Int16[] ia, int iaOff, int count)
		{
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToInt16_NoChecks(this byte[] ba, int baOff, Int16[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int16);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToBigEndian_NoChecks(this Int32[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToInt32(this byte[] ba, int baOff, Int32[] ia, int iaOff, int count)
		{
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToInt32_NoChecks(this byte[] ba, int baOff, Int32[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int32);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToBigEndian_NoChecks(this Int64[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToInt64(this byte[] ba, int baOff, Int64[] ia, int iaOff, int count)
		{
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToInt64_NoChecks(this byte[] ba, int baOff, Int64[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int64);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToBigEndian_NoChecks(this UInt16[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToUInt16(this byte[] ba, int baOff, UInt16[] ia, int iaOff, int count)
		{
			ValidateArguments16(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToUInt16_NoChecks(this byte[] ba, int baOff, UInt16[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt16);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToBigEndian_NoChecks(this uint[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToUInt32(this byte[] ba, int baOff, UInt32[] ia, int iaOff, int count)
		{
			ValidateArguments32(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToUInt32_NoChecks(this byte[] ba, int baOff, UInt32[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt32);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToBigEndian_NoChecks(this UInt64[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToUInt64(this byte[] ba, int baOff, UInt64[] ia, int iaOff, int count)
		{
			ValidateArguments64(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void BigEndianToUInt64_NoChecks(this byte[] ba, int baOff, UInt64[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt64);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToLittleEndian_NoChecks(this Int16[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int16);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToInt16(this byte[] ba, int baOff, Int16[] ia, int iaOff, int count)
		{
			ValidateArguments16(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToInt16_NoChecks(this byte[] ba, int baOff, Int16[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int16);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToLittleEndian_NoChecks(this Int32[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int32);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToInt32(this byte[] ba, int baOff, Int32[] ia, int iaOff, int count)
		{
			ValidateArguments32(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToInt32_NoChecks(this byte[] ba, int baOff, Int32[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int32);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToLittleEndian_NoChecks(this Int64[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int64);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToInt64(this byte[] ba, int baOff, long[] ia, int iaOff, int count)
		{
			ValidateArguments64(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToInt64_NoChecks(this byte[] ba, int baOff, long[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(Int64);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToLittleEndian_NoChecks(this UInt16[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt16);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToUInt16(this byte[] ba, int baOff, ushort[] ia, int iaOff, int count)
		{
			ValidateArguments16(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToUInt16_NoChecks(this byte[] ba, int baOff, ushort[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt16);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToLittleEndian_NoChecks(this uint[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt32);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToUInt32(this byte[] ba, int baOff, uint[] ia, int iaOff, int count)
		{
			ValidateArguments32(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToUInt32_NoChecks(this byte[] ba, int baOff, uint[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt32);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to read from.</param>
		/// <param name="count">Number of integers to output into <paramref name="ba" />.</param>
		internal static void ToLittleEndian_NoChecks(this UInt64[] ia, int iaOff, byte[] ba, int baOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt64);
			if (count >= umLimit)
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToUInt64(this byte[] ba, int baOff, ulong[] ia, int iaOff, int count)
		{
			ValidateArguments64(ba, baOff, ia, iaOff, count);
		...
		/// <param name="iaOff">Offset in <paramref name="ia" /> to write to.</param>
		/// <param name="count">Number of integers to output into <paramref name="ia" />.</param>
		internal static void LittleEndianToUInt64_NoChecks(this byte[] ba, int baOff, ulong[] ia, int iaOff, int count)
		{
#if INCLUDE_UNSAFE
			const int umLimit = Shared.UnmanagedThreshold / sizeof(UInt64);
			if (count >= umLimit)
