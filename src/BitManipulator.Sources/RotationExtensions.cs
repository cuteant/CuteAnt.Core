...
namespace System
{
	/// <summary>Extension methods for circularly-rotating integral numbers ("rotate through carry" derivative not provided).</summary>
	internal static class RotationExtensions
	{
		...
		/// <summary>Validate arguments/parameters to prevent unexpected exceptions.</summary>
