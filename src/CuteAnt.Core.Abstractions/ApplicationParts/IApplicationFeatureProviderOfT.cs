...
{
  /// <summary>A provider for a given <typeparamref name="TFeature"/> feature.</summary>
  ...
  public interface IApplicationFeatureProvider<in TFeature> : IApplicationFeatureProvider
  {
    ...
    /// <param name="parts">The list of <see cref="IApplicationPart"/>s of the application.</param>
