...
namespace CuteAnt.Metadata
{
  /// <summary>Defines a feature populator for this assembly.</summary>
  [AttributeUsage(AttributeTargets.Assembly, AllowMultiple = true)]
  public sealed class FeaturePopulatorAttribute : Attribute
  {
    /// <summary>Initializes a new instance of the <see cref="FeaturePopulatorAttribute"/> class.</summary>
    ...
    public FeaturePopulatorAttribute(Type populatorType)
    {
      ...
      if (!populatorType.GetInterfaces().Any(iface =>
#if NET40
          iface.IsConstructedGenericType()
#else
          iface.IsConstructedGenericType
#endif
          && typeof(IFeaturePopulator<>).IsAssignableFrom(iface.GetGenericTypeDefinition())))
      {
    ...
    /// <summary>Gets the feature populator type.</summary>
