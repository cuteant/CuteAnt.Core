...
namespace CuteAnt
{
    // Code take from Orleans(See https://github.com/dotnet/orleans/blob/master/src/Orleans.Core.Abstractions/IDs/JenkinsHash.cs).
    // 
    ...
    public static class JenkinsHash
    {
        ...
        /// A hash digest of the input.
        /// </returns>
        public static uint ComputeHash(in ReadOnlySpan<byte> data)
#endif
        {
            int len = data.Length;
            uint a = 0x9e3779b9;
