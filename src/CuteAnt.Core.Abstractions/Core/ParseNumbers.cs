...
namespace CuteAnt
{
    ...
    internal static class ParseNumbers
    {
        ...
        private static readonly Func<int, string> s_fastAllocateStringFunc;
        static ParseNumbers()
        {
            var fasMethod = typeof(string).GetMethod("FastAllocateString", BindingFlags.NonPublic | BindingFlags.Static);
            s_fastAllocateStringFunc = (Func<int, string>)fasMethod.CreateDelegate(typeof(Func<int, string>));
        }
        ...
        public static long StringToLong(ReadOnlySpan<char> s, int radix, int flags, ref int currPos)
        {
            ...
            if (r != 2 && r != 10 && r != 8 && r != 16)
                ThrowArgumentInvalidBaseException(ExceptionArgument.radix);
            ...
            if (((flags & IsTight) == 0) && ((flags & NoSpace) == 0))
            {
                ...
                if (i == length)
                    ThrowFormatEmptyInputStringException();
            }
            ...
            {
                if (r != 10)
                    ThrowFormatCannotHaveNegativeValueException();

                if ((flags & TreatAsUnsigned) != 0)
                    ThrowOverflowNegativeUnsignedException();
            ...
            if (i == grabNumbersStart)
                ThrowFormatNoParsibleDigitsException();

            if ((flags & IsTight) != 0)
            {
                //If we've got effluvia left at the end of the string, complain.
                if (i < length)
                    ThrowFormatExtraJunkAtEndException();
            }
        ...
        public static int StringToInt(ReadOnlySpan<char> s, int radix, int flags, ref int currPos)
        {
            ...
            {
                if ((uint)result > 0xFF)
                    ThrowOverflowSByteException();
            }
            else if ((flags & TreatAsI2) != 0)
            {
                if ((uint)result > 0xFFFF)
                    ThrowOverflowInt16Exception();
            }
        ...
        public static string IntToString(int n, int radix, int width, char paddingChar, int flags)
        {
            ...
            string result = s_fastAllocateStringFunc(Math.Max(width, index));
            unsafe
            {
        ...
        public static string LongToString(long n, int radix, int width, char paddingChar, int flags)
        {
            ...
            if (radix < MinRadix || radix > MaxRadix) { ThrowArgumentInvalidBaseException(ExceptionArgument.radix); }
        ...
        private static void ThrowArgumentOutOfRangeIndexException()
        {
            ...
            {
                return new ArgumentOutOfRangeException("Index was out of range. Must be non-negative and less than the size of the collection.");
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void ThrowArgumentInvalidBaseException(ExceptionArgument argument)
        {
            throw GetException();
            ArgumentException GetException()
            {
                return new ArgumentException("Invalid Base.", ThrowHelper.GetArgumentName(argument));
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void ThrowFormatEmptyInputStringException()
        {
            throw GetException();
            FormatException GetException()
            {
                return new FormatException("Input string was either empty or contained only whitespace.");
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void ThrowFormatCannotHaveNegativeValueException()
        {
            throw GetException();
            FormatException GetException()
            {
                return new FormatException("String cannot contain a minus sign if the base is not 10.");
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void ThrowFormatNoParsibleDigitsException()
        {
            throw GetException();
            FormatException GetException()
            {
                return new FormatException("Could not find any recognizable digits.");
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void ThrowFormatExtraJunkAtEndException()
        {
            throw GetException();
            FormatException GetException()
            {
                return new FormatException("Additional non-parsable characters are at the end of the string.");
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void ThrowOverflowSByteException()
        {
            throw GetException();
            OverflowException GetException()
            {
                return new OverflowException("Value was either too large or too small for a signed byte.");
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void ThrowOverflowInt16Exception()
        {
            throw GetException();
            OverflowException GetException()
            {
                return new OverflowException("Value was either too large or too small for an Int16.");
            }
        }
        ...
        private static void ThrowOverflowInt32Exception()
        {
            ...
            OverflowException GetException()
            {
                return new OverflowException("Value was either too large or too small for an Int32.");
            }
        }
        ...
        private static void ThrowOverflowInt64Exception()
        {
            ...
            OverflowException GetException()
            {
                return new OverflowException("Value was either too large or too small for an Int64.");
            }
        }
        ...
        private static void ThrowOverflowUInt32Exception()
        {
            ...
            OverflowException GetException()
            {
                return new OverflowException("Value was either too large or too small for a UInt32.");
            }
        }
        ...
        private static void ThrowOverflowUInt64Exception()
        {
            ...
            OverflowException GetException()
            {
                return new OverflowException("Value was either too large or too small for a UInt64.");
            }
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static void ThrowOverflowNegativeUnsignedException()
        {
            throw GetException();
            OverflowException GetException()
            {
                return new OverflowException("The string was being parsed as an unsigned number and could not have a negative sign.");
            }
        }
