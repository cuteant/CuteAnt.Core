...
{
  /// <summary>Generic filter group</summary>
  ...
  public class GenericFilterGroup<T>
  {
    ...
    /// <summary>Or together the filters rather than And them</summary>
    public bool UseOr { get; set; }

    /// <summary>Add filter to filter group</summary>
    ...
    /// <summary>Automatically convert from TypefilterGroup to Func(Type,bool)</summary>
    ...
    /// <summary>Internal method that does the filtering</summary>
