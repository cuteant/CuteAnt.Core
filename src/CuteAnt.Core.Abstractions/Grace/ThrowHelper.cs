...
namespace Grace
{
  internal static partial class ThrowHelper
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    internal static void ThrowArgumentNullOrEmpty(ExceptionArgument argument)
    {
      throw GetArgumentException();
      ArgumentException GetArgumentException()
      {
        return new ArgumentException("Value cannot be null or empty.", GetArgumentName(argument));
      }
    }
