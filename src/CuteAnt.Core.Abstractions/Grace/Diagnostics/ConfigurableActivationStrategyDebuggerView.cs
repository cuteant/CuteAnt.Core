...
{
  /// <summary>Diagnostic class for configurable strategies</summary>
  public class ConfigurableActivationStrategyDebuggerView
  {
    ...
    /// <summary>Lifestyle for container</summary>
