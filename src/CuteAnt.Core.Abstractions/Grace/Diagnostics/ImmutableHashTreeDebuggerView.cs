...
{
  /// <summary>Class for debugger</summary>
  ...
  public class ImmutableHashTreeDebuggerView<TKey, TValue>
  {
    ...
    /// <summary>Keys for hash tree</summary>
    ...
    public IEnumerable<KeyValuePairDebuggerView<TKey, TValue>> Items
    {
      get
      {
        var list = _hashTree.Select(kvp => new KeyValuePairDebuggerView<TKey, TValue>(kvp.Key, kvp.Value)).ToList();
  ...
  /// <summary>Debugger view for hash tree entries</summary>
  /// <typeparam name="TKey"></typeparam>
  /// <typeparam name="TValue"></typeparam>
  ...
  public class KeyValuePairDebuggerView<TKey, TValue>
  {
    ...
    /// <summary>Key for entry</summary>
    public TKey Key { get; }

    /// <summary>Value for entry</summary>
    ...
    /// <summary>Debugger value string</summary>
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
