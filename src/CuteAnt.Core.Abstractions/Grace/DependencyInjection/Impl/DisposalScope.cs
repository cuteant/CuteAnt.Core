...
{
    /// <summary>class for tracking and disposing objects</summary>
    public class DisposalScope : IDisposalScope
    {
        /// <summary>For memory allocation and execution performance I've written a one off linked list to track items for disposal</summary>
        private sealed class DisposeEntry
        {
            /// <summary>Item to be disposed. Can be either IDisposable or IAsyncDisposable</summary>
            public object DisposeItem;

            /// <summary>Cleanup delegate that was passed in, this is a wrapper around the original delegate that was passed in</summary>
            public Action CleanupDelegate;

            /// <summary>Next entry to dispose</summary>
        ...
        /// <summary>Internal list of disposal entries</summary>
            ...
            while (!ReferenceEquals(entry, DisposeEntry.Empty))
            {
                ...
                switch (entry.DisposeItem)
                {
                    ...
                    default:
                        ...
                        throw GetInvalidOperationException(entry);
                }
        ...
        private static InvalidOperationException GetInvalidOperationException(DisposeEntry entry)
        {
