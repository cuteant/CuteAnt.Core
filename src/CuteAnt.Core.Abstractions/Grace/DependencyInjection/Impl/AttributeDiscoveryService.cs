    ...
    public class AttributeDiscoveryService : IAttributeDiscoveryService
    {
        ...
        public IEnumerable<Attribute> GetAttributes(object value)
        {
            ...
            switch (value)
            {
                ...
                default:
                    throw GetNotSupportedException(value);
            }
        ...
        private static NotSupportedException GetNotSupportedException(object value)
        {
            return new NotSupportedException($"Getting attributes on type {value.GetType().Name} is not supported");
        }
    }
}