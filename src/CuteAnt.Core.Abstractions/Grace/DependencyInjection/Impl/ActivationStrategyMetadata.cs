...
{
  /// <summary>Metadata for activation strategy</summary>
  ...
  public class ActivationStrategyMetadata : IActivationStrategyMetadata
  {
    ...
    public IEnumerator<KeyValuePair<object, object>> GetEnumerator() => _metadata.GetEnumerator();
    ...
    public bool ContainsKey(object key) => _metadata.ContainsKey(key);

    /// <summary>Gets the value that is associated with the specified key.</summary>
    /// <returns>true if the object that implements the <see
    /// cref="T:System.Collections.Generic.IReadOnlyDictionary`2"/> interface contains an element
    ...
    /// <exception cref="T:System.ArgumentNullException"><paramref name="key"/> is null.</exception>
    public bool TryGetValue(object key, out object value) => _metadata.TryGetValue(key, out value);
    ...
    /// <summary>Activation type</summary>
    public Type ActivationType { get; }

    /// <summary>Exported as</summary>
    public IEnumerable<Type> ExportAs { get; }

    /// <summary>Exported as keyed</summary>
    public IEnumerable<KeyValuePair<Type, object>> ExportAsKeyed { get; }

    /// <summary>Check to see if specific metadata matches</summary>
    /// <param name="key">key to use</param>
    /// <param name="value">value to compare</param>
    /// <returns></returns>
    public bool MetadataMatches(object key, object value)
    {
      if (_metadata.TryGetValue(key, out object outValue))
      {
        if (value != null) { return value.Equals(outValue); }

        if (outValue == null) { return true; }
      }
      else if (value == null)
      {
        return true;
