...
{
  /// <summary>Configuration object for filtering members</summary>
  public class MembersThatConfiguration
  {
    ...
    public MembersThatConfiguration StartsWith(string prefix)
    {
      ...
      _filters.Add(m => (m.Name.StartsWith(prefix, StringComparison.Ordinal)) == notValue);
    ...
    public MembersThatConfiguration EndsWith(string postfix)
    {
      ...
      _filters.Add(m => (m.Name.EndsWith(postfix, StringComparison.Ordinal)) == notValue);

      return this;
    }

    /// <summary>Match a specific member</summary>
    ...
    /// <summary>Matched is the Memember is a Method</summary>
    /// <param name="filter"></param>
    /// <returns></returns>
    ...
    /// <summary>Have a specific attribute</summary>
