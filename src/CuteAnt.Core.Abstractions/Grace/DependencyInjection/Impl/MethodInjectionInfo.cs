...
{
  /// <summary>information for injecting a method</summary>
  public class MethodInjectionInfo
  {
    ...
    /// <summary>Method being injected</summary>
    public MethodInfo Method { get; set; }

    /// <summary>Enumerable of injected method parameters information</summary>
    ...
    /// <summary>Add a information for injected method parameters</summary>
  ...
  /// <summary>information for injected method parameters</summary>
  public class MethodParameterInfo
  {
    /// <summary>injected method parameter name</summary>
    public string ParameterName { get; private set; }

    /// <summary>the locate key for injected method parameter</summary>
    public string LocateKey { get; set; }

    /// <summary>if the injected method parameter is required</summary>
    public bool IsRequired { get; set; } = true;

    /// <summary>constructor for injected method parameters</summary>
