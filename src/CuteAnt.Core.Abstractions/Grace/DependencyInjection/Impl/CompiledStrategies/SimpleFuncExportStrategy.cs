...
{
    /// <summary>This strategy doesn't honor lifestyle or decorators, it's intended to be very simple</summary>
    public class SimpleFuncExportStrategy<T> : ConfigurableActivationStrategy, ICompiledExportStrategy
    {
        ...
        public ActivationStrategyDelegate GetActivationStrategyDelegate(IInjectionScope scope, IActivationStrategyCompiler compiler, Type activationType) => _delegate;
