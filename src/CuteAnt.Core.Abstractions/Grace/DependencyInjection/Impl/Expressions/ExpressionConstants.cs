...
{
  /// <summary>represents a set of constants that can be used while creating linq expression</summary>
  public class ExpressionConstants : IExpressionConstants
  {
    /// <summary>Default expression constants</summary>
    ...
    /// <summary>IInjectionContext parameter</summary>
