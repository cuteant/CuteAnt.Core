...
{
  /// <summary>implementation for creating an instantiation expression for a type</summary>
  ...
  /// <summary>Creates instantiation expressions</summary>
  public class InstantiationExpressionCreator : IInstantiationExpressionCreator
  {
    ...
    /// <returns>expression result</returns>
    public IActivationExpressionResult CreateExpression(IInjectionScope scope, IActivationExpressionRequest request, TypeActivationConfiguration configuration)
    {
      var creator = configuration.ConstructorSelectionMethod ??
                    request.RequestingScope.ScopeConfiguration.Behaviors.ConstructorSelection;
