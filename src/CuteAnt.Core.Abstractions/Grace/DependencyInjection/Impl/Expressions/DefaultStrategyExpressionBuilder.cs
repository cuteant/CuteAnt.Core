...
namespace Grace.DependencyInjection.Impl.Expressions
{
  ...
  /// <summary>class builds expressions for activation configurations using lifestyles</summary>
  public class DefaultStrategyExpressionBuilder : IDefaultStrategyExpressionBuilder
  {
    ...
    public DefaultStrategyExpressionBuilder(ITypeExpressionBuilder typeExpressionBuilder) => TypeExpressionBuilder = typeExpressionBuilder;
