...
{
  /// <summary>Enumeration for constructor selection method</summary>
  public static class ConstructorSelectionMethod
  {
    ...
    /// <summary>Matches the best constructor based on which exports are registered</summary>
    public static IConstructorExpressionCreator BestMatch { get; }

    /// <summary>Use the constructor with the most parameters</summary>
    public static IConstructorExpressionCreator MostParameters { get; }

    /// <summary>Use the constructor with the least parameters</summary>
    public static IConstructorExpressionCreator LeastParameters { get; }

    /// <summary>Dynamicly pick the cosntructor to use each request, not very fast but allows for support similar to NInject</summary>
    public static IConstructorExpressionCreator Dynamic { get; }
  }

  /// <summary>Classes that implement this can be used to create enumerables</summary>
  public interface IEnumerableCreator
  {
    /// <summary>Construct enumerable given a scope and an array</summary>
  ...
  /// <summary>Configure the how expressions are created</summary>
  public class ExportCompilationBehavior
  {
    private Func<Type, bool> _keyedTypeSelector = DefaultKeyedTypeSelector;

    /// <summary>Default implementation for selecting types that should be located by key.
    /// Note: string, primitive and datetime are located by key</summary>
    ...
    /// <summary>Allow IInjectionScope to be injected, false by default because you normally want IExportLocatorScope</summary>
    public bool AllowInjectionScopeLocation { get; set; } = false;

    /// <summary>Constructor selection algorithm, best match by default</summary>
    public IConstructorExpressionCreator ConstructorSelection { get; set; } = ConstructorSelectionMethod.BestMatch;

    /// <summary>customize IEnumerable&lt;T&gt; creation</summary>
    public IEnumerableCreator CustomEnumerableCreator { get; set; }

    /// <summary>Allows you to override the default behavior for what is located by key and what's not
    /// Note: By default string, primitive and DateTime are true, everything else is false</summary>
