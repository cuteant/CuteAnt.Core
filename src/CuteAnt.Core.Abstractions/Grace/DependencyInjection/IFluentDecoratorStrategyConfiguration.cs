...
{
    /// <summary>Configuration interface for decorator strategy</summary>
    public interface IFluentDecoratorStrategyConfiguration : IFluentDecoratorFactoryStrategyConfiguration
    {
        ///// <summary>Apply decorator after lifestyle, by default it's before</summary>
        ///// <returns></returns>
        //IFluentDecoratorStrategyConfiguration ApplyAfterLifestyle();

        ///// <summary>Export as particular types</summary>
        ///// <param name="type"></param>
        ///// <returns></returns>
        //IFluentDecoratorStrategyConfiguration As(Type type);

        ///// <summary>Condition for decorator strategy</summary>
        //IWhenConditionConfiguration<IFluentDecoratorStrategyConfiguration> When { get; }

        /// <summary>Sets priority for decorator</summary>
        /// <param name="priority"></param>
        /// <returns></returns>
        IFluentDecoratorStrategyConfiguration Priority(int priority);

        /// <summary>Add a specific value for a particular parameter in the constructor</summary>
