...
{
    /// <summary>Interface for configuring a non generic type</summary>
    public interface IFluentExportStrategyConfiguration
    {
        ...
        /// <summary>Import public members Fields, Properties, and Methods (not done by default)</summary>
        ...
        /// <summary>Process attribute on type as well as fluent interface</summary>
        /// <returns></returns>
    ...
    /// <summary>Represents a class that configures an export</summary>
