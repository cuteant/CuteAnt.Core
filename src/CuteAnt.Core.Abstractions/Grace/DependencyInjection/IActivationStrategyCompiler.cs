...
{
    /// <summary>Compiler to create ActivationStrategyDelegate delegates</summary>
    public interface IActivationStrategyCompiler
    {
        ...
        /// <summary>Compile fast instance creation delegate that can be used when certain parameters aren't needed.</summary>
        /// <param name="scope"></param>
        /// <param name="expressionContext"></param>
        /// <returns></returns>
