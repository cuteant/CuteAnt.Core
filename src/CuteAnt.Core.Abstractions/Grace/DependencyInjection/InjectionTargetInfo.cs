...
{
  /// <summary>information for a specific instance of a type being injected</summary>
  public class InjectionTargetInfo
  {
    ...
    /// <summary>This is the type that is being injected into</summary>
    public Type InjectionType { get; }

    /// <summary>Requesting strategy</summary>
    public IActivationStrategy RequestingStrategy { get; set; }

    /// <summary>These are the attributes for the class that it's being injected into</summary>
    public IEnumerable<Attribute> InjectionTypeAttributes => _attributeDiscoveryService.GetAttributes(InjectionType);

    /// <summary>The PropertyInfo or ParameterInfo that is being injected</summary>
    public object InjectionTarget { get; }

    /// <summary>Name of target being injected, parameter name, property name, or fieldName</summary>
    public string InjectionTargetName { get; }

    /// <summary>Type of injection being done, constructor, property, or method</summary>
    public RequestType InjectionDependencyType { get; }

    /// <summary>Attributes associated with the target PropertyInfo or ParameterInfo that is provided</summary>
    public IEnumerable<Attribute> InjectionTargetAttributes => _attributeDiscoveryService.GetAttributes(InjectionTarget);

    /// <summary>Attributes on the Constructor, Method, or Property being injected</summary>
    ...
    /// <summary>Locate type being used</summary>
    public Type LocateType { get; }

    /// <summary>Is the injection required</summary>
    public bool IsRequired { get; }

    /// <summary>Default value for injection</summary>
