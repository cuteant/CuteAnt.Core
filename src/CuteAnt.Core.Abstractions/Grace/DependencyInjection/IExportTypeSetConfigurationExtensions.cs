...
{
    /// <summary>extension methods for type set configuration</summary>
    public static class IExportTypeSetConfigurationExtensions
    {
        ...
        public static IExportTypeSetConfiguration PrioritizePartiallyClosedGenerics(this IExportTypeSetConfiguration configuration)
        {
        ...
        /// <summary>Export a type set by a keyed interface</summary>
