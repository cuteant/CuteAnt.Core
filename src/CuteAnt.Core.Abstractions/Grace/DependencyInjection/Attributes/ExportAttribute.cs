...
{
    /// <summary>This attribute is used to mark a type for export.</summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
    public class ExportAttribute : Attribute, IExportAttribute
    {
        /// <summary>Export by type rather than by name</summary>
