...
{
  /// <summary>Exports attribute with this attribute will be shared as a single instance for all scopes</summary>
  ...
  public class SingletonAttribute : Attribute, ILifestyleProviderAttribute
  {
    ...
    /// <returns></returns>
    public ICompiledLifestyle ProvideLifestyle(Type attributedType) => new SingletonLifestyle();
  }
}