...
{
  /// <summary>Exports marked with this attribute will be shared per injection context</summary>
  ...
  public class SingletonPerObjectGraphAttribute : Attribute, ILifestyleProviderAttribute
  {
    ...
    /// <returns></returns>
    public ICompiledLifestyle ProvideLifestyle(Type attributedType) => new SingletonPerObjectGraph(false);
  }
}