...
{
  /// <summary>Exports attributed with this will be shared, the instance will be held with a weak reference so
  /// it will be GC'd when done</summary>
  ...
  public class WeakSingletonAttribute : Attribute, ILifestyleProviderAttribute
  {
    ...
    /// <returns></returns>
    public ICompiledLifestyle ProvideLifestyle(Type attributedType) => new WeakSingletonLifestyle();
  }
}