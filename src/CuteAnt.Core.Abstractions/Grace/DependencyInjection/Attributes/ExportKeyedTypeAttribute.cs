...
{
    /// <summary>Adds a key to an exported class</summary>
    ...
    public class ExportKeyedTypeAttribute : Attribute, IExportKeyedTypeAttribute
    {
        ...
        /// <summary>provide type and key for export</summary>
        /// <param name="attributedType"></param>
        /// <returns></returns>
        public Tuple<Type, object> ProvideKey(Type attributedType) => new Tuple<Type, object>(_type, _key);
    }
}