...
{
  /// <summary>Exports marked with this attribute will be shared per scope.</summary>
  ...
  public class SingletonPerScopeAttribute : Attribute, ILifestyleProviderAttribute
  {
    ...
    /// <returns></returns>
    public ICompiledLifestyle ProvideLifestyle(Type attributedType) => new SingletonPerScopeLifestyle(false);
  }
}