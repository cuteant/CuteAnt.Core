...
{
  /// <summary>Attributes that implement this interface will be called at discovery time to provide an export strategy</summary>
  public interface IExportStrategyProviderAttribute
  {
    /// <summary>Provide an export strategy for the attributed type</summary>
