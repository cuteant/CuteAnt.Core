...
{
  /// <summary>This attribute can be used to attribute properties, methods, constructors or parameters</summary>
  ...
  public class ImportAttribute : Attribute, IImportAttribute
  {
    ...
    public ImportAttribute() => Required = true;

    /// <summary>Key to use when importing</summary>
    public object Key { get; set; }

    /// <summary>Is this import required. True by default</summary>
