...
{
    /// <summary>Type of request (Root, Constructor parameter, etc)</summary>
    public enum RequestType
    {
        /// <summary>Root of the object graph</summary>
        Root,

        /// <summary>for constructor parameter</summary>
        ConstructorParameter,

        /// <summary>For member (field or property)</summary>
        Member,
    ...
    /// <summary>Activation node for wrapper or decorator path</summary>
    ...
    /// <summary>Known value expression</summary>
    public interface IKnownValueExpression
    {
        /// <summary>Type for expression</summary>
        Type ActivationType { get; }

        /// <summary>Hint for locating when multiple</summary>
        object Key { get; }

        /// <summary>Hint for where the value should be positioned</summary>
        int? Position { get; }

        /// <summary>Expression that represents the known value</summary>
    ...
    /// <summary>Default value information</summary>
    ...
    /// <summary>Services to be used during request</summary>
    public interface IActivationServices
    {
        ...
        /// <summary>Service for compiling delegates</summary>
        IActivationStrategyCompiler Compiler { get; }

        /// <summary>Linq expression builder</summary>
    ...
    /// <summary>Expression constants for request</summary>
    public interface IExpressionConstants
    {
        /// <summary>Root disposal scope</summary>
    ...
    /// <summary>Data that is per delegate, used for lifestyles</summary>
    public interface IDataPerDelegate : IExtraDataContainer
    {
    }

    /// <summary>Request context to create expression</summary>
    public interface IActivationExpressionRequest : IExtraDataContainer
    {
        ...
        /// <summary>Set filter for this request</summary>
        ...
        /// <summary>Require export scope for resolution</summary>
        void RequireExportScope();

        /// <summary>Export scope is required</summary>
        /// <returns></returns>
        ...
        /// <summary>Disposal scope required</summary>
        /// <returns></returns>
        ...
        /// <summary>Scope the request originated in</summary>
