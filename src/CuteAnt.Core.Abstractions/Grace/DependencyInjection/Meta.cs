...
{
  /// <summary>Class that holds a dependency and it's metadata</summary>
  ...
  public class Meta<T>
  {
    ...
    /// <summary>Metadata for the resolved value</summary>
    public IActivationStrategyMetadata Metadata { get; private set; }
  }

  /// <summary>Strongly typed metadata class</summary>
  /// <typeparam name="T"></typeparam>
