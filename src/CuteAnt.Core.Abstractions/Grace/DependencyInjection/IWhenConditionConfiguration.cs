...
{
  /// <summary>Object used to configure a condition</summary>
  /// <typeparam name="T"></typeparam>
  public interface IWhenConditionConfiguration<out T>
  {
    /// <summary>Use strategy when it meets condition</summary>
    /// <param name="condition">condition</param>
    /// <returns></returns>
    T MeetsCondition(ICompiledCondition condition);

    /// <summary>Use strategy when it meets a condition</summary>
    /// <param name="condition">condition</param>
    /// <returns></returns>
    ...
    /// <summary>Use export when injecting into a specific type</summary>
    /// <typeparam name="TInjectedType">injected type</typeparam>
    /// <returns>configuration</returns>
    T InjectedInto<TInjectedType>();

    /// <summary>Use export when injected into one of the specified types</summary>
    /// <param name="types"></param>
    /// <returns></returns>
    T InjectedInto(params Type[] types);

    /// <summary>Injected into type using test method</summary>
