...
{
    /// <summary>Type of strategy, export, wrapper, or decorator</summary>
    public enum ActivationStrategyType
    {
        /// <summary>Export</summary>
        ExportStrategy,

        /// <summary>Export from framework</summary>
        FrameworkExportStrategy,

        /// <summary>Wrapper strategy</summary>
        WrapperStrategy,

        /// <summary>Decorator strategy</summary>
        DecoratorStrategy
    }

    /// <summary>Activation strategy</summary>
    public interface IActivationStrategy : IExtraDataContainer, IDisposable
    {
        ...
        /// <summary>Lifestyle for this activation stratgey</summary>
        ...
        /// <summary>Are the object produced by this export externally owned</summary>
