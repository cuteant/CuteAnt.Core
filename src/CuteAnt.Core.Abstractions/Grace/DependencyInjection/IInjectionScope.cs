...
{
  /// <summary>Injection scope abstraction</summary>
  public interface IInjectionScope : IExportLocatorScope
  {
    ...
    /// <summary>Locate an export from a child scope (for internal use)</summary>
    ...
    object LocateFromChildScope(IExportLocatorScope childScope, IDisposalScope disposalScope, Type type, 
      object extraData, ActivationStrategyFilter consider, object key, bool allowNull, bool isDynamic);
    ...
    /// <returns></returns>
    List<T> InternalLocateAll<T>(IExportLocatorScope scope, IDisposalScope disposalScope, Type type, 
      object extraData, ActivationStrategyFilter consider, IComparer<T> comparer);
    ...
    /// <param name="consider"></param>
    /// <returns></returns>
    List<object> InternalLocateAllByName(IExportLocatorScope scope, IDisposalScope disposalScope, 
      string exportName, object extraData, ActivationStrategyFilter consider);
    ...
    /// <summary>Strategy compiler used for this scope</summary>
