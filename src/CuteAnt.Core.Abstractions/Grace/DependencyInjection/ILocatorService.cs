...
{
    /// <summary>Represents a class that can locate types, classes should not implement this interface directly rather IExportLocatorScope</summary>
    public interface ILocatorService : IServiceProvider
    {
        ...
        /// <returns></returns>
        object LocateOrDefault(Type type);
        ...
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        T LocateOrDefault<T>(T defaultValue);
