...
{
  /// <summary>Used to store extra data, implemented by IInjectionContext and IExportLocator</summary>
  ...
  {
    public static T GetExtraData<T>(this IExtraDataContainer container, object key) => (T)container.GetExtraData(key);
  }
}