...
{
    /// <summary>Immutable array create methods</summary>
    public static class ImmutableArray
    {
        ...
        /// <summary>Creates a new immutable list from an IEnumerable(T)</summary>
        ...
        /// <summary>Create a new immutable array from an T[]</summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="ts"></param>
    ...
    /// <summary>Immutable List that implements IReadOnlyList(T)</summary>
    /// <typeparam name="T"></typeparam>
    public struct ImmutableArray<T> : IReadOnlyList<T>, IEqualityComparer<ImmutableArray<T>>, IStructuralComparable, IStructuralEquatable
    {
        ...
        {
            // ReSharper disable once ForCanBeConvertedToForeach ReSharper disable once LoopCanBeConvertedToQuery
            for (var i = 0; i < _list.Length; i++)
            {
                if (Equals(item, _list[i])) { return true; }
            }
        ...
        /// <summary>Immutable list is always read only</summary>
        public bool IsReadOnly => true;

        /// <summary>Index of item</summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public int IndexOf(T item)
        {
            for (var i = 0; i < _list.Length; i++)
            {
                if (Equals(item, _list[i])) { return i; }
            }

            return -1;
        }

        /// <summary>Index into list</summary>
        /// <param name="index">index for list</param>
        /// <returns>T at index</returns>
        public T this[int index] => _list[index];

        /// <summary>Add T to ImmutableList creating new list</summary>
        ...
        /// <summary>Add and IEnumerable to this list</summary>
        /// <param name="enumerable"></param>
        /// <returns></returns>
        public ImmutableArray<T> AddRange(IEnumerable<T> enumerable) => AddRange(enumerable.ToArray());

        /// <summary>Adds a range of T to immutable list creating a new one</summary>
        ...
        /// <summary>Insert value into array</summary>
        ...
        /// <summary>Implicit conversion from List(T)</summary>
        /// <param name="list"></param>
        /// <returns></returns>
        public static explicit operator ImmutableArray<T>(T[] list)
        {
            if (list == null || 0u >= (uint)list.Length) { return Empty; }

            return new ImmutableArray<T>(ImmutableArray.CloneArray(list, list.Length));
        }

        /// <summary>Implicit conversion to List(T)</summary>
        /// <param name="list"></param>
        /// <returns></returns>
        ...
        /// <summary>Get hashcode of array</summary>
        /// <returns></returns>
        ...
        {
            if (x._list.Length != y._list.Length) { return false; }

            for (var i = 0; i < x._list.Length; i++)
            {
                if (x._list[i] == null)
                {
                    if (y._list[i] != null) { return false; }
                }
        ...
        /// </exception>
        public int GetHashCode(ImmutableArray<T> obj) => obj._list != null ? obj._list.GetHashCode() : 0;
        ...
        /// <summary>Equal override for nullable</summary>
        /// <param name="left"></param>
        /// <param name="right"></param>
        /// <returns></returns>
        ...
        /// <summary>Not equal override for nullable</summary>
        /// <param name="left"></param>
        /// <param name="right"></param>
        /// <returns></returns>
        public static bool operator !=(ImmutableArray<T>? left, ImmutableArray<T>? right)
        ...
        #region == class ImmutableArrayEnumerator<TItter> ==

        /// <summary>Internal enumerator class used to enumerate lists, stacks and queues</summary>
        ...
        internal class ImmutableArrayEnumerator<TItter> : IEnumerator<TItter>
        {
            ...
            {
                if (_count + 1 >= _list.Length) { return false; }
