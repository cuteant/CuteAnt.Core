...
{
    /// <summary>Static helper class for linked list</summary>
    public static class ImmutableLinkedList
    {
        /// <summary>Empty an immutable linked list in a thread and return the list</summary>
        ...
        /// <summary>Add to a list in a thread safe manner</summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <summary>Add a range to a list in a thread safe manner</summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="list"></param>
        ...
        /// <summary>creates a new immutable linked list from an enumerable</summary>
        /// <typeparam name="T"></typeparam>
    ...
    /// <summary>Immutable linked list class</summary>
    /// <typeparam name="T"></typeparam>
    ...
    public class ImmutableLinkedList<T> : IEnumerable<T>, IReadOnlyList<T>
    {
        ...
        /// <summary>For for link</summary>
        public T Value { get; }

        /// <summary>Next link in the list</summary>
        public ImmutableLinkedList<T> Next { get; }

        /// <summary>Count for list</summary>
        ...
        {
            return 0u >= (uint)Count ? (IEnumerator<T>)EmptyEnumerator : new LinkedListEnumerator(this);
        }
