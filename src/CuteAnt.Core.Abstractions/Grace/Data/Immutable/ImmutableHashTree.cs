...
{
    /// <summary>Static helper class for immutable hash tree</summary>
    public static class ImmutableHashTree
    {
        /// <summary>Create immutable hash tree from IEnuermable</summary>
        /// <typeparam name="TKey"></typeparam>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="enumerable"></param>
        /// <returns></returns>
        public static ImmutableHashTree<TKey, TValue> From<TKey, TValue>(IEnumerable<KeyValuePair<TKey, TValue>> enumerable)
        {
        ...
        /// <summary>Adds value to hash tree</summary>
        /// <typeparam name="TKey"></typeparam>
        /// <typeparam name="TValue"></typeparam>
        ...
        public static TValue ThreadSafeAdd<TKey, TValue>(ref ImmutableHashTree<TKey, TValue> destination, TKey key, TValue value, bool updateIfExists = false)
        {
            ...
            {
                if (updateIfExists) { return newValue; }
        ...
        /// <summary>Add to tree in a thread safe manner</summary>
        ...
        private static void SpinWaitThreadSafeAddS<TKey, TValue>(ref ImmutableHashTree<TKey, TValue> destination,
          TKey key, TValue value, ImmutableHashTree<TKey, TValue>.UpdateDelegate updateDelegate)
        {
    ...
    /// <summary>Immutable HashTree implementation http://en.wikipedia.org/wiki/AVL_tree</summary>
    /// <typeparam name="TKey"></typeparam>
    /// <typeparam name="TValue"></typeparam>
    ...
    {
        /// <summary>Empty hashtree, used as the starting point</summary>
        public static readonly ImmutableHashTree<TKey, TValue> Empty = new ImmutableHashTree<TKey, TValue>();

        /// <summary>Hash value for this node</summary>
        public readonly int Hash;

        /// <summary>Height of hashtree node</summary>
        public readonly int Height;

        /// <summary>Key value for this hash node</summary>
        public readonly TKey Key;

        /// <summary>Value for this hash node</summary>
        public readonly TValue Value;

        /// <summary>Keys with the same hashcode</summary>
        public readonly ImmutableArray<KeyValuePair<TKey, TValue>> Conflicts;

        /// <summary>Left node of the hash tree</summary>
        public readonly ImmutableHashTree<TKey, TValue> Left;

        /// <summary>Right node of the hash tree</summary>
        public readonly ImmutableHashTree<TKey, TValue> Right;

        /// <summary>Update delegate defines behavior when key already exists</summary>
        /// <param name="currentValue"></param>
        /// <param name="newValue"></param>
        /// <returns></returns>
        public delegate TValue UpdateDelegate(TValue currentValue, TValue newValue);

        /// <summary>Provide an action that will be called for each node in the hash tree</summary>
        ...
        /// <summary>Return an enumerable of KVP</summary>
        /// <returns></returns>
        ...
        /// <summary>Adds a new entry to the hashtree</summary>
        /// <param name="key">key to add</param>
        ...
        /// <summary>Checks to see if a key is contained in the hashtable</summary>
        ...
        /// <summary>Try get value from hashtree</summary>
        /// <param name="key"></param>
        ...
        /// <summary>Get value or default from hash tree</summary>
        ...
        /// <summary>Get value or default value from hash tree using a known hash value</summary>
        ...
        public TValue GetConflictedValue(TKey key, ImmutableHashTree<TKey, TValue> currentNode, TValue defaultValue)
        {
            ...
            if (0u >= (uint)currentNode.Height)
            {
                return defaultValue;
            }

            var conflicts = currentNode.Conflicts;
            for (int i = 0; i < conflicts.Count; i++)
            {
                var kvp = conflicts[i];
        ...
        /// <summary>Locate value from hash table, throws exception if not found</summary>
        ...
        /// <summary>Returns all the keys in the hashtree</summary>
        public IEnumerable<TKey> Keys => this.Select(x => x.Key);

        /// <summary>returns all the values in the hashtree</summary>
        public IEnumerable<TValue> Values => this.Select(x => x.Value);

        /// <summary>Is the hash tree empty</summary>
        public bool IsEmpty => 0u >= (uint)Height;

        /// <summary>Gets an enumerator for the immutable hash</summary>
        /// <returns>enumerator</returns>
        public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator() => IterateInOrder().GetEnumerator();

        IEnumerator IEnumerable.GetEnumerator() => GetEnumerator();

        /// <summary>Gets the count of the immutable hashtree. Note its faster to do a lookup than to do a count
        /// If you want to test for emptyness use the IsEmpty property</summary>
        public int Count => 0u >= (uint)Height ? 0 : this.Count();
        ...
        private ImmutableHashTree<TKey, TValue> RotateRight() => Left.New(Left.Left, New(Left.Right, Right));

        private ImmutableHashTree<TKey, TValue> RotateLeft() => Right.New(New(Left, Right.Left), Right.Right);
        ...
        private ImmutableHashTree<TKey, TValue> New(ImmutableHashTree<TKey, TValue> left, ImmutableHashTree<TKey, TValue> right)
            => new ImmutableHashTree<TKey, TValue>(Hash, Key, Value, Conflicts, left, right);
