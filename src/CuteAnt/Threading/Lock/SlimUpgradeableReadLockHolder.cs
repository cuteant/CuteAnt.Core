...
namespace CuteAnt.Threading
{
	...
	internal class SlimUpgradeableReadLockHolder : IUpgradeableLockHolder
	{
		...
		private Boolean wasLockAlreadyHeld;

		public SlimUpgradeableReadLockHolder(ReaderWriterLockSlim locker, Boolean waitForLock, Boolean wasLockAlreadyHelf)
		{
			this.locker = locker;
		...
		public ILockHolder Upgrade(Boolean waitForLock)
		{
