...
namespace CuteAnt.Threading
{
	...
	internal class SlimReadWriteLock : Lock
	{
		...
		public override IUpgradeableLockHolder ForReadingUpgradeable(Boolean waitForLock)
		{
			return new SlimUpgradeableReadLockHolder(locker, waitForLock, locker.IsUpgradeableReadLockHeld || locker.IsWriteLockHeld);
		}

		public override ILockHolder ForReading(Boolean waitForLock)
		{
		...
		public override ILockHolder ForWriting(Boolean waitForLock)
		{
