...
namespace CuteAnt.Reflection
{
	...
	internal class FastMethod
	{
		...
		private static IFastProvider _provider = new FastProvider();
		...
		private class FastProvider : IFastProvider
		{
			...
			private class FastHandlerGet<T> : IFastHandler
			{
			...
			private class FastHandlerSet<T> : IFastHandler
			{
