...
namespace CuteAnt.Reflection
{
	...
	public class AsmX86
	{
		...
		private static extern Int32 CloseHandle(Int32 hObject);

		[DllImport("kernel32.dll")]
		private static extern Int32 WriteProcessMemory(IntPtr hProcess, IntPtr lpBaseAddress, [In, Out] Byte[] buffer, Int32 size, out IntPtr lpNumberOfBytesWritten);

		[DllImport("kernel32.dll")]
		private static extern Int32 WriteProcessMemory(Int32 hProcess, Int32 lpBaseAddress, Byte[] buffer, Int32 size, Int32 lpNumberOfBytesWritten);

		[DllImport("kernel32", EntryPoint = "CreateRemoteThread")]
		private static extern Int32 CreateRemoteThread(Int32 hProcess, Int32 lpThreadAttributes, Int32 dwStackSize, Int32 lpStartAddress, Int32 lpParameter, Int32 dwCreationFlags, ref Int32 lpThreadId);

		[DllImport("Kernel32.dll")]
		private static extern System.Int32 VirtualAllocEx(IntPtr hProcess, Int32 lpAddress, Int32 dwSize, Int16 flAllocationType, Int16 flProtect);

		[DllImport("Kernel32.dll")]
		private static extern System.Int32 VirtualAllocEx(Int32 hProcess, Int32 lpAddress, Int32 dwSize, Int32 flAllocationType, Int32 flProtect);

		[DllImport("Kernel32.dll")]
		private static extern System.Int32 VirtualFreeEx(Int32 hProcess, Int32 lpAddress, Int32 dwSize, Int32 flAllocationType);

		[DllImport("kernel32.dll", EntryPoint = "OpenProcess")]
		private static extern Int32 OpenProcess(Int32 dwDesiredAccess, Int32 bInheritHandle, Int32 dwProcessId);
		...
		private String intTohex(Int32 value, Int32 num)
		{
			String str1;
			String str2 = "";
		...
		public void Run(Int32 pid)
		{
			...
			var asm = Builder.ToString().ToHex();
			if (pid != 0)
			{
