namespace CuteAnt.Reflection
{
  ...
  /// <summary>Options for formatting type names.</summary>
  public class TypeFormattingOptions : IEquatable<TypeFormattingOptions>
  {
    ...
    /// <summary>Gets a value indicating whether or not to include the fully-qualified namespace of the class in the result.</summary>
    public bool IncludeNamespace { get; private set; }

    /// <summary>Gets a value indicating whether or not to include concrete type parameters in the result.</summary>
    public bool IncludeTypeParameters { get; private set; }

    /// <summary>Gets a value indicating whether or not to include generic type parameters in the result.</summary>
    public bool IncludeGenericTypeParameters { get; private set; }

    /// <summary>Gets the separator used between declaring types and their declared types.</summary>
    public char NestedTypeSeparator { get; private set; }

    /// <summary>Gets the name to append to the formatted name, before any type parameters.</summary>
    public string NameSuffix { get; private set; }

    /// <summary>Gets a value indicating whether or not to include the global namespace qualifier.</summary>
