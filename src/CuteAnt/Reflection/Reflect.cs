...
namespace CuteAnt.Reflection
{
    ...
    public static partial class ReflectUtils
    {
        ...
        public static Type GetCachedGenericType(this Type type, params Type[] argTypes)
        {
            ...
            if (argTypes is null) { argTypes = Type.EmptyTypes; }
        ...
        public static MemberInfo LookupMember(this Type type, String name)
        {
            ...
            while (type is not null && type != TypeConstants.ObjectType)
            {
                ...
                if (fs is not null && fs.Length > 0) { return fs[0]; }
        ...
        public static String GetDisplayName(this MemberInfo member, Boolean inherit = true)
        {
            ...
            if (att is not null && !att.DisplayName.IsNullOrWhiteSpace()) { return att.DisplayName; }
        ...
        public static String GetDescription(this MemberInfo member, Boolean inherit = true)
        {
            ...
            if (att2 is not null && !att2.Description.IsNullOrWhiteSpace()) { return att2.Description; }
        ...
        public static Boolean As(this Type type, Type baseType)
        {
            ...
            {
                if (type.GetInterface(baseType.Name) is not null) { return true; }
            ...
            {
                // 反射加载时，需要特殊处理接口
                //if (baseType.IsInterface && type.GetInterface(baseType.Name) is not null) return true;
                while (type is not null && type != TypeConstants.ObjectType)
                {
