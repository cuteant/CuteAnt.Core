...
namespace CuteAnt.Reflection
{
  public static class TypeHelper
  {
    ...
    public static bool AreReferenceTypesCompatible(Type sourceType, Type destinationType)
    {
      ...
      {
        throw new ArgumentException("AreReferenceTypesCompatible can only be used for reference types");
      }
      if (object.ReferenceEquals(sourceType, destinationType))
      {
        return true;
    ...
    public static T Convert<T>(object source)
    {
      ...
      //throw new InvalidCastException($"Cannot convert object {source} to {conversionType}");
      ...
      return TypeUtils.ChangeType<T>(source);
    ...
    private static void GetImplementedTypesHelper(Type type, Dictionary<Type, object> typesEncountered)
    {
      ...
      while ((baseType != null) && (baseType != TypeConstants.ObjectType))
      {
    ...
    {
      if (sourceType.IsValueType && (destinationType == TypeConstants.ObjectType || destinationType == TypeConstants.ValueType))
      {
        return true;
      }
    ...
    {
      return type.IsGenericType && type.GetGenericTypeDefinition() == TypeConstants.NullableType;
    }
    ...
    public static bool IsNonNullableValueType(Type type)
    {
      ...
      return type != TypeConstants.StringType;
    }
