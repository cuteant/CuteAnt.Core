...
//#endif
    ...
    public Object Invoke(params Object[] parameters)
    {
      ...
      if (Method == null) throw new HmExceptionBase("脚本引擎未编译表达式！");
      ...
      var _my = CaPathExtensions.BaseDirectory;
      if (!WorkingDirectory.IsNullOrEmpty())
      {
        flag = true;
        Environment.CurrentDirectory = WorkingDirectory;
        CaPathExtensions.BaseDirectory = WorkingDirectory;
      }
      ...
      finally
      {
        if (flag)
        {
          ...
          CaPathExtensions.BaseDirectory = _my;
        }
      }
    }
