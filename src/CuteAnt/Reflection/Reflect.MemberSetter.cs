...
namespace CuteAnt.Reflection
{
    ...
    partial class ReflectUtils
    {
        ...
        public static bool IsNullOrEmpty(this MemberSetter setter) => setter is null || object.ReferenceEquals(TypeAccessorHelper.EmptyMemberSetter, setter);
        public static bool IsNullOrEmpty<T>(this MemberSetter<T> setter) => setter is null || object.ReferenceEquals(TypeAccessorHelper<T>.EmptyMemberSetter, setter);
        ...
        private static MemberSetter GetValueSetterInternal(PropertyInfo propertyInfo)
        {
            ...
            if (method is null) { return TypeAccessorHelper.EmptyMemberSetter; }
            try
            {
                if (method.IsStatic)
                {
