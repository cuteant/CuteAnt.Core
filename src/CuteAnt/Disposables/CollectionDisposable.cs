...
namespace CuteAnt.Disposables
{
  ...
  {
    /// <summary>Creates a disposable that disposes a collection of disposables.</summary>
    ...
    /// <summary>Adds a disposable to the collection of disposables.
    /// If this instance is already disposed or disposing, then <paramref name="disposable"/> is disposed immediately.</summary>
