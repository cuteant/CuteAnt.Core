...
{
  /// <summary>Interface for generating IL for a NewArray expression</summary>
  public interface IArrayInitExpressionGenerator
  {
    /// <summary>Generate IL for new array expression</summary>
  ...
  /// <summary>Class for generating IL for a NewArray expression</summary>
