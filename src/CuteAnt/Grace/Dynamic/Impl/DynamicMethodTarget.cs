...
{
  /// <summary>dynamic method target that uses array</summary>
  internal sealed class ArrayDynamicMethodTarget
  {
    public ArrayDynamicMethodTarget(object[] items) => Items = items;

    /// <summary>array of constants</summary>
    public object[] Items;
  }

  /// <summary>Default dynamic method target</summary>
  internal sealed class DynamicMethodTarget
  {
  }

  /// <summary>Dynamic method target with one constant</summary>
  /// <typeparam name="T1"></typeparam>
  internal sealed class DynamicMethodTarget<T1>
  {
    /// <summary>Default constructor</summary>
    /// <param name="t1"></param>
    public DynamicMethodTarget(T1 t1) => TArg1 = t1;

    /// <summary>constant one</summary>
    public T1 TArg1;
  }

  /// <summary>dynamic method target with two args</summary>
  /// <typeparam name="T1"></typeparam>
  ...
  /// <summary>dynamic method target with three args</summary>
  /// <typeparam name="T1"></typeparam>
  /// <typeparam name="T2"></typeparam>
  ...
  /// <summary>dynamic method target with four args</summary>
  /// <typeparam name="T1"></typeparam>
  /// <typeparam name="T2"></typeparam>
  /// <typeparam name="T3"></typeparam>
  ...
  /// <summary>dynamic method target with six args</summary>
  /// <typeparam name="T1"></typeparam>
  /// <typeparam name="T2"></typeparam>
  /// <typeparam name="T3"></typeparam>
  /// <typeparam name="T4"></typeparam>
  ...
  internal sealed class DynamicMethodTarget<T1, T2, T3, T4, T5, T6>
  {
    ...
    /// <summary>constant six</summary>
    public T6 TArg6;
  }

  /// <summary>dynamic method target with seven args</summary>
  /// <typeparam name="T1"></typeparam>
  /// <typeparam name="T2"></typeparam>
  /// <typeparam name="T3"></typeparam>
  /// <typeparam name="T4"></typeparam>
  ...
  internal sealed class DynamicMethodTarget<T1, T2, T3, T4, T5, T6, T7>
  {
    ...
    /// <summary>constant seven</summary>
    public T7 TArg7;
  }
