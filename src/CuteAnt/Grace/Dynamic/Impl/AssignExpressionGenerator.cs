...
{
  /// <summary>Interface for emiting assign expression</summary>
  public interface IAssignExpressionGenerator
  {
    /// <summary>Generate IL for assign statement</summary>
  ...
  /// <summary>Expression generator for assign statement</summary>
