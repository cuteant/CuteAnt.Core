...
{
  /// <summary>Interface for generating a method call expression</summary>
  public interface ICallExpressionGenerator
  {
    /// <summary>Generate IL for method call expression</summary>
  ...
  /// <summary>class for generating method call expression</summary>
