...
{
  /// <summary>Configuration class for using IL generation in liue of Linq Expressions</summary>
  public class GraceDynamicMethod : InjectionScopeConfiguration
  {
    ...
    /// <summary>Implementation factory for dynamic IL generation</summary>
    protected static ImplementationFactory DynamicImplementation;

    /// <summary>Static constructor to setup dynamic implementation</summary>
