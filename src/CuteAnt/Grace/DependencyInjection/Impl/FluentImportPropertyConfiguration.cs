...
{
  /// <summary>Import property configuration</summary>
  public class FluentImportPropertyConfiguration : ProxyFluentExportStrategyConfiguration, IFluentImportPropertyConfiguration
  {
    ...
    /// <summary>use a filter delegate when importing property</summary>
    ...
    /// <summary>Default value if one can not be found</summary>
    ...
    /// <summary>Provide value to be used for property</summary>
  ...
  /// <summary>Configuration class for importing a property</summary>
  ...
  public class FluentImportPropertyConfiguration<T, TProp> : ProxyFluentExportStrategyConfiguration<T>, IFluentImportPropertyConfiguration<T, TProp>
  {
    ...
    public FluentImportPropertyConfiguration(IFluentExportStrategyConfiguration<T> strategy, MemberInjectionInfo memberInjectionInfo)
      : base(strategy) => _memberInjectionInfo = memberInjectionInfo;
    ...
    /// <summary>Provide value for property</summary>
