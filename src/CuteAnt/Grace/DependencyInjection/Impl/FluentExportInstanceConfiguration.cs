...
{
  /// <summary>Configuration object for an export instance</summary>
  ...
  public class FluentExportInstanceConfiguration<T> : IFluentExportInstanceConfiguration<T>, IActivationStrategyProvider
  {
    ...
    /// <summary>Export as a specific keyed type</summary>
    ...
    /// <summary>Only export if delegate returns true</summary>
    ...
    /// <summary>Use export under specific conditions</summary>
    ...
    /// <summary>Set priority for export</summary>
