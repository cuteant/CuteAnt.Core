...
{
  /// <summary>Configuration object for exporting a member</summary>
  ...
  public class FluentExportMemberConfiguration<T> : ProxyFluentExportStrategyConfiguration<T>, IFluentExportMemberConfiguration<T>
  {
    ...
    public FluentExportMemberConfiguration(IFluentExportStrategyConfiguration<T> strategy, ICompiledExportStrategy exportStrategy) 
      : base(strategy) => _exportStrategy = exportStrategy;

    /// <summary>Control what type the member is exported as</summary>
    ...
    /// <summary>Add a condition for property export</summary>
