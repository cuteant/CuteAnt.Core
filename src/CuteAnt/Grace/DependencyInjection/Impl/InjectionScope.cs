...
namespace Grace.DependencyInjection.Impl
{
  ...
  public class InjectionScope : BaseExportLocatorScope, IInjectionScope
  {
    ...
    /// <summary>Disposal scope providers, this or DisposalScope must be set</summary>
    protected IDisposalScopeProvider DisposalScopeProvider;

    /// <summary>Default disposal scope, this or DisposalScopeProdiver must be set</summary>
    ...
    public object LocateOrDefault(Type type)
    {
      ...
      return func != null ?
             func(this, DisposalScope ?? DisposalScopeProvider.ProvideDisposalScope(this), null) :
             InternalLocate(this, DisposalScope ?? DisposalScopeProvider.ProvideDisposalScope(this), type, null, null, null, true, false);
    }
    ...
    public List<object> LocateAll(Type type, object extraData = null, ActivationStrategyFilter consider = null, IComparer<object> comparer = null)
        => ((IInjectionScope)this).InternalLocateAll(this, DisposalScope ?? DisposalScopeProvider.ProvideDisposalScope(this), type, extraData, consider, comparer);
    ...
    public List<T> LocateAll<T>(Type type = null, object extraData = null, ActivationStrategyFilter consider = null, IComparer<T> comparer = null)
        => ((IInjectionScope)this).InternalLocateAll(this, DisposalScope ?? DisposalScopeProvider.ProvideDisposalScope(this), type ?? typeof(T), extraData, consider, comparer);
    ...
    public object LocateByName(string name, object extraData = null, ActivationStrategyFilter consider = null)
        => ((IInjectionScope)this).LocateByNameFromChildScope(this,
    ...
    public List<object> LocateAllByName(string name, object extraData = null, ActivationStrategyFilter consider = null)
        => ((IInjectionScope)this).InternalLocateAllByName(this,
    ...
    public IExportLocatorScope BeginLifetimeScope(string scopeName = "")
        => InternalFieldStorage.LifetimeScopeProvider == null
      ...
      Type type, IInjectionContext context, ActivationStrategyFilter filter, List<TValue> returnList) where TStrategy : IWrapperOrExportActivationStrategy
    {
      foreach (var strategy in collection.GetStrategies())
      {
        ...
        {
          returnList.Add((TValue)activationDelegate(scope, disposalScope, context?.Clone()));
        }
      }
    }
    ...
    protected class InternalFieldStorageClass
    {
      ...
      /// <summary>Provides IExportLocatorScope when requested</summary>
