...
{
  /// <summary>Export strategy for exporting a method off an existing type</summary>
  public class ExportMethodStrategy : ConfigurableActivationStrategy, ICompiledExportStrategy
  {
    ...
    public ExportMethodStrategy(Type activationType, IInjectionScope injectionScope, ICompiledExportStrategy dependentStrategy, MethodInfo methodInfo)
    ...
    public IActivationExpressionResult GetDecoratorActivationExpression(IInjectionScope scope, IActivationExpressionRequest request, ICompiledLifestyle lifestyle)
        => GetExpressionFromDependentStrategy(scope, request);
    ...
    public void AddSecondaryStrategy(ICompiledExportStrategy secondaryStrategy) => throw new NotSupportedException("Secondary strategies not supported on method export");
