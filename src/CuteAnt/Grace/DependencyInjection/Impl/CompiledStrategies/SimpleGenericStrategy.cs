...
{
  /// <summary>Abstract class for basing simple generic strategies on</summary>
  public abstract class SimpleGenericStrategy : ConfigurableActivationStrategy, ICompiledExportStrategy
  {
    ...
    protected SimpleGenericStrategy(Type activationType, IInjectionScope injectionScope)
    ...
    /// <returns></returns>
    public abstract IActivationExpressionResult GetDecoratorActivationExpression(
