...
{
    /// <summary>Standard export strategy for all non generic types registered with the container</summary>
    public class CompiledExportStrategy : ConfigurableActivationStrategy, ICompiledExportStrategy
    {
        ...
        public CompiledExportStrategy(Type activationType, IInjectionScope injectionScope, IDefaultStrategyExpressionBuilder builder)
        ...
        {
            const string _beginLifetimeScopeMethodName = nameof(IExportLocatorScope.BeginLifetimeScope);
            ...
            if (ActivationConfiguration.CustomScopeName != null)
            {
                ...
                var beginScopeMethod = typeof(IExportLocatorScope).GetTypeInfo().GetDeclaredMethod(_beginLifetimeScopeMethodName);
        ...
        public void AddSecondaryStrategy(ICompiledExportStrategy secondaryStrategy) => _secondaryStrategies = _secondaryStrategies.Add(secondaryStrategy);

        /// <summary>Provide secondary strategies such as exporting property or method</summary>
        /// <returns>export strategies</returns>
        public IEnumerable<ICompiledExportStrategy> SecondaryStrategies() => _secondaryStrategies;
    }
}