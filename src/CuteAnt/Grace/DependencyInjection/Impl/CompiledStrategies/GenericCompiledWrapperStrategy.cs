...
{
  /// <summary>Wrapper strategy for generic type</summary>
  public class GenericCompiledWrapperStrategy : ConfigurableActivationStrategy, IConfigurableCompiledWrapperStrategy
  {
    ...
    public GenericCompiledWrapperStrategy(Type activationType, IInjectionScope injectionScope, IDefaultStrategyExpressionBuilder builder)
