...
{
    /// <summary>base locator scope used by InjectionScope and LifetimeScope</summary>
    public abstract partial class BaseExportLocatorScope : DisposalScope, IExportLocatorScope
    {
        ...
        /// <summary>Cache delegate for base scopes</summary>
        protected readonly ActivationStrategyDelegateCache DelegateCache;

        /// <summary>Internal scoped storage used by Scoped Lifestyle</summary>
        ...
        protected BaseExportLocatorScope(IExportLocatorScope parent, string name,
        ...
        /// <summary>Parent for scope</summary>
        ...
        /// <summary>Sets extra data on the locator scope</summary>
        ...
        public object GetLockObject(string lockName)
            => _lockObjects.GetValueOrDefault(lockName) ?? ImmutableHashTree.ThreadSafeAdd(ref _lockObjects, lockName, new object());
        ...
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        public T LocateOrDefault<T>(T defaultValue)
        {
        ...
        /// <summary>class for storing scoped instances</summary>
        protected class ScopedStorage
        {
            /// <summary>storage id</summary>
            public int Id;

            /// <summary>Scoped service instance</summary>
            public object ScopedService;

            /// <summary>Next scoped storage in list</summary>
