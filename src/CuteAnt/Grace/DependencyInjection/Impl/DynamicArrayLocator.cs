...
{
  /// <summary>Creates an array of element type</summary>
  public class DynamicArrayLocator : IDynamicArrayLocator
  {
    /// <summary>Delegate for creating dynamic array</summary>
    ...
    /// <returns></returns>
    public delegate object ArrayCreateDelegate(IInjectionScope injectionScope, IExportLocatorScope scope, IDisposalScope disposalScope,
    ...
    public object Locate(IInjectionScope injectionScope, IExportLocatorScope scope, IDisposalScope disposalScope, Type type, ActivationStrategyFilter consider, IInjectionContext injectionContext)
    {
      ...
      const string _arrayCreateMethodName = nameof(ArrayCreateMethod);
      ...
      if (createDelegate == null)
      {
        ...
        var method = typeof(DynamicArrayLocator)
            .GetRuntimeMethods().FirstOrDefault(m => string.Equals(_arrayCreateMethodName, m.Name));
    ...
    /// <summary>Static method to create an a dynamic array</summary>
    ...
    public static object ArrayCreateMethod<T>(IInjectionScope injectionScope, IExportLocatorScope scope,
      IDisposalScope disposalScope, ActivationStrategyFilter consider, IInjectionContext injectionContext)
        => injectionScope.InternalLocateAll<T>(scope, disposalScope, typeof(T), injectionContext, consider, null).ToArray();
  }
}