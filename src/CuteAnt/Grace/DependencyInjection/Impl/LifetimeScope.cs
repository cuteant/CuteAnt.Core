...
namespace Grace.DependencyInjection.Impl
{
    ...
    public class LifetimeScope : BaseExportLocatorScope, IExportLocatorScope
    {
        ...
        public LifetimeScope(IExportLocatorScope parent, IInjectionScope injectionScope, string name, ActivationStrategyDelegateCache activationDelegates)
            : base(parent, name, activationDelegates)
        {
        ...
        /// <returns></returns>
        public override bool CanLocate(Type type, ActivationStrategyFilter consider = null, object key = null) => _injectionScope.CanLocate(type, consider, key);

        /// <summary>Create injection context</summary>
        /// <param name="extraData">extra data</param>
        /// <returns>injection context</returns>
        public override IInjectionContext CreateContext(object extraData = null) => _injectionScope.CreateContext(extraData);
