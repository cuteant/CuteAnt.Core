...
{
    /// <summary>Strategy that represents a constant value</summary>
    ...
    public class ConstantInstanceExportStrategy<T> : BaseInstanceExportStrategy
    {
        ...
        public ConstantInstanceExportStrategy(T constant, IInjectionScope injectionScope)
          : base(GetBaseType(constant), injectionScope) => _constant = constant;
        ...
        {
            if (lifestyle == null) { return CreateExpression(request); }
        ...
        {
            return typeof(T) == typeof(object) && constant is object ? constant.GetType() : typeof(T);
        }
    }
}