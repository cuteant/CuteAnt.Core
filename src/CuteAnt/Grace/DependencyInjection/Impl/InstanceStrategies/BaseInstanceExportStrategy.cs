...
{
  /// <summary>Base export strategy for all instance and factory exports</summary>
  public abstract class BaseInstanceExportStrategy : ConfigurableActivationStrategy, ICompiledExportStrategy, IInstanceActivationStrategy
  {
    ...
    /// <summary>delegate for the strategy</summary>
    protected ActivationStrategyDelegate StrategyDelegate;

    /// <summary>Default constructor</summary>
    /// <param name="activationType"></param>
    /// <param name="injectionScope"></param>
    protected BaseInstanceExportStrategy(Type activationType, IInjectionScope injectionScope)
    ...
    public IActivationExpressionResult GetDecoratorActivationExpression(
      IInjectionScope scope, IActivationExpressionRequest request, ICompiledLifestyle lifestyle)
        => CreateExpression(scope, request, lifestyle);
    ...
    /// <summary>Allow for null returns</summary>
    ...
    /// <param name="lifestyle"></param>
    /// <returns></returns>
    protected abstract IActivationExpressionResult CreateExpression(
      IInjectionScope scope, IActivationExpressionRequest request, ICompiledLifestyle lifestyle);
  }
}