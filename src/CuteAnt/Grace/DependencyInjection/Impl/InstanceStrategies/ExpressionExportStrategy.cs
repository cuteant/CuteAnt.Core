...
{
  /// <summary>Strategy for export Expression Tree</summary>
  ...
  public class ExpressionExportStrategy<T> : BaseInstanceExportStrategy
  {
    ...
    public ExpressionExportStrategy(Expression<Func<T>> expression, IInjectionScope injectionScope)
      : base(typeof(T), injectionScope) => _expression = expression;
