...
{
    /// <summary>Strategy for creating Func with 4 args</summary>
    public class FuncFourArgWrapperStrategy : BaseWrapperStrategy
    {
        /// <summary>Default constructor</summary>
        /// <param name="injectionScope"></param>
        public FuncFourArgWrapperStrategy(IInjectionScope injectionScope)
...
#if NET40
            return genericType == typeof(Func<,,,,>) ? type.GenericTypeArguments()[4] : null;
#else
            return genericType == typeof(Func<,,,,>) ? type.GenericTypeArguments[4] : null;
#endif
        }
        ...
        /// <summary>Helper class that creates Func with 4 arguements</summary>
        ...
        public class FuncExpression<T1, T2, T3, T4, TResult>
        {
              ...
              IInjectionContextCreator injectionContextCreator, IActivationStrategy activationStrategy)
            {
                ...
                var newRequest = request.NewRequest(typeof(TResult), activationStrategy,
                    typeof(Func<T1, T2, T3, T4, TResult>), RequestType.Other, null, true);
            ...
            /// <summary>Method that creates new Func with 4 args</summary>
            /// <param name="scope"></param>
            /// <param name="disposalScope"></param>
            /// <param name="context"></param>
            /// <returns></returns>
            public Func<T1, T2, T3, T4, TResult> CreateFunc(IExportLocatorScope scope, IDisposalScope disposalScope, IInjectionContext context)
            {
