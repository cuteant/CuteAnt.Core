...
{
    /// <summary>Strategy for creating Func with 3 args</summary>
    public class FuncThreeArgWrapperStrategy : BaseWrapperStrategy
    {
        /// <summary>Default constructor</summary>
        /// <param name="injectionScope"></param>
        public FuncThreeArgWrapperStrategy(IInjectionScope injectionScope)
...
#if NET40
            return genericType == typeof(Func<,,,>) ? type.GenericTypeArguments()[3] : null;
#else
            return genericType == typeof(Func<,,,>) ? type.GenericTypeArguments[3] : null;
#endif
        }
        ...
        /// <summary>Helper class that creates Func with 3 args</summary>
        ...
        public class FuncExpression<T1, T2, T3, TResult>
        {
              ...
              IInjectionContextCreator injectionContextCreator, IActivationStrategy activationStrategy)
            {
                ...
                var newRequest = request.NewRequest(typeof(TResult), activationStrategy,
                    typeof(Func<T1, T2, T3, TResult>), RequestType.Other, null, true);
            ...
            /// <summary>Method creates 3 arg Func</summary>
            /// <param name="scope"></param>
            /// <param name="disposalScope"></param>
            /// <param name="context"></param>
            /// <returns></returns>
            public Func<T1, T2, T3, TResult> CreateFunc(IExportLocatorScope scope, IDisposalScope disposalScope, IInjectionContext context)
            {
