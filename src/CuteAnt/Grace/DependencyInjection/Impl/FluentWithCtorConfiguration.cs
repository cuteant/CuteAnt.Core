...
namespace Grace.DependencyInjection.Impl
{
  ...
  public class FluentWithCtorConfiguration : ProxyFluentExportStrategyConfiguration, IFluentWithCtorConfiguration
  {
    ...
    /// <summary>Applies a filter to be used when resolving a parameter constructor It will be called each
    /// time the parameter is resolved.</summary>
    ...
    /// <summary>Default value function</summary>
    /// <param name="defaultValueFunc"></param>
    /// <returns></returns>
  ...
  public class FluentWithCtorConfiguration<TParam> : ProxyFluentExportStrategyConfiguration, IFluentWithCtorConfiguration<TParam>
  {
    ...
    /// <param name="strategy"></param>
    /// <param name="constructorParameterInfo"></param>
    public FluentWithCtorConfiguration(IFluentExportStrategyConfiguration strategy, ConstructorParameterInfo constructorParameterInfo)
      : base(strategy) => _constructorParameterInfo = constructorParameterInfo;
  ...
  /// <summary>Configuration object for constructor parameter</summary>
  ...
  public class FluentWithCtorConfiguration<T, TParam> : ProxyFluentExportStrategyConfiguration<T>, IFluentWithCtorConfiguration<T, TParam>
  {
    ...
    /// <summary>Mark the parameter as dynamic (will be located from child scopes)</summary>
    /// <param name="isDynamic"></param>
    /// <returns></returns>
    ...
    /// <summary>Use specific type to satisfy parameter</summary>
    /// <param name="type"></param>
    /// <returns></returns>
