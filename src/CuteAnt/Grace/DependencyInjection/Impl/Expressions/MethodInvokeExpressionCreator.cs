...
{
  /// <summary>Creates expression to call methods on type being instantiated</summary>
  public class MethodInvokeExpressionCreator : IMethodInvokeExpressionCreator
  {
    ...
    private IEnumerable<ActivationStrategyDependency> GetDependenciesForMethod(MethodInjectionInfo methodInjection,
      TypeActivationConfiguration configuration, IActivationExpressionRequest request)
    {
      var list = ImmutableLinkedList<ActivationStrategyDependency>.Empty;
