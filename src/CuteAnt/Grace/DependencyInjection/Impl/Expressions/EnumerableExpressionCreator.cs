...
{
  /// <summary>class for creating enumerable expressions</summary>
  public class EnumerableExpressionCreator : IEnumerableExpressionCreator
  {
    ...
    /// <returns></returns>
    public IActivationExpressionResult GetEnumerableExpression(IInjectionScope scope, IActivationExpressionRequest request, IArrayExpressionCreator arrayExpressionCreator)
    {
    ...
    /// <summary>Create enumerable expression that is an array</summary>
    ...
    /// <summary>Create enumerable method</summary>
