...
{
  /// <summary>Injection context that can be created on the fly</summary>
  public class InjectionContext : IInjectionContext
  {
    ...
    /// <summary>Get data from context, returns null if not found</summary>
    ...
    /// <summary>Set data into context</summary>
    ...
    /// <summary>Original object that was passed in as extra data when locate was called</summary>
    public object ExtraData { get; private set; }

    /// <summary>Data container that is shared between all context for an object graph</summary>
    public IInjectionContextSharedData SharedData { get; private set; }

    /// <summary>Get a value by type from the extra data</summary>
