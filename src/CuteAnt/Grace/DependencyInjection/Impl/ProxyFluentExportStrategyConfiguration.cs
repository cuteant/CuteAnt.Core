...
{
    /// <summary>forwards strategy configuration</summary>
    public abstract class ProxyFluentExportStrategyConfiguration : IFluentExportStrategyConfiguration
    {
        ...
        protected ProxyFluentExportStrategyConfiguration(IFluentExportStrategyConfiguration strategy) => _strategy = strategy;

        /// <summary>Export as a specific type</summary>
        /// <param name="type">type to export as</param>
        /// <returns>configuraiton object</returns>
        public IFluentExportStrategyConfiguration As(Type type) => _strategy.As(type);

        /// <summary>Export as keyed interface</summary>
        /// <param name="type">type to export as</param>
        /// <param name="key">key to export under</param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration AsKeyed(Type type, object key) => _strategy.AsKeyed(type, key);

        /// <summary>Export as Name</summary>
        /// <param name="name"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration AsName(string name) => _strategy.AsName(name);

        /// <summary>Export by interfaces</summary>
        /// <param name="filter"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration ByInterfaces(Func<Type, bool> filter = null) => _strategy.ByInterfaces(filter);

        /// <summary>Mark the export as externally owned so the container does not track for disposal</summary>
        /// <returns>configuraiton object</returns>
        public IFluentExportStrategyConfiguration ExternallyOwned() => _strategy.ExternallyOwned();

        /// <summary>Use specific constructor for use</summary>
        /// <param name="constructorInfo">constructor to use</param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration ImportConstructor(ConstructorInfo constructorInfo) => _strategy.ImportConstructor(constructorInfo);
        ...
        /// <param name="filter"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration OnlyIf(Func<IExportRegistrationBlock, bool> filter) => _strategy.OnlyIf(filter);

        /// <inheritdoc />
        public IFluentExportStrategyConfiguration ProcessAttributes() => _strategy.ProcessAttributes();

        /// <summary>Assign a custom lifestyle to an export</summary>
        /// <param name="lifestyle"></param>
        /// <returns>configuraiton object</returns>
        public IFluentExportStrategyConfiguration UsingLifestyle(ICompiledLifestyle lifestyle) => _strategy.Lifestyle.Custom(lifestyle);
        ...
        /// <returns></returns>
        public IFluentWithCtorConfiguration<TParam> WithCtorParam<TParam>(Func<TParam> paramFunc = null) => _strategy.WithCtorParam(paramFunc);

        /// <summary>Export with specific metadata</summary>
        /// <param name="key">metadata key</param>
        /// <param name="value">metadata value</param>
        /// <returns>configuraiton object</returns>
        public IFluentExportStrategyConfiguration WithMetadata(object key, object value) => _strategy.WithMetadata(key, value);

        /// <summary>Set the priority for the export</summary>
        /// <param name="priority"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration WithPriority(int priority) => _strategy.WithPriority(priority);

        /// <summary>Defines a custom scope when creating instance</summary>
        /// <param name="customscope"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration DefinesNamedScope(string customscope) => _strategy.DefinesNamedScope(customscope);
    }

    /// <summary>Base class for configurin an export strategy</summary>
    ...
    public abstract class ProxyFluentExportStrategyConfiguration<T> : IFluentExportStrategyConfiguration<T>
    {
        ...
        /// <summary>Default constructor</summary>
        /// <param name="strategy"></param>
        protected ProxyFluentExportStrategyConfiguration(IFluentExportStrategyConfiguration<T> strategy) => _strategy = strategy;
        ...
        public IFluentExportStrategyConfiguration<T> ActivationMethod(Expression<Action<T>> activationMethod)
            => _strategy.ActivationMethod(activationMethod);
        ...
        /// <returns>configuration object</returns>
        public IFluentExportStrategyConfiguration<T> Apply(Action<T> applyAction) => _strategy.Apply(applyAction);

        /// <summary>Export as a specific type</summary>
        /// <param name="type">type to export as</param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> As(Type type) => _strategy.As(type);

        /// <summary>Export as a particular type</summary>
        /// <typeparam name="TInterface">type to export as</typeparam>
        /// <returns>configuration object</returns>
        public IFluentExportStrategyConfiguration<T> As<TInterface>() => _strategy.As<TInterface>();

        /// <summary>Export as keyed type</summary>
        /// <param name="type">export type</param>
        /// <param name="key">key</param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> AsKeyed(Type type, object key) => _strategy.AsKeyed(type, key);

        /// <summary>Export as a keyed type</summary>
        /// <typeparam name="TInterface">export type</typeparam>
        /// <param name="key">key to export under</param>
        /// <returns>configuration object</returns>
        public IFluentExportStrategyConfiguration<T> AsKeyed<TInterface>(object key) => _strategy.AsKeyed<TInterface>(key);

        /// <summary>Export as specific name</summary>
        /// <param name="name"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> AsName(string name) => _strategy.AsName(name);

        /// <summary>Export the type by the interfaces it implements</summary>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> ByInterfaces(Func<Type, bool> filter = null) => _strategy.ByInterfaces(filter);

        /// <summary>Creates a new scope and then resolves decorators inside of it.</summary>
        /// <param name="namedScope"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> DefinesNamedScope(string namedScope) => _strategy.DefinesNamedScope(namedScope);
        ...
        public IFluentExportStrategyConfiguration<T> DisposalCleanupDelegate(Action<T> disposalCleanupDelegate)
            => _strategy.DisposalCleanupDelegate(disposalCleanupDelegate);
        ...
        public IFluentExportStrategyConfiguration<T> EnrichWithDelegate(Func<IExportLocatorScope, StaticInjectionContext, T, T> enrichmentDelegate)
            => _strategy.EnrichWithDelegate(enrichmentDelegate);
        ...
        public IFluentExportMemberConfiguration<T> ExportMember<TValue>(Expression<Func<T, TValue>> memberExpression)
            => _strategy.ExportMember(memberExpression);

        /// <summary>Mark an export as externally owned means the container will not track and dispose the instance</summary>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> ExternallyOwned() => _strategy.ExternallyOwned();
        ...
        public IFluentExportStrategyConfiguration<T> ImportConstructorSelection(IConstructorExpressionCreator method)
            => _strategy.ImportConstructorSelection(method);
        ...
        public IFluentExportStrategyConfiguration<T> ImportMembers(Func<MemberInfo, bool> selector = null, bool injectMethod = false)
            => _strategy.ImportMembers(selector, injectMethod);
        ...
        public IFluentImportPropertyConfiguration<T, TProp> ImportProperty<TProp>(Expression<Func<T, TProp>> property)
            => _strategy.ImportProperty(property);

        /// <summary>Import a specific method on the type</summary>
        /// <param name="method">method to import</param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> ImportMethod(Expression<Action<T>> method) => _strategy.ImportMethod(method);
        ...
        /// <param name="filter"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> OnlyIf(Func<IExportRegistrationBlock, bool> filter) => _strategy.OnlyIf(filter);

        /// <inheritdoc />
        public IFluentExportStrategyConfiguration<T> ProcessAttributes() => _strategy.ProcessAttributes();
        ...
        public IFluentExportStrategyConfiguration<T> UsingLifestyle(ICompiledLifestyle lifestyle)
            => _strategy.Lifestyle.Custom(lifestyle);
        ...
        public IFluentWithCtorConfiguration<T, TParam> WithCtorParam<TParam>(Func<TParam> paramValue = null)
            => _strategy.WithCtorParam(paramValue);
        ...
        public IFluentWithCtorCollectionConfiguration<T, TItem> WithCtorCollectionParam<TParam, TItem>() where TParam : IEnumerable<TItem>
            => _strategy.WithCtorCollectionParam<TParam, TItem>();
        ...
        /// <param name="value">metadata value</param>
        /// <returns>configuration object</returns>
        public IFluentExportStrategyConfiguration<T> WithMetadata(object key, object value) => _strategy.WithMetadata(key, value);

        /// <summary>Set the priority for the export</summary>
        /// <param name="priority"></param>
        /// <returns></returns>
        public IFluentExportStrategyConfiguration<T> WithPriority(int priority) => _strategy.WithPriority(priority);
