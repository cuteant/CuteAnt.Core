...
{
  /// <summary>Strategy for Func that take 2 dependencies and returns TResult</summary>
  ...
  public class FactoryTwoArgStrategy<T1, T2, TResult> : DelegateBaseExportStrategy<Func<T1, T2, TResult>>
  {
    ...
    public FactoryTwoArgStrategy(Func<T1, T2, TResult> func, IInjectionScope injectionScope)
