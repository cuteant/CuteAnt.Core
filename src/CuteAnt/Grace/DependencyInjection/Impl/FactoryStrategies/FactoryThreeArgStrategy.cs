...
{
  /// <summary>Strategy for Func that take 3 dependencies and returns TResult</summary>
  ...
  public class FactoryThreeArgStrategy<T1, T2, T3, TResult> : DelegateBaseExportStrategy<Func<T1, T2, T3, TResult>>
  {
    ...
    public FactoryThreeArgStrategy(Func<T1, T2, T3, TResult> func, IInjectionScope injectionScope)
