...
namespace Grace.DependencyInjection.Impl
{
    ...
    public class ProxyFluentDecoratorStrategyConfiguration : IFluentDecoratorStrategyConfiguration
    {
        ...
        /// <returns></returns>
        public IFluentDecoratorStrategyConfiguration ApplyAfterLifestyle() => _configuration.ApplyAfterLifestyle();

        /// <summary>Export as particular types</summary>
        /// <param name="type"></param>
        /// <returns></returns>
        public IFluentDecoratorStrategyConfiguration As(Type type) => _configuration.As(type);
        ...
        public IFluentDecoratorWithCtorConfiguration<TParam> WithCtorParam<TParam>(Func<TParam> paramValue = null)
            => _configuration.WithCtorParam(paramValue);
