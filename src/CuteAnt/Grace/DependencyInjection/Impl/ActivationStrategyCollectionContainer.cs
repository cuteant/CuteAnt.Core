...
{
    /// <summary>Container of activation strategy collection</summary>
    ...
    public class ActivationStrategyCollectionContainer<T> : IActivationStrategyCollectionContainer<T> where T : class, IActivationStrategy
    {
        ...
        /// <summary>Protected constructor to be used internally</summary>
        /// <param name="collections"></param>
        protected ActivationStrategyCollectionContainer(ImmutableHashTree<Type, IActivationStrategyCollection<T>>[] collections)
        {
            ArrayLengthMinusOne = collections.Length - 1;
            Collections = collections;
        }

        /// <summary>Export type as their base</summary>
        protected bool ExportAsBase;

        /// <summary>Array length of Collections minus one</summary>
        protected int ArrayLengthMinusOne;

        /// <summary>Array of hash trees</summary>
        protected ImmutableHashTree<Type, IActivationStrategyCollection<T>>[] Collections;

        /// <summary>Inspectors to apply to strategies</summary>
        protected ImmutableLinkedList<IActivationStrategyInspector> Inspectors = ImmutableLinkedList<IActivationStrategyInspector>.Empty;

        /// <summary>Strategies by name</summary>
        protected ImmutableHashTree<string, IActivationStrategyCollection<T>> StrategiesByName = ImmutableHashTree<string, IActivationStrategyCollection<T>>.Empty;

        /// <summary>Add strategy to container</summary>
        /// <param name="strategy">strategy</param>
        public void AddStrategy(T strategy)
        {
            if (0u >= (uint)strategy.ExportOrder)
            {
        ...
        /// <summary>Get all strategies</summary>
        /// <returns></returns>
        ...
        /// <summary>Get collection for a specific type</summary>
        ...
        /// <summary>Get collection for a specific name</summary>
        /// <param name="name"></param>
        /// <returns></returns>
        public IActivationStrategyCollection<T> GetActivationStrategyCollectionByName(string name) => StrategiesByName.GetValueOrDefault(name);

        /// <summary>Get all activation types</summary>
        /// <returns></returns>
        ...
        /// <summary>Clone the container</summary>
        /// <returns></returns>
        ...
        /// <summary>Add strategy inspector</summary>
        ...
        /// <summary>Create a collection of activation strategy</summary>
    ...
    /// <summary>Class to wrap a counter for all exports including wrappers and decorators</summary>
    public class ActivationStrategyCollectionContainerCounter
    {
        /// <summary>TBD</summary>
        private static int _totalExportCount = 0;

        /// <summary>Increment the count of total</summary>
