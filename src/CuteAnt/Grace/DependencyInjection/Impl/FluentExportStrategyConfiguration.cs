    ...
    public class FluentExportStrategyConfiguration : IFluentExportStrategyConfiguration, IActivationStrategyProvider
    {
        ...
        public IFluentExportStrategyConfiguration As(Type type)
        {
            ...
            if (type.IsGenericTypeDefinition &&
                !_exportConfiguration.ActivationType.IsGenericTypeDefinition)
            {
                ThrowArgumentException_ExportedTypeIsNotOpenGenericButAsTypeIsOpen();
            }
        ...
        private static void ThrowArgumentException_ExportedTypeIsNotOpenGenericButAsTypeIsOpen()
        {
            throw GetException();
            ArgumentException GetException()
            {
                return new ArgumentException("Exported type is not open generic but As type is open"); ;
            }
        }
