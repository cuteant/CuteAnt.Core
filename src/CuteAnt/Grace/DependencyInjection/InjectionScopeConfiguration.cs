...
{
  /// <summary>Configuration for injection scope</summary>
  public class InjectionScopeConfiguration : IInjectionScopeConfiguration
  {
    ...
    /// <summary>internal method used by the container</summary>
    /// <param name="scope">owning scope</param>
    void IInjectionScopeConfiguration.SetInjectionScope(IInjectionScope scope) => Implementation.InjectionScope = scope;

    /// <summary>Allows you to configure how to construct compiled exports.</summary>
    public ExportCompilationBehavior Behaviors { get; protected set; }

    /// <summary>Catch exceptions on disposal, false by default</summary>
    public bool CatchDisposalExceptions { get; set; }

    /// <summary>This the containers internal DI container. If you want to change any implementation you would add them here</summary>
    public ImplementationFactory Implementation { get; protected set; }

    /// <summary>Size of the array used to cache execution delegates. By default it's 64, if you wish to
    /// change this make sure it's a positive power of 2</summary>
    public int CacheArraySize { get; set; }

    /// <summary>Size of array used to cache export strategies. By default it's 16, if you wish to change this
    /// make sure it's a positive power of 2</summary>
    public int ExportStrategyArraySize { get; set; }

    /// <summary>Register concrete implementation that are unknown</summary>
    public bool AutoRegisterUnknown { get; set; }

    /// <summary>Lifestyle picker to be used when</summary>
    public Func<Type, ICompiledLifestyle> AutoRegistrationLifestylePicker { get; set; }

    /// <summary>Export as type and base implementations, false by default</summary>
    public bool ExportAsBase { get; set; }

    /// <summary>Use custom disposal scopes</summary>
    public IDisposalScopeProvider DisposalScopeProvider { get; set; }

    /// <summary>Filter interfaces to be exported</summary>
    ...
    /// <summary>Provide action that will be called for tracing purposes</summary>
    public Action<string> Trace { get; set; }

    /// <summary>Should the container track disposable transients</summary>
    ...
    /// <summary>Default interface filter</summary>
    /// <returns></returns>
    ...
    /// <summary>Default implementation factor</summary>
    protected static readonly ImplementationFactory DefaultImplementation;

    /// <summary>static constructor that sets up a default implementation for the DI container</summary>
