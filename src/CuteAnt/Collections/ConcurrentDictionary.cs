...
namespace System.Collections.Concurrent
{
	...
	public class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IDictionary, ICollection, IEnumerable
	{
		...
		{
			return Backup.Contains(item);
		}

		void ICollection<KeyValuePair<TKey, TValue>>.CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
		{
			Backup.CopyTo(array, arrayIndex);
		}
		...
		{
			(Backup as ICollection).CopyTo(array, index);
		}
		...
		{
			return (Backup as IDictionary).Contains(key);
		}

		IDictionaryEnumerator IDictionary.GetEnumerator()
		{
			return (Backup as IDictionary).GetEnumerator();
		}
		...
		{
			(Backup as IDictionary).Remove(key);
		}
