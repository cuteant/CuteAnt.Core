...
namespace CuteAnt
{
	...
	public class WeakAction<TArgs>
	{
		...
		public WeakAction(Delegate handler)
			: this(handler.Target, handler.Method, null, false)
		{
		}
		...
		public WeakAction(Delegate handler, Action<Action<TArgs>> unHandler, Boolean once)
			: this(handler.Target, handler.Method, unHandler, once)
		{
		}
