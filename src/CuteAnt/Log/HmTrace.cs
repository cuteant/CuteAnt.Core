...
namespace CuteAnt.Log
{
	...
	public static class HmTrace
	{
		...
		private static Logger s_log = LogManager.GetLogger(GlobalLoggerName);
		...
		{
			if (Debug) { Log.Error(ex, formatMsg, args); }
		}
