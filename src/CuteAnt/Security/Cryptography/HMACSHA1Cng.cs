...
//namespace CuteAnt.Security.Cryptography
//{
//	/// <summary>
//	///     <para>
//	///         The HMACSHA1Cng class provides a wrapper for the CNG implementation of the HMAC SHA256
...
//	///     </para>
//	///     <para>
//	///         HMACSHA1Cng uses the BCrypt layer of CNG to do its work, and requires Windows Vista and the
//	///         .NET Framework 3.5.
//	///     </para>
//	///     <para>
//	///         Since most of the HMACSHA1Cng APIs are inherited from the <see cref="HMAC" /> base class,
...
//		/// <summary>
//		///     Constructs a HMACSHA1Cng object with a randomly generated key, which will use the Microsoft
//		///     PrimitiveAlgorithm Provider to do its work.
//		/// </summary>
//		public HMACSHA1Cng()
//			: this(RNGCng.GenerateKey(BlockSize))
//		{
//		}

//		/// <summary>
//		///     Constructs a HMACSHA1Cng object using the given key, which will use the Microsoft
...
//		/// <summary>
//		///     Constructs a HMACSHA1Cng object using the given key, which will calculate the HMAC using the
...
//			m_hmac = new BCryptHMAC(CngAlgorithm.Sha1, algorithmProvider, "SHA1", BlockSize, key);
