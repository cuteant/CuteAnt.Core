...
namespace CuteAnt.Security.Cryptography
{
	...
	{
		internal AnsiPadding(int blockSize)
			: base(blockSize)
		{
		}
	...
	{
		internal IsoPadding(int blockSize)
			: base(blockSize)
		{
		}
	...
	{
		internal NoPadding(int blockSize)
			: base(blockSize)
		{
		}
	...
	{
		internal PkcsPadding(int blockSize)
			: base(blockSize)
		{
		}
	...
	{
		internal ZerosPadding(int blockSize)
			: base(blockSize)
		{
		}
