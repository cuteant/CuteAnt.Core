...
namespace CuteAnt.Runtime
{
    ...
    {
#if !NET40
        private const string asyncTimerName = "CuteAnt.Runtime.AsyncTaskSafeTimer";
#endif
        private const string syncTimerName = "CuteAnt.Runtime.SafeTimerBase";
        ...
        {
            Init(logger, asyncTaskCallback, null, state, INFINITE_TIMESPAN, INFINITE_TIMESPAN);
        }
        ...
        private void Init(ILogger logger, Func<object, Task> asynCallback, TimerCallback synCallback, object state, TimeSpan due, TimeSpan period)
        {
            ...
            timer = NonCapturingTimer.Create(HandleTimerCallback, state, INFINITE_TIMESPAN, INFINITE_TIMESPAN);
        }
        ...
        private string GetFullName()
        {
            ...
            if (asyncTaskCallback != null) { return asyncTimerName; }
