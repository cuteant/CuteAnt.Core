...
{
  /// <summary>Common interface for <see cref="IServiceProviderFactory{TContainerBuilder}"/> implementations.</summary>
  internal interface IServiceProviderFactoryAdapter
  {
    /// <summary>Creates a <see cref="IServiceProvider"/> from an <see cref="IServiceCollection" />.</summary>
