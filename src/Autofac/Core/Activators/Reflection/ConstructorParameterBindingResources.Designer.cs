...
namespace Autofac.Core.Activators.Reflection {
    ...
    internal class ConstructorParameterBindingResources {
        ...
        /// <summary>
        ///    查找与 Bound constructor &apos;{0}&apos;. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The binding cannot be instantiated. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 An exception was thrown while invoking the constructor &apos;{0}&apos; on type &apos;{1}&apos;. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 Cannot resolve parameter &apos;{1}&apos; of constructor &apos;{0}&apos;. 类似的本地化字符串。
        /// </summary>
