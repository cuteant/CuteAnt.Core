...
namespace Autofac.Core.Activators.Reflection {
    ...
    internal class MatchingSignatureConstructorSelectorResources {
        ...
        /// <summary>
        ///    查找与 At least one binding must be provided in order to select a constructor. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The required constructor on type &apos;{0}&apos;  with signature &apos;{1}&apos; is unavailable. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 More than one constructor matches the signature &apos;{0}&apos;. 类似的本地化字符串。
        /// </summary>
