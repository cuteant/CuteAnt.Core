...
namespace Autofac.Core.Activators.ProvidedInstance {
    ...
    internal class ProvidedInstanceActivatorResources {
        ...
        /// <summary>
        ///    查找与 The provided instance has already been used in an activation request. Did you combine a provided instance with non-root/single-instance lifetime/sharing? 类似的本地化字符串。
        /// </summary>
