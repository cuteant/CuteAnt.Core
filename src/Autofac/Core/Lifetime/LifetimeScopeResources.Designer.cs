...
namespace Autofac.Core.Lifetime {
    ...
    internal class LifetimeScopeResources {
        ...
        /// <summary>
        ///    查找与 Instances cannot be resolved and nested lifetimes cannot be created from this LifetimeScope as it has already been disposed. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The constructor of type &apos;{0}&apos; attempted to create another instance of itself. This is not permitted because the service is configured to only allowed a single instance per lifetime scope. 类似的本地化字符串。
        /// </summary>
