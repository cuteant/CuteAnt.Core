...
namespace Autofac.Core.Resolving {
    ...
    internal class ResolveOperationResources {
        ...
        /// <summary>
        ///    查找与 An exception was thrown while executing a resolve operation. See the InnerException for details. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 This resolve operation has already ended. When registering components using lambdas, the IComponentContext &apos;c&apos; parameter to the lambda cannot be stored. Instead, either resolve IComponentContext again from &apos;c&apos;, or resolve a Func&lt;&gt; based factory to create subsequent components from. 类似的本地化字符串。
        /// </summary>
