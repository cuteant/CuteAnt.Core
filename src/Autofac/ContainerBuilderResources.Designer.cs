...
namespace Autofac {
    ...
    internal class ContainerBuilderResources {
        ...
        /// <summary>
        ///    查找与 Build() or Update() can only be called once on a ContainerBuilder. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 An error occurred while attempting to automatically activate registration &apos;{0}&apos;. See the inner exception for information on the source of the failure. 类似的本地化字符串。
        /// </summary>
