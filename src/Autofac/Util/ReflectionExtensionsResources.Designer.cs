...
namespace Autofac.Util {
    ...
    internal class ReflectionExtensionsResources {
        ...
        /// <summary>
        ///    查找与 The provided expression must be of the form () =&gt;new X(), but the provided expression was {0}. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The provided expression must be of the form x =&gt;x.M(), but the provided expression was {0}. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The provided expression must be of the form x =&gt;x.P, but the provided expression was {0}. 类似的本地化字符串。
        /// </summary>
