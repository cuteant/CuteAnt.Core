...
namespace Autofac.Features.OpenGenerics {
    ...
    internal class OpenGenericServiceBinderResources {
        ...
        /// <summary>
        ///    查找与 The type &apos;{0}&apos; does not implement the interface &apos;{1}&apos;. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The implementation type &apos;{0}&apos; is not an open generic type definition. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The implementation type &apos;{0}&apos; does not support the interface &apos;{1}&apos;. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The service &apos;{0}&apos; is not an open generic type definition. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 The service &apos;{1}&apos; is not assignable from implementation type &apos;{0}&apos;. 类似的本地化字符串。
        /// </summary>
