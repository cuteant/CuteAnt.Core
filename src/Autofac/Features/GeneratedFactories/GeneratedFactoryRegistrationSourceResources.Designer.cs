...
namespace Autofac.Features.GeneratedFactories {
    ...
    internal class GeneratedFactoryRegistrationSourceResources {
        ...
        /// <summary>
        ///    查找与 Unable to generate a function to return type &apos;{0}&apos; with input parameter types [{1}]. The input parameter type list has duplicate types. Try registering a custom delegate type instead of using a generic Func relationship. 类似的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///    查找与 Delegate Support (Func&lt;T&gt;and Custom Delegates) 类似的本地化字符串。
        /// </summary>
