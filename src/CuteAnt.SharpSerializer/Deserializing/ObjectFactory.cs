...
namespace CuteAnt.Serialization.Deserializing
{
	...
	public sealed class ObjectFactory
	{
		...
		private readonly Dictionary<Int32, object> _objectCache = new Dictionary<Int32, object>();
		...
		{
			ValidationHelper.ArgumentNull(property, "property");

			// Is it NullProperty?
			var nullProperty = property as NullProperty;
			if (nullProperty != null) { return null; }
		...
		{
			Int32 itemsCount = property.Items.Count;
			...
			// Items
			for (Int32 index = property.LowerBound; index < property.LowerBound + itemsCount; index++)
			{
		...
		private static Array createArrayInstance(Type elementType, Int32[] lengths, Int32[] lowerBounds)
		{
#if PORTABLE
				...
				IEnumerable<DimensionInfo> infos)
		{
			...
			var lowerBounds = new List<Int32>();
		...
		private class MultiDimensionalArrayCreatingInfo
		{
			...
			public Int32[] LowerBounds { get; set; }
		}
