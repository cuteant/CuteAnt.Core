...
namespace CuteAnt.Serialization.Serializing
{
	...
	public sealed class PropertyFactory
	{
		...
		private Int32 _currentReferenceId = 1;
		...
		private Boolean fillComplexProperty(ComplexProperty property, TypeInfo typeInfo, object value)
		{
		...
		private Boolean fillCollectionProperty(CollectionProperty property, TypeInfo info, object value)
		{
			if (property == null) { return false; }
		...
		private Boolean fillDictionaryProperty(DictionaryProperty property, TypeInfo info, object value)
		{
			if (property == null) { return false; }
		...
		private Boolean fillMultiDimensionalArrayProperty(MultiDimensionalArrayProperty property, TypeInfo info, object value)
		{
			if (property == null) { return false; }
			property.ElementType = info.ElementType;
		...
		private Boolean fillSingleDimensionalArrayProperty(SingleDimensionalArrayProperty property, TypeInfo info, object value)
		{
			if (property == null) { return false; }
			property.ElementType = info.ElementType;
			var analyzer = new ArrayAnalyzer(value);
