...
namespace CuteAnt.Serialization.Advanced
{
	...
	public class PropertyProvider
	{
		...
		/// <returns></returns>
		public IList<PropertyInfo> GetProperties(CuteAnt.Serialization.Serializing.TypeInfo typeInfo)
		{
			// Search in cache
		...
		///   - is indexer
		/// </returns>
		protected virtual Boolean IgnoreProperty(CuteAnt.Serialization.Serializing.TypeInfo info, PropertyInfo property)
		{
		...
		/// </returns>
		protected Boolean ContainsExcludeFromSerializationAttribute(ICustomAttributeProvider property)
		{
	...
	public sealed class PropertiesToIgnore
	{
		...
		///<param name = "propertyName"></param>
		///<returns></returns>
		public Boolean Contains(Type type, String propertyName)
		{
		...
		private sealed class TypePropertiesToIgnoreCollection : KeyedCollection<Type, TypePropertiesToIgnore>
		{
			...
			public Int32 IndexOf(Type type)
			{
			...
			public Boolean ContainsProperty(Type type, String propertyName)
			{
