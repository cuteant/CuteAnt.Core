...
namespace CuteAnt.Serialization.Core
{
	...
	public abstract class Property
	{
		...
		/// <param name="art" type="CuteAnt.Serialization.Core.PropertyArt">
		/// <para></para>
		/// </param>
	...
	#region -- class ReferenceTargetProperty --
	...
	#region -- class PropertyCollection --
	...
	public sealed class PropertyCollection : Collection<Property>
	{
		...
		protected override void InsertItem(Int32 index, Property item)
		{
		...
		/// <param name = "index"></param>
		/// <param name = "item"></param>
		protected override void SetItem(Int32 index, Property item)
		{
			Items[index].Parent = null;
	...
	#region -- class DictionaryProperty --
	...
	#region -- class SingleDimensionalArrayProperty --
	...
	public sealed class SingleDimensionalArrayProperty : ReferenceTargetProperty
	{
		...
		public PropertyCollection Items
		{
			get
			{
				if (_items == null)
				{
					_items = new PropertyCollection { Parent = this };
				}
				return _items;
			}
			set { _items = value; }
	...
	#region -- class MultiDimensionalArrayProperty --
	...
	#region -- class MultiDimensionalArrayItem --
	...
	public sealed class MultiDimensionalArrayItem
	{
		...
		public MultiDimensionalArrayItem(Int32[] indexes, Property value)
		{
			Indexes = indexes;
			Value = value;
		}
