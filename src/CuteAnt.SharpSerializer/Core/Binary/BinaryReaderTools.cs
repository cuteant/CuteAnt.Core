...
namespace CuteAnt.Serialization.Core.Binary
{
	...
	public static class BinaryReaderTools
	{
		...
		///<param name = "reader"></param>
		///<returns></returns>
		public static Int32 ReadNumber(BinaryReader reader)
		{
			// Size
		...
		public static Int32[] ReadNumbers(BinaryReader reader)
		{
			// Count
			Int32 count = ReadNumber(reader);
			if (count == 0) return new Int32[0];
		...
		{
			Int32 length = ReadNumber(reader);
