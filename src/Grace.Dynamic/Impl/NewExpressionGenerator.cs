...
{
  /// <summary>interface for generating IL for new expression</summary>
  public interface INewExpressionGenerator
  {
    /// <summary>Generate IL for new expression</summary>
  ...
  /// <summary>class for generating IL for new expression</summary>
  public class NewExpressionGenerator : INewExpressionGenerator
  {
    ...
    {
      if (expression.Arguments.Any(argument => !request.TryGenerateIL(request, argument))) { return false; }
