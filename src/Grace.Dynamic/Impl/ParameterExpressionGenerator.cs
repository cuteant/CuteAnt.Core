...
{
  /// <summary>interface for generating IL for Parameter expression</summary>
  public interface IParameterExpressionGenerator
  {
    /// <summary>Generate IL for ParameterExpression</summary>
  ...
  /// <summary>class for generating parameter expression</summary>
