...
{
  /// <summary>Represents a request to create a dynamic method</summary>
  public class DynamicMethodGenerationRequest
  {
    ...
    /// <summary>Expression Request</summary>
    public IActivationExpressionRequest ExpressionRequest { get; }

    /// <summary>Extra parameters for delegate</summary>
    public ParameterExpression[] ExtraParameters { get; }

    /// <summary>IL Generator</summary>
    ...
    /// <summary>is the constants target an array target</summary>
