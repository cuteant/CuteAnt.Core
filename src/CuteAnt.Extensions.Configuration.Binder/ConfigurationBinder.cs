...
using CuteAnt.Extensions.Configuration.Binder;
...
namespace CuteAnt.Extensions.Configuration
{
  ...
  public static class ConfigurationBinder
  {
    ...
    private static void BindProperty(PropertyInfo property, object instance, IConfiguration config)
    {
      ...
      if (property.GetMethodEx() == null ||
          !property.GetMethodEx().IsPublic ||
          property.GetMethodEx().GetParameters().Length > 0)
      {
        return;
      }

      var propertyValue = property.GetValue(instance);
      var hasPublicSetter = property.SetMethodEx() != null && property.SetMethodEx().IsPublic;
