...
namespace Autofac.Test.Builder
{
    public class PropertyInjectionTests
    {
        ...
        public void InjectPropertiesWithSelector()
        {
            ...
            Assert.Null(obj.Prop);
            c.InjectProperties(obj, new DelegatePropertySelector((p, _) => Attribute.GetCustomAttributes(p, typeof(InjectAttribute)).Any()));
            Assert.Null(obj.Prop);
        ...
        private class InjectAttributePropertySelector : IPropertySelector
        {
            ...
            {
                return Attribute.GetCustomAttributes(propertyInfo,typeof(InjectAttribute)).Any();
            }
        }
