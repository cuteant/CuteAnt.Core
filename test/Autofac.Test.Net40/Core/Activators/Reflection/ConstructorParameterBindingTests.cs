...
namespace Autofac.Test.Core.Activators.Reflection
{
    public class ConstructorParameterBindingTests
    {
        ...
        {
      var ci = typeof(ThrowsInCtor).GetConstructors(BindingFlagsHelper.MSDeclaredOnlyLookup).Single();
        ...
        {
      var ci = typeof(CtorWithDoubleParam).GetConstructors(BindingFlagsHelper.MSDeclaredOnlyLookup).Single();
            var cpb = new ConstructorParameterBinding(
        ...
        {
      var ci = typeof(CtorWithInt).GetConstructors(BindingFlagsHelper.MSDeclaredOnlyLookup).Single();
            var cpb = new ConstructorParameterBinding(
