...
------------------- |---------:|----------:|----------:|------:|--------:|------------:|------------:|------------:|--------------------:|
 ...
 InvokeFastCompiled | 12.75 ns | 0.1291 ns | 0.1208 ns |  1.00 |    0.00 |      0.0169 |           - |           - |                80 B |
        ...
        private static readonly Func<X> _fastCompiledFunc = _expr.CompileFast(true);
        ...
        private static Func<X> CreateExpressionInfo()
        {
            var expr = LE.Lambda<Func<X>>(LE.New(_xCtor, LE.New(_aCtor), LE.New(_bCtor))); // , Array.Empty<FastExpressionCompiler.LightExpression.ParameterExpression>()
            return LEC.CompileFast(expr, true);
        }
        private static readonly Func<X> _leCompiledFunc = CreateExpressionInfo();
        [Benchmark]
        public X InvokeLECompiled() => _leCompiledFunc();
        ...
        //private static Func<X> CreateManualEmit()
        //{
        ...
        //    return ((Func<X>)method.CreateDelegate(typeof(Func<X>), null));
        //}
        //private static readonly Func<X> _manualEmitFunc = CreateManualEmit();
        //[Benchmark]
        //public X InvokeManualEmit() => _manualEmitFunc();
